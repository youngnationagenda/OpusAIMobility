...
// TERRA-081: MPAndroidChart imports
...
public class TelemetryActivity extends AppCompatActivity {
    ...
    // TERRA-081: Use WAF-protected CloudFront URL (REQ-001)
    private static final String API_BASE    = "https://d22up4o3zhu9gf.cloudfront.net";
    ...
    // TERRA-081: MPAndroidChart efficiency history
    private LineChart chartEfficiency;
    private final List<Entry> efficiencyEntries = new ArrayList<>();
    ...
    private void bindViews() {
        // TERRA-081: MPAndroidChart line chart (id must exist in layout or gracefully null)
        chartEfficiency  = findViewById(R.id.chart_efficiency);
        if (chartEfficiency != null) setupEfficiencyChart();
