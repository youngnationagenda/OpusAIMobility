...
function openmenu(menuid) {
	...
	//jQuery(".mainmenus_items").slideUp();
	jQuery(".mainmenus_items#"+menuid).slideToggle();
}
...
jQuery(document).ready(function(){
	...
	jQuery("#addnewmenu").on("click", function(){
		jQuery(this).hide();
		jQuery(this).parent().append("<h3 class='addmenuheading'><i class='fa fa-plus-circle' style='margin-right: 5px;'></i> Add New Menu</h3><form action='process.php?resid=1&userid=2&p=manage_menu&add=menu' method='post' enctype='multipart/form-data' class='form addmenuform' id='adnewmenfrm'><div class='cl33'><div class='col33 left'> <p><input type='text' name='menu_name' id='menu_name' placeholder='Name'></p> </div> <div class='col33 left'> <p><input type='text' name='menu_dsc' id='menu_dsc' placeholder='Description'></p> </div> <div class='col33 left'> <p><input type='file' name='menu_image' id='menu_image' style='padding: 8px;'></p> </div> <div class='clear'></div> <div class='col100' style='padding: 0 10px;'> <p><input type='submit' value='Add Menu'></p> </div> </div></form>");
	});
	...
	jQuery(".main_menu_edit").on("click", function(){
		...
		jQuery("#main_menu_edit_div_"+menuid).html("<form action='process.php?resid=1&userid=2&p=manage_menu&edit=menu' method='post' class='form addmenuform' id='adnewmenfrm' enctype='multipart/form-data'><input type='hidden' name='rid' id='rid' value='"+menuid+"'><div class='cl33'><div class='col33 left'> <p><input type='text' name='menu_name' id='menu_name' value='"+menuname+"' required=''><label alt='Name' placeholder='Name'></label></p> </div> <div class='col33 left'> <p><input type='text' name='menu_dsc' id='menu_dsc' value='"+menudesc+"' required=''><label alt='Description' placeholder='Description'></label></p> </div> <div class='col33 left'> <p><input type='file' name='menu_image' id='menu_image' style='padding: 8px;'></p> </div> <div class='clear'></div> <div class='col100' style='padding: 0 10px;'> <p><input type='submit' value='Update Menu'></p> </div></div></form>");
	});
	...
	jQuery(".addnewmenu_item").on("click", function(){
		...
		//alert(menuid);
		jQuery(this).hide();
		jQuery(this).parent().append("<h3 class='addmenuheading'><i class='fa fa-plus-circle' style='margin-right: 5px;'></i> Add New Menu Item</h3><form action='process.php?resid=1&userid=2&p=manage_menu&add=menuitem' method='post' enctype='multipart/form-data' class='form addmenuform' id='adnewmenuitmfrm'><input type='hidden' name='menuid' id='menuid' value='"+menuid+"'><div class='col50 left twocll'> <p><input type='text' name='menu_name' id='menu_name' placeholder='Name'></p> </div> <div class='col50 right twocll'> <p><input type='text' name='menu_dsc' id='menu_dsc' placeholder='Description'></p> </div> <div class='col50 left twocll'> <p><input type='text' name='menu_price' id='menu_price' placeholder='Price'></p> </div>  <div class='col50 right'> <p><input name='menu_image' id='menu_image' style='padding: 8px;' type='file'></p> </div><div class='clear'></div><div class='col100 twocll'> <p><input type='submit' value='Add Menu Item'></p></div></form>");
	});
	...
	jQuery(".main_menu_item_edit").on("click", function(){
		...
		jQuery("#main_menu_item_edit_div_"+menuid).html("<form action='process.php?resid=1&userid=2&p=manage_menu&edit=menuitem' method='post' class='form addmenuform' id='adnewmenuitmfrm' enctype='multipart/form-data'><input type='hidden' name='rid' id='rid' value='"+menuid+"'><input type='hidden' name='menuid' id='menuid' value='"+mainmenuidd+"'><div class='col50 left twocll'> <p><input type='text' name='menu_name' id='menu_name' value='"+menuname+"' required='Name'><label alt='Name' placeholder='Name'></label></p> </div> <div class='col50 right twocll'> <p><input type='text' name='menu_dsc' id='menu_dsc' value='"+menudesc+"' required=''><label alt='Description' placeholder='Description'></label></p> </div> <div class='col50 left twocll'> <p><input type='text' name='menu_price' value='"+menuprce+"' id='menu_price' required='Price'><label alt='Price' placeholder='Price'></label><p style='margin-top: 0px !important'><input type='checkbox' name='outofstock' id='require_items' value='1' "+menuoutofstock+" /> Out Of Stock</p></p> </div> <div class='col50 right'> <p><input name='menu_image' id='menu_image' style='padding: 8px;' type='file'></p> </div><div class='clear'></div><div class='col100 twocll'> <p><input type='submit' value='Update Menu Item'></p></div></form>");
	});
