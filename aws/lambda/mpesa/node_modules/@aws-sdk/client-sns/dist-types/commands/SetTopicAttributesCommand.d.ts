...
declare const SetTopicAttributesCommand_base: {
    new (input: SetTopicAttributesCommandInput): import("@smithy/core/client").CommandImpl<SetTopicAttributesCommandInput, SetTopicAttributesCommandOutput, import("..").SNSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SetTopicAttributesCommandInput): import("@smithy/core/client").CommandImpl<SetTopicAttributesCommandInput, SetTopicAttributesCommandOutput, import("..").SNSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
