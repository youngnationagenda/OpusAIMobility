...
declare const UnsubscribeCommand_base: {
    new (input: UnsubscribeCommandInput): import("@smithy/core/client").CommandImpl<UnsubscribeCommandInput, UnsubscribeCommandOutput, import("..").SNSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UnsubscribeCommandInput): import("@smithy/core/client").CommandImpl<UnsubscribeCommandInput, UnsubscribeCommandOutput, import("..").SNSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
