...
declare const UpdateContributorInsightsCommand_base: {
    new (input: UpdateContributorInsightsCommandInput): import("@smithy/core/client").CommandImpl<UpdateContributorInsightsCommandInput, UpdateContributorInsightsCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateContributorInsightsCommandInput): import("@smithy/core/client").CommandImpl<UpdateContributorInsightsCommandInput, UpdateContributorInsightsCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
