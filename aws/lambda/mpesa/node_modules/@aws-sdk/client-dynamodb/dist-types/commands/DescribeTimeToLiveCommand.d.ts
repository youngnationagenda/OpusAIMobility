...
declare const DescribeTimeToLiveCommand_base: {
    new (input: DescribeTimeToLiveCommandInput): import("@smithy/core/client").CommandImpl<DescribeTimeToLiveCommandInput, DescribeTimeToLiveCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeTimeToLiveCommandInput): import("@smithy/core/client").CommandImpl<DescribeTimeToLiveCommandInput, DescribeTimeToLiveCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
