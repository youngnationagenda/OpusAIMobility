...
declare const ListGlobalTablesCommand_base: {
    new (input: ListGlobalTablesCommandInput): import("@smithy/core/client").CommandImpl<ListGlobalTablesCommandInput, ListGlobalTablesCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListGlobalTablesCommandInput]): import("@smithy/core/client").CommandImpl<ListGlobalTablesCommandInput, ListGlobalTablesCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
