...
declare const UpdateGlobalTableCommand_base: {
    new (input: UpdateGlobalTableCommandInput): import("@smithy/core/client").CommandImpl<UpdateGlobalTableCommandInput, UpdateGlobalTableCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateGlobalTableCommandInput): import("@smithy/core/client").CommandImpl<UpdateGlobalTableCommandInput, UpdateGlobalTableCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
