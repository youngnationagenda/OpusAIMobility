...
declare const SetSMSAttributesCommand_base: {
    new (input: SetSMSAttributesCommandInput): import("@smithy/core/client").CommandImpl<SetSMSAttributesCommandInput, SetSMSAttributesCommandOutput, import("..").SNSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SetSMSAttributesCommandInput): import("@smithy/core/client").CommandImpl<SetSMSAttributesCommandInput, SetSMSAttributesCommandOutput, import("..").SNSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
