...
declare const VerifySMSSandboxPhoneNumberCommand_base: {
    new (input: VerifySMSSandboxPhoneNumberCommandInput): import("@smithy/core/client").CommandImpl<VerifySMSSandboxPhoneNumberCommandInput, VerifySMSSandboxPhoneNumberCommandOutput, import("..").SNSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: VerifySMSSandboxPhoneNumberCommandInput): import("@smithy/core/client").CommandImpl<VerifySMSSandboxPhoneNumberCommandInput, VerifySMSSandboxPhoneNumberCommandOutput, import("..").SNSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
