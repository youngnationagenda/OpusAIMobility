...
declare const SubscribeCommand_base: {
    new (input: SubscribeCommandInput): import("@smithy/core/client").CommandImpl<SubscribeCommandInput, SubscribeCommandOutput, import("..").SNSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SubscribeCommandInput): import("@smithy/core/client").CommandImpl<SubscribeCommandInput, SubscribeCommandOutput, import("..").SNSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
