...
declare const DeleteAliasCommand_base: {
    new (input: DeleteAliasCommandInput): import("@smithy/core/client").CommandImpl<DeleteAliasCommandInput, DeleteAliasCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteAliasCommandInput): import("@smithy/core/client").CommandImpl<DeleteAliasCommandInput, DeleteAliasCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
