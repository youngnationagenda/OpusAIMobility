...
declare const SendDurableExecutionCallbackFailureCommand_base: {
    new (input: SendDurableExecutionCallbackFailureCommandInput): import("@smithy/core/client").CommandImpl<SendDurableExecutionCallbackFailureCommandInput, SendDurableExecutionCallbackFailureCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SendDurableExecutionCallbackFailureCommandInput): import("@smithy/core/client").CommandImpl<SendDurableExecutionCallbackFailureCommandInput, SendDurableExecutionCallbackFailureCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
