...
declare const GetCapacityProviderCommand_base: {
    new (input: GetCapacityProviderCommandInput): import("@smithy/core/client").CommandImpl<GetCapacityProviderCommandInput, GetCapacityProviderCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetCapacityProviderCommandInput): import("@smithy/core/client").CommandImpl<GetCapacityProviderCommandInput, GetCapacityProviderCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
