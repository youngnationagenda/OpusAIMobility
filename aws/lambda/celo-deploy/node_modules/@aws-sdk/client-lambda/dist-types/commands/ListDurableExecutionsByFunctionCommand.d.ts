...
declare const ListDurableExecutionsByFunctionCommand_base: {
    new (input: ListDurableExecutionsByFunctionCommandInput): import("@smithy/core/client").CommandImpl<ListDurableExecutionsByFunctionCommandInput, ListDurableExecutionsByFunctionCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListDurableExecutionsByFunctionCommandInput): import("@smithy/core/client").CommandImpl<ListDurableExecutionsByFunctionCommandInput, ListDurableExecutionsByFunctionCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
