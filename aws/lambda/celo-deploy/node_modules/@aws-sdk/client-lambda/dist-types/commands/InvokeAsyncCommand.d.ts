...
declare const InvokeAsyncCommand_base: {
    new (input: InvokeAsyncCommandInput): import("@smithy/core/client").CommandImpl<InvokeAsyncCommandInput, InvokeAsyncCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: InvokeAsyncCommandInput): import("@smithy/core/client").CommandImpl<InvokeAsyncCommandInput, InvokeAsyncCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
