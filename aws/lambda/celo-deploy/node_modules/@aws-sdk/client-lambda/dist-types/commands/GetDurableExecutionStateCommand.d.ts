...
declare const GetDurableExecutionStateCommand_base: {
    new (input: GetDurableExecutionStateCommandInput): import("@smithy/core/client").CommandImpl<GetDurableExecutionStateCommandInput, GetDurableExecutionStateCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetDurableExecutionStateCommandInput): import("@smithy/core/client").CommandImpl<GetDurableExecutionStateCommandInput, GetDurableExecutionStateCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
