...
declare const StopDurableExecutionCommand_base: {
    new (input: StopDurableExecutionCommandInput): import("@smithy/core/client").CommandImpl<StopDurableExecutionCommandInput, StopDurableExecutionCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopDurableExecutionCommandInput): import("@smithy/core/client").CommandImpl<StopDurableExecutionCommandInput, StopDurableExecutionCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
