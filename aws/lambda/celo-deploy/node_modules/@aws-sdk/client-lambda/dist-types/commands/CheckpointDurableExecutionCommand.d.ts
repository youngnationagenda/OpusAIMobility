...
declare const CheckpointDurableExecutionCommand_base: {
    new (input: CheckpointDurableExecutionCommandInput): import("@smithy/core/client").CommandImpl<CheckpointDurableExecutionCommandInput, CheckpointDurableExecutionCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CheckpointDurableExecutionCommandInput): import("@smithy/core/client").CommandImpl<CheckpointDurableExecutionCommandInput, CheckpointDurableExecutionCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
