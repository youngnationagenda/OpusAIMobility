...
declare const CreateCapacityProviderCommand_base: {
    new (input: CreateCapacityProviderCommandInput): import("@smithy/core/client").CommandImpl<CreateCapacityProviderCommandInput, CreateCapacityProviderCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateCapacityProviderCommandInput): import("@smithy/core/client").CommandImpl<CreateCapacityProviderCommandInput, CreateCapacityProviderCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
