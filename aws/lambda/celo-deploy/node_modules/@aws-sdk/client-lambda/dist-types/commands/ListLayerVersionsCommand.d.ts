...
declare const ListLayerVersionsCommand_base: {
    new (input: ListLayerVersionsCommandInput): import("@smithy/core/client").CommandImpl<ListLayerVersionsCommandInput, ListLayerVersionsCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListLayerVersionsCommandInput): import("@smithy/core/client").CommandImpl<ListLayerVersionsCommandInput, ListLayerVersionsCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
