...
declare const PutProvisionedConcurrencyConfigCommand_base: {
    new (input: PutProvisionedConcurrencyConfigCommandInput): import("@smithy/core/client").CommandImpl<PutProvisionedConcurrencyConfigCommandInput, PutProvisionedConcurrencyConfigCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutProvisionedConcurrencyConfigCommandInput): import("@smithy/core/client").CommandImpl<PutProvisionedConcurrencyConfigCommandInput, PutProvisionedConcurrencyConfigCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
