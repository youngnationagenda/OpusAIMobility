...
declare const GetDurableExecutionCommand_base: {
    new (input: GetDurableExecutionCommandInput): import("@smithy/core/client").CommandImpl<GetDurableExecutionCommandInput, GetDurableExecutionCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetDurableExecutionCommandInput): import("@smithy/core/client").CommandImpl<GetDurableExecutionCommandInput, GetDurableExecutionCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
