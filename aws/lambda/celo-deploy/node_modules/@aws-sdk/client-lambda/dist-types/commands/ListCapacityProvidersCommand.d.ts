...
declare const ListCapacityProvidersCommand_base: {
    new (input: ListCapacityProvidersCommandInput): import("@smithy/core/client").CommandImpl<ListCapacityProvidersCommandInput, ListCapacityProvidersCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListCapacityProvidersCommandInput]): import("@smithy/core/client").CommandImpl<ListCapacityProvidersCommandInput, ListCapacityProvidersCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
