...
declare const UpdateCodeSigningConfigCommand_base: {
    new (input: UpdateCodeSigningConfigCommandInput): import("@smithy/core/client").CommandImpl<UpdateCodeSigningConfigCommandInput, UpdateCodeSigningConfigCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateCodeSigningConfigCommandInput): import("@smithy/core/client").CommandImpl<UpdateCodeSigningConfigCommandInput, UpdateCodeSigningConfigCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
