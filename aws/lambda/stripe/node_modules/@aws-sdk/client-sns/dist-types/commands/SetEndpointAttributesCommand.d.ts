...
declare const SetEndpointAttributesCommand_base: {
    new (input: SetEndpointAttributesCommandInput): import("@smithy/core/client").CommandImpl<SetEndpointAttributesCommandInput, SetEndpointAttributesCommandOutput, import("..").SNSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SetEndpointAttributesCommandInput): import("@smithy/core/client").CommandImpl<SetEndpointAttributesCommandInput, SetEndpointAttributesCommandOutput, import("..").SNSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
