...
declare const SetSubscriptionAttributesCommand_base: {
    new (input: SetSubscriptionAttributesCommandInput): import("@smithy/core/client").CommandImpl<SetSubscriptionAttributesCommandInput, SetSubscriptionAttributesCommandOutput, import("..").SNSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SetSubscriptionAttributesCommandInput): import("@smithy/core/client").CommandImpl<SetSubscriptionAttributesCommandInput, SetSubscriptionAttributesCommandOutput, import("..").SNSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
