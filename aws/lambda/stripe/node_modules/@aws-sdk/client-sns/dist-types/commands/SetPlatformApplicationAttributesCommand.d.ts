...
declare const SetPlatformApplicationAttributesCommand_base: {
    new (input: SetPlatformApplicationAttributesCommandInput): import("@smithy/core/client").CommandImpl<SetPlatformApplicationAttributesCommandInput, SetPlatformApplicationAttributesCommandOutput, import("..").SNSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SetPlatformApplicationAttributesCommandInput): import("@smithy/core/client").CommandImpl<SetPlatformApplicationAttributesCommandInput, SetPlatformApplicationAttributesCommandOutput, import("..").SNSClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
