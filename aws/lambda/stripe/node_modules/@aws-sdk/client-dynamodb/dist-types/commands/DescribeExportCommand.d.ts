...
declare const DescribeExportCommand_base: {
    new (input: DescribeExportCommandInput): import("@smithy/core/client").CommandImpl<DescribeExportCommandInput, DescribeExportCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeExportCommandInput): import("@smithy/core/client").CommandImpl<DescribeExportCommandInput, DescribeExportCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
