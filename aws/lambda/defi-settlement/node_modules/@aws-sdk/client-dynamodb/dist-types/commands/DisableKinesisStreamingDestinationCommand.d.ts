...
declare const DisableKinesisStreamingDestinationCommand_base: {
    new (input: DisableKinesisStreamingDestinationCommandInput): import("@smithy/core/client").CommandImpl<DisableKinesisStreamingDestinationCommandInput, DisableKinesisStreamingDestinationCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisableKinesisStreamingDestinationCommandInput): import("@smithy/core/client").CommandImpl<DisableKinesisStreamingDestinationCommandInput, DisableKinesisStreamingDestinationCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
