...
declare const ExportTableToPointInTimeCommand_base: {
    new (input: ExportTableToPointInTimeCommandInput): import("@smithy/core/client").CommandImpl<ExportTableToPointInTimeCommandInput, ExportTableToPointInTimeCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ExportTableToPointInTimeCommandInput): import("@smithy/core/client").CommandImpl<ExportTableToPointInTimeCommandInput, ExportTableToPointInTimeCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
