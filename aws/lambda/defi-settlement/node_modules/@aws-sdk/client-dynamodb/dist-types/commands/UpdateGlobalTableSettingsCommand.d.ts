...
declare const UpdateGlobalTableSettingsCommand_base: {
    new (input: UpdateGlobalTableSettingsCommandInput): import("@smithy/core/client").CommandImpl<UpdateGlobalTableSettingsCommandInput, UpdateGlobalTableSettingsCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateGlobalTableSettingsCommandInput): import("@smithy/core/client").CommandImpl<UpdateGlobalTableSettingsCommandInput, UpdateGlobalTableSettingsCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
