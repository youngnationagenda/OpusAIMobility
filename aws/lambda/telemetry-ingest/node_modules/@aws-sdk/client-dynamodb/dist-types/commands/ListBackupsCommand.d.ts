...
declare const ListBackupsCommand_base: {
    new (input: ListBackupsCommandInput): import("@smithy/core/client").CommandImpl<ListBackupsCommandInput, ListBackupsCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListBackupsCommandInput]): import("@smithy/core/client").CommandImpl<ListBackupsCommandInput, ListBackupsCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
