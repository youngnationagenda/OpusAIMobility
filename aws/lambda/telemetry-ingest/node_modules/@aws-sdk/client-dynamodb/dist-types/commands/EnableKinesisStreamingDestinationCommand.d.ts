...
declare const EnableKinesisStreamingDestinationCommand_base: {
    new (input: EnableKinesisStreamingDestinationCommandInput): import("@smithy/core/client").CommandImpl<EnableKinesisStreamingDestinationCommandInput, EnableKinesisStreamingDestinationCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: EnableKinesisStreamingDestinationCommandInput): import("@smithy/core/client").CommandImpl<EnableKinesisStreamingDestinationCommandInput, EnableKinesisStreamingDestinationCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
