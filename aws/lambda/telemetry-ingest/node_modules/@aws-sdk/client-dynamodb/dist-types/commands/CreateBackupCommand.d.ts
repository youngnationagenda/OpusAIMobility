...
declare const CreateBackupCommand_base: {
    new (input: CreateBackupCommandInput): import("@smithy/core/client").CommandImpl<CreateBackupCommandInput, CreateBackupCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateBackupCommandInput): import("@smithy/core/client").CommandImpl<CreateBackupCommandInput, CreateBackupCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
