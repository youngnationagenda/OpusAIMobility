...
declare const DescribeGlobalTableCommand_base: {
    new (input: DescribeGlobalTableCommandInput): import("@smithy/core/client").CommandImpl<DescribeGlobalTableCommandInput, DescribeGlobalTableCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeGlobalTableCommandInput): import("@smithy/core/client").CommandImpl<DescribeGlobalTableCommandInput, DescribeGlobalTableCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
