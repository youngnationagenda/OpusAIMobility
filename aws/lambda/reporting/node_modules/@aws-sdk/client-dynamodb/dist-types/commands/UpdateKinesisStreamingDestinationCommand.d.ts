...
declare const UpdateKinesisStreamingDestinationCommand_base: {
    new (input: UpdateKinesisStreamingDestinationCommandInput): import("@smithy/core/client").CommandImpl<UpdateKinesisStreamingDestinationCommandInput, UpdateKinesisStreamingDestinationCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateKinesisStreamingDestinationCommandInput): import("@smithy/core/client").CommandImpl<UpdateKinesisStreamingDestinationCommandInput, UpdateKinesisStreamingDestinationCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
