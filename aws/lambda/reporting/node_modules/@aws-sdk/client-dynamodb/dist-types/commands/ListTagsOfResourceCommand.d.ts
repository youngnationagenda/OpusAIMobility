...
declare const ListTagsOfResourceCommand_base: {
    new (input: ListTagsOfResourceCommandInput): import("@smithy/core/client").CommandImpl<ListTagsOfResourceCommandInput, ListTagsOfResourceCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListTagsOfResourceCommandInput): import("@smithy/core/client").CommandImpl<ListTagsOfResourceCommandInput, ListTagsOfResourceCommandOutput, import("..").DynamoDBClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
