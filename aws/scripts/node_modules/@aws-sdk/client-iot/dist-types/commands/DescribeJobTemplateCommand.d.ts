...
declare const DescribeJobTemplateCommand_base: {
    new (input: DescribeJobTemplateCommandInput): import("@smithy/core/client").CommandImpl<DescribeJobTemplateCommandInput, DescribeJobTemplateCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeJobTemplateCommandInput): import("@smithy/core/client").CommandImpl<DescribeJobTemplateCommandInput, DescribeJobTemplateCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
