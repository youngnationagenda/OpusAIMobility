...
import type { ListFleetMetricsRequest, ListFleetMetricsResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const ListFleetMetricsCommand_base: {
    new (input: ListFleetMetricsCommandInput): import("@smithy/core/client").CommandImpl<ListFleetMetricsCommandInput, ListFleetMetricsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListFleetMetricsCommandInput]): import("@smithy/core/client").CommandImpl<ListFleetMetricsCommandInput, ListFleetMetricsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
