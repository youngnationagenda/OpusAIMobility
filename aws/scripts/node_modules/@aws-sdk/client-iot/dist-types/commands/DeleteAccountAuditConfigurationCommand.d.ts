...
import type { DeleteAccountAuditConfigurationRequest, DeleteAccountAuditConfigurationResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DeleteAccountAuditConfigurationCommand_base: {
    new (input: DeleteAccountAuditConfigurationCommandInput): import("@smithy/core/client").CommandImpl<DeleteAccountAuditConfigurationCommandInput, DeleteAccountAuditConfigurationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DeleteAccountAuditConfigurationCommandInput]): import("@smithy/core/client").CommandImpl<DeleteAccountAuditConfigurationCommandInput, DeleteAccountAuditConfigurationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
