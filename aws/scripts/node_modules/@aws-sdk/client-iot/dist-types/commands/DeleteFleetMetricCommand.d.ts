...
declare const DeleteFleetMetricCommand_base: {
    new (input: DeleteFleetMetricCommandInput): import("@smithy/core/client").CommandImpl<DeleteFleetMetricCommandInput, DeleteFleetMetricCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteFleetMetricCommandInput): import("@smithy/core/client").CommandImpl<DeleteFleetMetricCommandInput, DeleteFleetMetricCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
