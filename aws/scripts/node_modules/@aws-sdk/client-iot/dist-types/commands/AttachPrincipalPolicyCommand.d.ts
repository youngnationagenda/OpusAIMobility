...
declare const AttachPrincipalPolicyCommand_base: {
    new (input: AttachPrincipalPolicyCommandInput): import("@smithy/core/client").CommandImpl<AttachPrincipalPolicyCommandInput, AttachPrincipalPolicyCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AttachPrincipalPolicyCommandInput): import("@smithy/core/client").CommandImpl<AttachPrincipalPolicyCommandInput, AttachPrincipalPolicyCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
