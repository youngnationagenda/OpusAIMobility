...
declare const ListCommandsCommand_base: {
    new (input: ListCommandsCommandInput): import("@smithy/core/client").CommandImpl<ListCommandsCommandInput, ListCommandsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListCommandsCommandInput]): import("@smithy/core/client").CommandImpl<ListCommandsCommandInput, ListCommandsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
