...
import type { AssociateTargetsWithJobRequest, AssociateTargetsWithJobResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const AssociateTargetsWithJobCommand_base: {
    new (input: AssociateTargetsWithJobCommandInput): import("@smithy/core/client").CommandImpl<AssociateTargetsWithJobCommandInput, AssociateTargetsWithJobCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AssociateTargetsWithJobCommandInput): import("@smithy/core/client").CommandImpl<AssociateTargetsWithJobCommandInput, AssociateTargetsWithJobCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
