...
declare const DeleteCertificateProviderCommand_base: {
    new (input: DeleteCertificateProviderCommandInput): import("@smithy/core/client").CommandImpl<DeleteCertificateProviderCommandInput, DeleteCertificateProviderCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteCertificateProviderCommandInput): import("@smithy/core/client").CommandImpl<DeleteCertificateProviderCommandInput, DeleteCertificateProviderCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
