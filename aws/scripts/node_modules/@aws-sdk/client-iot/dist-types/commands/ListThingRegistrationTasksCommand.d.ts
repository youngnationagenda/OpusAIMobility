...
declare const ListThingRegistrationTasksCommand_base: {
    new (input: ListThingRegistrationTasksCommandInput): import("@smithy/core/client").CommandImpl<ListThingRegistrationTasksCommandInput, ListThingRegistrationTasksCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListThingRegistrationTasksCommandInput]): import("@smithy/core/client").CommandImpl<ListThingRegistrationTasksCommandInput, ListThingRegistrationTasksCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
