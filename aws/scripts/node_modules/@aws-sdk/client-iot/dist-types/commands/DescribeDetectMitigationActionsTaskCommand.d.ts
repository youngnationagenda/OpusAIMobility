...
import type { DescribeDetectMitigationActionsTaskRequest, DescribeDetectMitigationActionsTaskResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const DescribeDetectMitigationActionsTaskCommand_base: {
    new (input: DescribeDetectMitigationActionsTaskCommandInput): import("@smithy/core/client").CommandImpl<DescribeDetectMitigationActionsTaskCommandInput, DescribeDetectMitigationActionsTaskCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeDetectMitigationActionsTaskCommandInput): import("@smithy/core/client").CommandImpl<DescribeDetectMitigationActionsTaskCommandInput, DescribeDetectMitigationActionsTaskCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
