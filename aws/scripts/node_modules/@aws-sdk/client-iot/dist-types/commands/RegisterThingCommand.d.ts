...
declare const RegisterThingCommand_base: {
    new (input: RegisterThingCommandInput): import("@smithy/core/client").CommandImpl<RegisterThingCommandInput, RegisterThingCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RegisterThingCommandInput): import("@smithy/core/client").CommandImpl<RegisterThingCommandInput, RegisterThingCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
