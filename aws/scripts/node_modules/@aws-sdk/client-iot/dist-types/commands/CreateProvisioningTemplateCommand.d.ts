...
import type { CreateProvisioningTemplateRequest, CreateProvisioningTemplateResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateProvisioningTemplateCommand_base: {
    new (input: CreateProvisioningTemplateCommandInput): import("@smithy/core/client").CommandImpl<CreateProvisioningTemplateCommandInput, CreateProvisioningTemplateCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateProvisioningTemplateCommandInput): import("@smithy/core/client").CommandImpl<CreateProvisioningTemplateCommandInput, CreateProvisioningTemplateCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
