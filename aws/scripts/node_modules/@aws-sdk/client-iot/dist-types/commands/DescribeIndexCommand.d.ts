...
import type { DescribeIndexRequest, DescribeIndexResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const DescribeIndexCommand_base: {
    new (input: DescribeIndexCommandInput): import("@smithy/core/client").CommandImpl<DescribeIndexCommandInput, DescribeIndexCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeIndexCommandInput): import("@smithy/core/client").CommandImpl<DescribeIndexCommandInput, DescribeIndexCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
