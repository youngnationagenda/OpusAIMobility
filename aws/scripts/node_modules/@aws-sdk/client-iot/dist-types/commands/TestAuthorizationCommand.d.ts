...
declare const TestAuthorizationCommand_base: {
    new (input: TestAuthorizationCommandInput): import("@smithy/core/client").CommandImpl<TestAuthorizationCommandInput, TestAuthorizationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: TestAuthorizationCommandInput): import("@smithy/core/client").CommandImpl<TestAuthorizationCommandInput, TestAuthorizationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
