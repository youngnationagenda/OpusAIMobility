...
declare const DescribeThingGroupCommand_base: {
    new (input: DescribeThingGroupCommandInput): import("@smithy/core/client").CommandImpl<DescribeThingGroupCommandInput, DescribeThingGroupCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeThingGroupCommandInput): import("@smithy/core/client").CommandImpl<DescribeThingGroupCommandInput, DescribeThingGroupCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
