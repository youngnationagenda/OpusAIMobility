...
import type { DescribeFleetMetricRequest, DescribeFleetMetricResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const DescribeFleetMetricCommand_base: {
    new (input: DescribeFleetMetricCommandInput): import("@smithy/core/client").CommandImpl<DescribeFleetMetricCommandInput, DescribeFleetMetricCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeFleetMetricCommandInput): import("@smithy/core/client").CommandImpl<DescribeFleetMetricCommandInput, DescribeFleetMetricCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
