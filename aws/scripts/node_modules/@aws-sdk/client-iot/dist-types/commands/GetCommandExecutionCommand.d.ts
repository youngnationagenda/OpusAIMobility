...
declare const GetCommandExecutionCommand_base: {
    new (input: GetCommandExecutionCommandInput): import("@smithy/core/client").CommandImpl<GetCommandExecutionCommandInput, GetCommandExecutionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetCommandExecutionCommandInput): import("@smithy/core/client").CommandImpl<GetCommandExecutionCommandInput, GetCommandExecutionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
