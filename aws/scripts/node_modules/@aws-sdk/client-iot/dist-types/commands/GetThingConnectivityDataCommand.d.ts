...
import type { GetThingConnectivityDataRequest, GetThingConnectivityDataResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const GetThingConnectivityDataCommand_base: {
    new (input: GetThingConnectivityDataCommandInput): import("@smithy/core/client").CommandImpl<GetThingConnectivityDataCommandInput, GetThingConnectivityDataCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetThingConnectivityDataCommandInput): import("@smithy/core/client").CommandImpl<GetThingConnectivityDataCommandInput, GetThingConnectivityDataCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
