...
declare const CreateThingCommand_base: {
    new (input: CreateThingCommandInput): import("@smithy/core/client").CommandImpl<CreateThingCommandInput, CreateThingCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateThingCommandInput): import("@smithy/core/client").CommandImpl<CreateThingCommandInput, CreateThingCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
