...
declare const ListCertificateProvidersCommand_base: {
    new (input: ListCertificateProvidersCommandInput): import("@smithy/core/client").CommandImpl<ListCertificateProvidersCommandInput, ListCertificateProvidersCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListCertificateProvidersCommandInput]): import("@smithy/core/client").CommandImpl<ListCertificateProvidersCommandInput, ListCertificateProvidersCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
