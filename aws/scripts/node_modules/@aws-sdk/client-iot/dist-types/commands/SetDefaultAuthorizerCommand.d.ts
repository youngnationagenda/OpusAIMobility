...
declare const SetDefaultAuthorizerCommand_base: {
    new (input: SetDefaultAuthorizerCommandInput): import("@smithy/core/client").CommandImpl<SetDefaultAuthorizerCommandInput, SetDefaultAuthorizerCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SetDefaultAuthorizerCommandInput): import("@smithy/core/client").CommandImpl<SetDefaultAuthorizerCommandInput, SetDefaultAuthorizerCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
