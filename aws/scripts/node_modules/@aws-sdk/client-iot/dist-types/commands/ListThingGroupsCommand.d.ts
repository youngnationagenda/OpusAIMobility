...
declare const ListThingGroupsCommand_base: {
    new (input: ListThingGroupsCommandInput): import("@smithy/core/client").CommandImpl<ListThingGroupsCommandInput, ListThingGroupsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListThingGroupsCommandInput]): import("@smithy/core/client").CommandImpl<ListThingGroupsCommandInput, ListThingGroupsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
