...
declare const UpdateThingGroupCommand_base: {
    new (input: UpdateThingGroupCommandInput): import("@smithy/core/client").CommandImpl<UpdateThingGroupCommandInput, UpdateThingGroupCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateThingGroupCommandInput): import("@smithy/core/client").CommandImpl<UpdateThingGroupCommandInput, UpdateThingGroupCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
