...
declare const UpdateIndexingConfigurationCommand_base: {
    new (input: UpdateIndexingConfigurationCommandInput): import("@smithy/core/client").CommandImpl<UpdateIndexingConfigurationCommandInput, UpdateIndexingConfigurationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [UpdateIndexingConfigurationCommandInput]): import("@smithy/core/client").CommandImpl<UpdateIndexingConfigurationCommandInput, UpdateIndexingConfigurationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
