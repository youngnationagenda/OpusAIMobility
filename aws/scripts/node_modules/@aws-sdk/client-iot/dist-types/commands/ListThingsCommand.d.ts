...
declare const ListThingsCommand_base: {
    new (input: ListThingsCommandInput): import("@smithy/core/client").CommandImpl<ListThingsCommandInput, ListThingsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListThingsCommandInput]): import("@smithy/core/client").CommandImpl<ListThingsCommandInput, ListThingsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
