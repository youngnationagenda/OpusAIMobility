...
declare const SetDefaultPolicyVersionCommand_base: {
    new (input: SetDefaultPolicyVersionCommandInput): import("@smithy/core/client").CommandImpl<SetDefaultPolicyVersionCommandInput, SetDefaultPolicyVersionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SetDefaultPolicyVersionCommandInput): import("@smithy/core/client").CommandImpl<SetDefaultPolicyVersionCommandInput, SetDefaultPolicyVersionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
