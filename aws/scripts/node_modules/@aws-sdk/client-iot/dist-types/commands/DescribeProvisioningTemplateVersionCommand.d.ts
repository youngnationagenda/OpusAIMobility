...
import type { DescribeProvisioningTemplateVersionRequest, DescribeProvisioningTemplateVersionResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const DescribeProvisioningTemplateVersionCommand_base: {
    new (input: DescribeProvisioningTemplateVersionCommandInput): import("@smithy/core/client").CommandImpl<DescribeProvisioningTemplateVersionCommandInput, DescribeProvisioningTemplateVersionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeProvisioningTemplateVersionCommandInput): import("@smithy/core/client").CommandImpl<DescribeProvisioningTemplateVersionCommandInput, DescribeProvisioningTemplateVersionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
