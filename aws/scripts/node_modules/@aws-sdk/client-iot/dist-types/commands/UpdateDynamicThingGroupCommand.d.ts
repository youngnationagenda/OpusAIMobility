...
import type { UpdateDynamicThingGroupRequest, UpdateDynamicThingGroupResponse } from "../models/models_2";
/**
 * @public
 */
...
declare const UpdateDynamicThingGroupCommand_base: {
    new (input: UpdateDynamicThingGroupCommandInput): import("@smithy/core/client").CommandImpl<UpdateDynamicThingGroupCommandInput, UpdateDynamicThingGroupCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateDynamicThingGroupCommandInput): import("@smithy/core/client").CommandImpl<UpdateDynamicThingGroupCommandInput, UpdateDynamicThingGroupCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
