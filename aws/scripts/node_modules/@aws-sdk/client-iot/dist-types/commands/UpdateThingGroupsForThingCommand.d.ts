...
declare const UpdateThingGroupsForThingCommand_base: {
    new (input: UpdateThingGroupsForThingCommandInput): import("@smithy/core/client").CommandImpl<UpdateThingGroupsForThingCommandInput, UpdateThingGroupsForThingCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [UpdateThingGroupsForThingCommandInput]): import("@smithy/core/client").CommandImpl<UpdateThingGroupsForThingCommandInput, UpdateThingGroupsForThingCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
