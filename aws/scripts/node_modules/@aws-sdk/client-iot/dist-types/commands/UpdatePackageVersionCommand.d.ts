...
import type { UpdatePackageVersionRequest, UpdatePackageVersionResponse } from "../models/models_2";
/**
 * @public
 */
...
declare const UpdatePackageVersionCommand_base: {
    new (input: UpdatePackageVersionCommandInput): import("@smithy/core/client").CommandImpl<UpdatePackageVersionCommandInput, UpdatePackageVersionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdatePackageVersionCommandInput): import("@smithy/core/client").CommandImpl<UpdatePackageVersionCommandInput, UpdatePackageVersionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
