...
declare const ListSecurityProfilesCommand_base: {
    new (input: ListSecurityProfilesCommandInput): import("@smithy/core/client").CommandImpl<ListSecurityProfilesCommandInput, ListSecurityProfilesCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListSecurityProfilesCommandInput]): import("@smithy/core/client").CommandImpl<ListSecurityProfilesCommandInput, ListSecurityProfilesCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
