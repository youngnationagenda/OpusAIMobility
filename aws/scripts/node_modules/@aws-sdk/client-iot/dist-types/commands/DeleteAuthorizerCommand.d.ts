...
import type { DeleteAuthorizerRequest, DeleteAuthorizerResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DeleteAuthorizerCommand_base: {
    new (input: DeleteAuthorizerCommandInput): import("@smithy/core/client").CommandImpl<DeleteAuthorizerCommandInput, DeleteAuthorizerCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteAuthorizerCommandInput): import("@smithy/core/client").CommandImpl<DeleteAuthorizerCommandInput, DeleteAuthorizerCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
