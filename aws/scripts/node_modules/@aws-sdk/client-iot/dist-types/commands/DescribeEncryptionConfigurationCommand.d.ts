...
import type { DescribeEncryptionConfigurationRequest, DescribeEncryptionConfigurationResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const DescribeEncryptionConfigurationCommand_base: {
    new (input: DescribeEncryptionConfigurationCommandInput): import("@smithy/core/client").CommandImpl<DescribeEncryptionConfigurationCommandInput, DescribeEncryptionConfigurationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeEncryptionConfigurationCommandInput]): import("@smithy/core/client").CommandImpl<DescribeEncryptionConfigurationCommandInput, DescribeEncryptionConfigurationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
