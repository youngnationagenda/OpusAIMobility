...
declare const ListIndicesCommand_base: {
    new (input: ListIndicesCommandInput): import("@smithy/core/client").CommandImpl<ListIndicesCommandInput, ListIndicesCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListIndicesCommandInput]): import("@smithy/core/client").CommandImpl<ListIndicesCommandInput, ListIndicesCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
