...
declare const AttachSecurityProfileCommand_base: {
    new (input: AttachSecurityProfileCommandInput): import("@smithy/core/client").CommandImpl<AttachSecurityProfileCommandInput, AttachSecurityProfileCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AttachSecurityProfileCommandInput): import("@smithy/core/client").CommandImpl<AttachSecurityProfileCommandInput, AttachSecurityProfileCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
