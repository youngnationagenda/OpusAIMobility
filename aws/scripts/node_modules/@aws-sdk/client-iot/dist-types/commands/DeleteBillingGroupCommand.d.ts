...
import type { DeleteBillingGroupRequest, DeleteBillingGroupResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DeleteBillingGroupCommand_base: {
    new (input: DeleteBillingGroupCommandInput): import("@smithy/core/client").CommandImpl<DeleteBillingGroupCommandInput, DeleteBillingGroupCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteBillingGroupCommandInput): import("@smithy/core/client").CommandImpl<DeleteBillingGroupCommandInput, DeleteBillingGroupCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
