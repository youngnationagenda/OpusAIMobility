...
import type { UpdateCommandRequest, UpdateCommandResponse } from "../models/models_2";
/**
 * @public
 */
...
declare const UpdateCommandCommand_base: {
    new (input: UpdateCommandCommandInput): import("@smithy/core/client").CommandImpl<UpdateCommandCommandInput, UpdateCommandCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateCommandCommandInput): import("@smithy/core/client").CommandImpl<UpdateCommandCommandInput, UpdateCommandCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
