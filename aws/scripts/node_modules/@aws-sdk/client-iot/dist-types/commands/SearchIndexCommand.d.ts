...
declare const SearchIndexCommand_base: {
    new (input: SearchIndexCommandInput): import("@smithy/core/client").CommandImpl<SearchIndexCommandInput, SearchIndexCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SearchIndexCommandInput): import("@smithy/core/client").CommandImpl<SearchIndexCommandInput, SearchIndexCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
