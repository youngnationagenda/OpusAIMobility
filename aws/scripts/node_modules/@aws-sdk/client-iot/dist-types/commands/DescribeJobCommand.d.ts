...
declare const DescribeJobCommand_base: {
    new (input: DescribeJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeJobCommandInput, DescribeJobCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeJobCommandInput, DescribeJobCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
