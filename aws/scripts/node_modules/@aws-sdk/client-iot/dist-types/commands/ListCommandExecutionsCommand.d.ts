...
declare const ListCommandExecutionsCommand_base: {
    new (input: ListCommandExecutionsCommandInput): import("@smithy/core/client").CommandImpl<ListCommandExecutionsCommandInput, ListCommandExecutionsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListCommandExecutionsCommandInput]): import("@smithy/core/client").CommandImpl<ListCommandExecutionsCommandInput, ListCommandExecutionsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
