...
declare const ListCACertificatesCommand_base: {
    new (input: ListCACertificatesCommandInput): import("@smithy/core/client").CommandImpl<ListCACertificatesCommandInput, ListCACertificatesCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListCACertificatesCommandInput]): import("@smithy/core/client").CommandImpl<ListCACertificatesCommandInput, ListCACertificatesCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
