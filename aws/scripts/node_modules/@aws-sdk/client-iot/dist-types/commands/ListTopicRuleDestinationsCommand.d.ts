...
declare const ListTopicRuleDestinationsCommand_base: {
    new (input: ListTopicRuleDestinationsCommandInput): import("@smithy/core/client").CommandImpl<ListTopicRuleDestinationsCommandInput, ListTopicRuleDestinationsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListTopicRuleDestinationsCommandInput]): import("@smithy/core/client").CommandImpl<ListTopicRuleDestinationsCommandInput, ListTopicRuleDestinationsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
