...
declare const DescribeDefaultAuthorizerCommand_base: {
    new (input: DescribeDefaultAuthorizerCommandInput): import("@smithy/core/client").CommandImpl<DescribeDefaultAuthorizerCommandInput, DescribeDefaultAuthorizerCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeDefaultAuthorizerCommandInput]): import("@smithy/core/client").CommandImpl<DescribeDefaultAuthorizerCommandInput, DescribeDefaultAuthorizerCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
