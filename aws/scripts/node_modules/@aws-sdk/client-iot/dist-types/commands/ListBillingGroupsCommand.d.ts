...
import type { ListBillingGroupsRequest, ListBillingGroupsResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const ListBillingGroupsCommand_base: {
    new (input: ListBillingGroupsCommandInput): import("@smithy/core/client").CommandImpl<ListBillingGroupsCommandInput, ListBillingGroupsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListBillingGroupsCommandInput]): import("@smithy/core/client").CommandImpl<ListBillingGroupsCommandInput, ListBillingGroupsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
