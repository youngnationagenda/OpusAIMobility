...
import type { DeleteDimensionRequest, DeleteDimensionResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DeleteDimensionCommand_base: {
    new (input: DeleteDimensionCommandInput): import("@smithy/core/client").CommandImpl<DeleteDimensionCommandInput, DeleteDimensionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteDimensionCommandInput): import("@smithy/core/client").CommandImpl<DeleteDimensionCommandInput, DeleteDimensionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
