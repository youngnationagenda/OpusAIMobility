...
import type { ListCertificatesRequest, ListCertificatesResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const ListCertificatesCommand_base: {
    new (input: ListCertificatesCommandInput): import("@smithy/core/client").CommandImpl<ListCertificatesCommandInput, ListCertificatesCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListCertificatesCommandInput]): import("@smithy/core/client").CommandImpl<ListCertificatesCommandInput, ListCertificatesCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
