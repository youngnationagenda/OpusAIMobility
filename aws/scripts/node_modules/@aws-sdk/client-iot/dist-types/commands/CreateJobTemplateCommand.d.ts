...
declare const CreateJobTemplateCommand_base: {
    new (input: CreateJobTemplateCommandInput): import("@smithy/core/client").CommandImpl<CreateJobTemplateCommandInput, CreateJobTemplateCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateJobTemplateCommandInput): import("@smithy/core/client").CommandImpl<CreateJobTemplateCommandInput, CreateJobTemplateCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
