...
import type { CreateCustomMetricRequest, CreateCustomMetricResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateCustomMetricCommand_base: {
    new (input: CreateCustomMetricCommandInput): import("@smithy/core/client").CommandImpl<CreateCustomMetricCommandInput, CreateCustomMetricCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateCustomMetricCommandInput): import("@smithy/core/client").CommandImpl<CreateCustomMetricCommandInput, CreateCustomMetricCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
