...
declare const CreateKeysAndCertificateCommand_base: {
    new (input: CreateKeysAndCertificateCommandInput): import("@smithy/core/client").CommandImpl<CreateKeysAndCertificateCommandInput, CreateKeysAndCertificateCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [CreateKeysAndCertificateCommandInput]): import("@smithy/core/client").CommandImpl<CreateKeysAndCertificateCommandInput, CreateKeysAndCertificateCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
