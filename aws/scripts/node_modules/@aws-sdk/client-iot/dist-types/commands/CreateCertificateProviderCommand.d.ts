...
declare const CreateCertificateProviderCommand_base: {
    new (input: CreateCertificateProviderCommandInput): import("@smithy/core/client").CommandImpl<CreateCertificateProviderCommandInput, CreateCertificateProviderCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateCertificateProviderCommandInput): import("@smithy/core/client").CommandImpl<CreateCertificateProviderCommandInput, CreateCertificateProviderCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
