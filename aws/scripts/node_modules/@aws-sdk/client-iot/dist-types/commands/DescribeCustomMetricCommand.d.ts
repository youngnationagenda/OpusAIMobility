...
import type { DescribeCustomMetricRequest, DescribeCustomMetricResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const DescribeCustomMetricCommand_base: {
    new (input: DescribeCustomMetricCommandInput): import("@smithy/core/client").CommandImpl<DescribeCustomMetricCommandInput, DescribeCustomMetricCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeCustomMetricCommandInput): import("@smithy/core/client").CommandImpl<DescribeCustomMetricCommandInput, DescribeCustomMetricCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
