...
declare const StopThingRegistrationTaskCommand_base: {
    new (input: StopThingRegistrationTaskCommandInput): import("@smithy/core/client").CommandImpl<StopThingRegistrationTaskCommandInput, StopThingRegistrationTaskCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopThingRegistrationTaskCommandInput): import("@smithy/core/client").CommandImpl<StopThingRegistrationTaskCommandInput, StopThingRegistrationTaskCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
