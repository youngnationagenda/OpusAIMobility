...
declare const AttachPolicyCommand_base: {
    new (input: AttachPolicyCommandInput): import("@smithy/core/client").CommandImpl<AttachPolicyCommandInput, AttachPolicyCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AttachPolicyCommandInput): import("@smithy/core/client").CommandImpl<AttachPolicyCommandInput, AttachPolicyCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
