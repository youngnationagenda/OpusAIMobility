...
import type { DeleteAuditSuppressionRequest, DeleteAuditSuppressionResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DeleteAuditSuppressionCommand_base: {
    new (input: DeleteAuditSuppressionCommandInput): import("@smithy/core/client").CommandImpl<DeleteAuditSuppressionCommandInput, DeleteAuditSuppressionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteAuditSuppressionCommandInput): import("@smithy/core/client").CommandImpl<DeleteAuditSuppressionCommandInput, DeleteAuditSuppressionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
