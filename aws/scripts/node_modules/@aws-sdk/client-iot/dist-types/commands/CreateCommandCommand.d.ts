...
declare const CreateCommandCommand_base: {
    new (input: CreateCommandCommandInput): import("@smithy/core/client").CommandImpl<CreateCommandCommandInput, CreateCommandCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateCommandCommandInput): import("@smithy/core/client").CommandImpl<CreateCommandCommandInput, CreateCommandCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
