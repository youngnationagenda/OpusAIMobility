...
import type { DescribeCACertificateRequest, DescribeCACertificateResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const DescribeCACertificateCommand_base: {
    new (input: DescribeCACertificateCommandInput): import("@smithy/core/client").CommandImpl<DescribeCACertificateCommandInput, DescribeCACertificateCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeCACertificateCommandInput): import("@smithy/core/client").CommandImpl<DescribeCACertificateCommandInput, DescribeCACertificateCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
