...
declare const ListTargetsForPolicyCommand_base: {
    new (input: ListTargetsForPolicyCommandInput): import("@smithy/core/client").CommandImpl<ListTargetsForPolicyCommandInput, ListTargetsForPolicyCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListTargetsForPolicyCommandInput): import("@smithy/core/client").CommandImpl<ListTargetsForPolicyCommandInput, ListTargetsForPolicyCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
