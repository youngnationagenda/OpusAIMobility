...
declare const GetJobDocumentCommand_base: {
    new (input: GetJobDocumentCommandInput): import("@smithy/core/client").CommandImpl<GetJobDocumentCommandInput, GetJobDocumentCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetJobDocumentCommandInput): import("@smithy/core/client").CommandImpl<GetJobDocumentCommandInput, GetJobDocumentCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
