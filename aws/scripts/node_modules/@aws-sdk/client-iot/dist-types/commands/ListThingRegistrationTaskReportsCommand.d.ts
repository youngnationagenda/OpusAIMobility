...
declare const ListThingRegistrationTaskReportsCommand_base: {
    new (input: ListThingRegistrationTaskReportsCommandInput): import("@smithy/core/client").CommandImpl<ListThingRegistrationTaskReportsCommandInput, ListThingRegistrationTaskReportsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListThingRegistrationTaskReportsCommandInput): import("@smithy/core/client").CommandImpl<ListThingRegistrationTaskReportsCommandInput, ListThingRegistrationTaskReportsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
