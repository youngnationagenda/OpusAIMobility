...
import type { CreateScheduledAuditRequest, CreateScheduledAuditResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateScheduledAuditCommand_base: {
    new (input: CreateScheduledAuditCommandInput): import("@smithy/core/client").CommandImpl<CreateScheduledAuditCommandInput, CreateScheduledAuditCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateScheduledAuditCommandInput): import("@smithy/core/client").CommandImpl<CreateScheduledAuditCommandInput, CreateScheduledAuditCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
