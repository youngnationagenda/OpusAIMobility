...
declare const GetPackageConfigurationCommand_base: {
    new (input: GetPackageConfigurationCommandInput): import("@smithy/core/client").CommandImpl<GetPackageConfigurationCommandInput, GetPackageConfigurationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetPackageConfigurationCommandInput]): import("@smithy/core/client").CommandImpl<GetPackageConfigurationCommandInput, GetPackageConfigurationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
