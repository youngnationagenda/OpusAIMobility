...
declare const CreateProvisioningClaimCommand_base: {
    new (input: CreateProvisioningClaimCommandInput): import("@smithy/core/client").CommandImpl<CreateProvisioningClaimCommandInput, CreateProvisioningClaimCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateProvisioningClaimCommandInput): import("@smithy/core/client").CommandImpl<CreateProvisioningClaimCommandInput, CreateProvisioningClaimCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
