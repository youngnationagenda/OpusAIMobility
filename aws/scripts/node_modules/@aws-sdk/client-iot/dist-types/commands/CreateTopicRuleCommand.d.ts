...
declare const CreateTopicRuleCommand_base: {
    new (input: CreateTopicRuleCommandInput): import("@smithy/core/client").CommandImpl<CreateTopicRuleCommandInput, CreateTopicRuleCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateTopicRuleCommandInput): import("@smithy/core/client").CommandImpl<CreateTopicRuleCommandInput, CreateTopicRuleCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
