...
import type { DescribeDomainConfigurationRequest, DescribeDomainConfigurationResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const DescribeDomainConfigurationCommand_base: {
    new (input: DescribeDomainConfigurationCommandInput): import("@smithy/core/client").CommandImpl<DescribeDomainConfigurationCommandInput, DescribeDomainConfigurationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeDomainConfigurationCommandInput): import("@smithy/core/client").CommandImpl<DescribeDomainConfigurationCommandInput, DescribeDomainConfigurationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
