...
import type { CreateFleetMetricRequest, CreateFleetMetricResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateFleetMetricCommand_base: {
    new (input: CreateFleetMetricCommandInput): import("@smithy/core/client").CommandImpl<CreateFleetMetricCommandInput, CreateFleetMetricCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateFleetMetricCommandInput): import("@smithy/core/client").CommandImpl<CreateFleetMetricCommandInput, CreateFleetMetricCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
