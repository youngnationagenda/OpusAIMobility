...
import type { ListDetectMitigationActionsTasksRequest, ListDetectMitigationActionsTasksResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const ListDetectMitigationActionsTasksCommand_base: {
    new (input: ListDetectMitigationActionsTasksCommandInput): import("@smithy/core/client").CommandImpl<ListDetectMitigationActionsTasksCommandInput, ListDetectMitigationActionsTasksCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListDetectMitigationActionsTasksCommandInput): import("@smithy/core/client").CommandImpl<ListDetectMitigationActionsTasksCommandInput, ListDetectMitigationActionsTasksCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
