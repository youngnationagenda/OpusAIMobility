...
import type { DetachPolicyRequest } from "../models/models_1";
/**
 * @public
 */
...
declare const DetachPolicyCommand_base: {
    new (input: DetachPolicyCommandInput): import("@smithy/core/client").CommandImpl<DetachPolicyCommandInput, DetachPolicyCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DetachPolicyCommandInput): import("@smithy/core/client").CommandImpl<DetachPolicyCommandInput, DetachPolicyCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
