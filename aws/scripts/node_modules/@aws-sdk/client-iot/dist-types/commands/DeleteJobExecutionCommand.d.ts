...
declare const DeleteJobExecutionCommand_base: {
    new (input: DeleteJobExecutionCommandInput): import("@smithy/core/client").CommandImpl<DeleteJobExecutionCommandInput, DeleteJobExecutionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteJobExecutionCommandInput): import("@smithy/core/client").CommandImpl<DeleteJobExecutionCommandInput, DeleteJobExecutionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
