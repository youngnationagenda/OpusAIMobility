...
declare const RejectCertificateTransferCommand_base: {
    new (input: RejectCertificateTransferCommandInput): import("@smithy/core/client").CommandImpl<RejectCertificateTransferCommandInput, RejectCertificateTransferCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RejectCertificateTransferCommandInput): import("@smithy/core/client").CommandImpl<RejectCertificateTransferCommandInput, RejectCertificateTransferCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
