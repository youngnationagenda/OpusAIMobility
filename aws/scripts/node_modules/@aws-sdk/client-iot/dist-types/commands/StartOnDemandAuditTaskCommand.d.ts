...
declare const StartOnDemandAuditTaskCommand_base: {
    new (input: StartOnDemandAuditTaskCommandInput): import("@smithy/core/client").CommandImpl<StartOnDemandAuditTaskCommandInput, StartOnDemandAuditTaskCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartOnDemandAuditTaskCommandInput): import("@smithy/core/client").CommandImpl<StartOnDemandAuditTaskCommandInput, StartOnDemandAuditTaskCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
