...
declare const DescribeRoleAliasCommand_base: {
    new (input: DescribeRoleAliasCommandInput): import("@smithy/core/client").CommandImpl<DescribeRoleAliasCommandInput, DescribeRoleAliasCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeRoleAliasCommandInput): import("@smithy/core/client").CommandImpl<DescribeRoleAliasCommandInput, DescribeRoleAliasCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
