...
import type { DescribeScheduledAuditRequest, DescribeScheduledAuditResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const DescribeScheduledAuditCommand_base: {
    new (input: DescribeScheduledAuditCommandInput): import("@smithy/core/client").CommandImpl<DescribeScheduledAuditCommandInput, DescribeScheduledAuditCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeScheduledAuditCommandInput): import("@smithy/core/client").CommandImpl<DescribeScheduledAuditCommandInput, DescribeScheduledAuditCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
