...
import type { CreateMitigationActionRequest, CreateMitigationActionResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateMitigationActionCommand_base: {
    new (input: CreateMitigationActionCommandInput): import("@smithy/core/client").CommandImpl<CreateMitigationActionCommandInput, CreateMitigationActionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateMitigationActionCommandInput): import("@smithy/core/client").CommandImpl<CreateMitigationActionCommandInput, CreateMitigationActionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
