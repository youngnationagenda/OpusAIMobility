...
declare const StartAuditMitigationActionsTaskCommand_base: {
    new (input: StartAuditMitigationActionsTaskCommandInput): import("@smithy/core/client").CommandImpl<StartAuditMitigationActionsTaskCommandInput, StartAuditMitigationActionsTaskCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartAuditMitigationActionsTaskCommandInput): import("@smithy/core/client").CommandImpl<StartAuditMitigationActionsTaskCommandInput, StartAuditMitigationActionsTaskCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
