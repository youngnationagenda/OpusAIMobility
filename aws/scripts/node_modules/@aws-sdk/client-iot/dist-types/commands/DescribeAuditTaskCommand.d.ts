...
declare const DescribeAuditTaskCommand_base: {
    new (input: DescribeAuditTaskCommandInput): import("@smithy/core/client").CommandImpl<DescribeAuditTaskCommandInput, DescribeAuditTaskCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeAuditTaskCommandInput): import("@smithy/core/client").CommandImpl<DescribeAuditTaskCommandInput, DescribeAuditTaskCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
