...
declare const CreateOTAUpdateCommand_base: {
    new (input: CreateOTAUpdateCommandInput): import("@smithy/core/client").CommandImpl<CreateOTAUpdateCommandInput, CreateOTAUpdateCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateOTAUpdateCommandInput): import("@smithy/core/client").CommandImpl<CreateOTAUpdateCommandInput, CreateOTAUpdateCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
