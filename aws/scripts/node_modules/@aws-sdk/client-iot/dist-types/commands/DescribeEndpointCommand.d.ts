...
import type { DescribeEndpointRequest, DescribeEndpointResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const DescribeEndpointCommand_base: {
    new (input: DescribeEndpointCommandInput): import("@smithy/core/client").CommandImpl<DescribeEndpointCommandInput, DescribeEndpointCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeEndpointCommandInput]): import("@smithy/core/client").CommandImpl<DescribeEndpointCommandInput, DescribeEndpointCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
