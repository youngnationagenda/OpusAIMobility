...
declare const TransferCertificateCommand_base: {
    new (input: TransferCertificateCommandInput): import("@smithy/core/client").CommandImpl<TransferCertificateCommandInput, TransferCertificateCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: TransferCertificateCommandInput): import("@smithy/core/client").CommandImpl<TransferCertificateCommandInput, TransferCertificateCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
