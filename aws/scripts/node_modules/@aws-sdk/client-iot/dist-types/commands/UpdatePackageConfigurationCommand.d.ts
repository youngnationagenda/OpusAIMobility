...
declare const UpdatePackageConfigurationCommand_base: {
    new (input: UpdatePackageConfigurationCommandInput): import("@smithy/core/client").CommandImpl<UpdatePackageConfigurationCommandInput, UpdatePackageConfigurationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [UpdatePackageConfigurationCommandInput]): import("@smithy/core/client").CommandImpl<UpdatePackageConfigurationCommandInput, UpdatePackageConfigurationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
