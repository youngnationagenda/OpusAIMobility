...
declare const GetPackageCommand_base: {
    new (input: GetPackageCommandInput): import("@smithy/core/client").CommandImpl<GetPackageCommandInput, GetPackageCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetPackageCommandInput): import("@smithy/core/client").CommandImpl<GetPackageCommandInput, GetPackageCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
