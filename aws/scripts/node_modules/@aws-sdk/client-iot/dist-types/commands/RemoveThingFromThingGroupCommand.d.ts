...
declare const RemoveThingFromThingGroupCommand_base: {
    new (input: RemoveThingFromThingGroupCommandInput): import("@smithy/core/client").CommandImpl<RemoveThingFromThingGroupCommandInput, RemoveThingFromThingGroupCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [RemoveThingFromThingGroupCommandInput]): import("@smithy/core/client").CommandImpl<RemoveThingFromThingGroupCommandInput, RemoveThingFromThingGroupCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
