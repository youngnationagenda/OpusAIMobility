...
declare const SetLoggingOptionsCommand_base: {
    new (input: SetLoggingOptionsCommandInput): import("@smithy/core/client").CommandImpl<SetLoggingOptionsCommandInput, SetLoggingOptionsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SetLoggingOptionsCommandInput): import("@smithy/core/client").CommandImpl<SetLoggingOptionsCommandInput, SetLoggingOptionsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
