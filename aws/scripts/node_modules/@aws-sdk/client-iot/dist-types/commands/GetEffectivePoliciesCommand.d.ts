...
import type { GetEffectivePoliciesRequest, GetEffectivePoliciesResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const GetEffectivePoliciesCommand_base: {
    new (input: GetEffectivePoliciesCommandInput): import("@smithy/core/client").CommandImpl<GetEffectivePoliciesCommandInput, GetEffectivePoliciesCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetEffectivePoliciesCommandInput]): import("@smithy/core/client").CommandImpl<GetEffectivePoliciesCommandInput, GetEffectivePoliciesCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
