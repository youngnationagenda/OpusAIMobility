...
declare const ListSecurityProfilesForTargetCommand_base: {
    new (input: ListSecurityProfilesForTargetCommandInput): import("@smithy/core/client").CommandImpl<ListSecurityProfilesForTargetCommandInput, ListSecurityProfilesForTargetCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListSecurityProfilesForTargetCommandInput): import("@smithy/core/client").CommandImpl<ListSecurityProfilesForTargetCommandInput, ListSecurityProfilesForTargetCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
