...
import type { DescribeThingRegistrationTaskRequest, DescribeThingRegistrationTaskResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const DescribeThingRegistrationTaskCommand_base: {
    new (input: DescribeThingRegistrationTaskCommandInput): import("@smithy/core/client").CommandImpl<DescribeThingRegistrationTaskCommandInput, DescribeThingRegistrationTaskCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeThingRegistrationTaskCommandInput): import("@smithy/core/client").CommandImpl<DescribeThingRegistrationTaskCommandInput, DescribeThingRegistrationTaskCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
