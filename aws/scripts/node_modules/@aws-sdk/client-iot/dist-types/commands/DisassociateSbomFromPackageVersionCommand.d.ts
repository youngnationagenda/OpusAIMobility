...
import type { DisassociateSbomFromPackageVersionRequest, DisassociateSbomFromPackageVersionResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const DisassociateSbomFromPackageVersionCommand_base: {
    new (input: DisassociateSbomFromPackageVersionCommandInput): import("@smithy/core/client").CommandImpl<DisassociateSbomFromPackageVersionCommandInput, DisassociateSbomFromPackageVersionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisassociateSbomFromPackageVersionCommandInput): import("@smithy/core/client").CommandImpl<DisassociateSbomFromPackageVersionCommandInput, DisassociateSbomFromPackageVersionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
