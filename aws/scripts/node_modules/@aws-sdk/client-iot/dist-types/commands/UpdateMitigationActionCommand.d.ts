...
import type { UpdateMitigationActionRequest, UpdateMitigationActionResponse } from "../models/models_2";
/**
 * @public
 */
...
declare const UpdateMitigationActionCommand_base: {
    new (input: UpdateMitigationActionCommandInput): import("@smithy/core/client").CommandImpl<UpdateMitigationActionCommandInput, UpdateMitigationActionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateMitigationActionCommandInput): import("@smithy/core/client").CommandImpl<UpdateMitigationActionCommandInput, UpdateMitigationActionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
