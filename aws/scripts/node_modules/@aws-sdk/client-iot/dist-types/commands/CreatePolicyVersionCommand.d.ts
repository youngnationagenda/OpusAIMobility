...
declare const CreatePolicyVersionCommand_base: {
    new (input: CreatePolicyVersionCommandInput): import("@smithy/core/client").CommandImpl<CreatePolicyVersionCommandInput, CreatePolicyVersionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreatePolicyVersionCommandInput): import("@smithy/core/client").CommandImpl<CreatePolicyVersionCommandInput, CreatePolicyVersionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
