...
declare const DetachThingPrincipalCommand_base: {
    new (input: DetachThingPrincipalCommandInput): import("@smithy/core/client").CommandImpl<DetachThingPrincipalCommandInput, DetachThingPrincipalCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DetachThingPrincipalCommandInput): import("@smithy/core/client").CommandImpl<DetachThingPrincipalCommandInput, DetachThingPrincipalCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
