...
declare const ListAttachedPoliciesCommand_base: {
    new (input: ListAttachedPoliciesCommandInput): import("@smithy/core/client").CommandImpl<ListAttachedPoliciesCommandInput, ListAttachedPoliciesCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListAttachedPoliciesCommandInput): import("@smithy/core/client").CommandImpl<ListAttachedPoliciesCommandInput, ListAttachedPoliciesCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
