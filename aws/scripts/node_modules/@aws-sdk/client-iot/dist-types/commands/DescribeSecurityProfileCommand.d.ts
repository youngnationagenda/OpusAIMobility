...
declare const DescribeSecurityProfileCommand_base: {
    new (input: DescribeSecurityProfileCommandInput): import("@smithy/core/client").CommandImpl<DescribeSecurityProfileCommandInput, DescribeSecurityProfileCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeSecurityProfileCommandInput): import("@smithy/core/client").CommandImpl<DescribeSecurityProfileCommandInput, DescribeSecurityProfileCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
