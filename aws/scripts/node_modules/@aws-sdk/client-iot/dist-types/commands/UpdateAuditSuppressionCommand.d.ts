...
declare const UpdateAuditSuppressionCommand_base: {
    new (input: UpdateAuditSuppressionCommandInput): import("@smithy/core/client").CommandImpl<UpdateAuditSuppressionCommandInput, UpdateAuditSuppressionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateAuditSuppressionCommandInput): import("@smithy/core/client").CommandImpl<UpdateAuditSuppressionCommandInput, UpdateAuditSuppressionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
