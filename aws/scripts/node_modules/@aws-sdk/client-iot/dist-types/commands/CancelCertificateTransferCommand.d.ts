...
import type { CancelCertificateTransferRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const CancelCertificateTransferCommand_base: {
    new (input: CancelCertificateTransferCommandInput): import("@smithy/core/client").CommandImpl<CancelCertificateTransferCommandInput, CancelCertificateTransferCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CancelCertificateTransferCommandInput): import("@smithy/core/client").CommandImpl<CancelCertificateTransferCommandInput, CancelCertificateTransferCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
