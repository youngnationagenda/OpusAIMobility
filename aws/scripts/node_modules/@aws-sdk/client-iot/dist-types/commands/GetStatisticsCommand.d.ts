...
import type { GetStatisticsRequest, GetStatisticsResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const GetStatisticsCommand_base: {
    new (input: GetStatisticsCommandInput): import("@smithy/core/client").CommandImpl<GetStatisticsCommandInput, GetStatisticsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetStatisticsCommandInput): import("@smithy/core/client").CommandImpl<GetStatisticsCommandInput, GetStatisticsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
