...
declare const ListThingPrincipalsV2Command_base: {
    new (input: ListThingPrincipalsV2CommandInput): import("@smithy/core/client").CommandImpl<ListThingPrincipalsV2CommandInput, ListThingPrincipalsV2CommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListThingPrincipalsV2CommandInput): import("@smithy/core/client").CommandImpl<ListThingPrincipalsV2CommandInput, ListThingPrincipalsV2CommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
