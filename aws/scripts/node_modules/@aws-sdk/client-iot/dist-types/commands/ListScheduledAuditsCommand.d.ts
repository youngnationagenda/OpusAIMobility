...
declare const ListScheduledAuditsCommand_base: {
    new (input: ListScheduledAuditsCommandInput): import("@smithy/core/client").CommandImpl<ListScheduledAuditsCommandInput, ListScheduledAuditsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListScheduledAuditsCommandInput]): import("@smithy/core/client").CommandImpl<ListScheduledAuditsCommandInput, ListScheduledAuditsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
