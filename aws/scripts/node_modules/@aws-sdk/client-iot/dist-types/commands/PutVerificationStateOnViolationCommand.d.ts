...
declare const PutVerificationStateOnViolationCommand_base: {
    new (input: PutVerificationStateOnViolationCommandInput): import("@smithy/core/client").CommandImpl<PutVerificationStateOnViolationCommandInput, PutVerificationStateOnViolationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutVerificationStateOnViolationCommandInput): import("@smithy/core/client").CommandImpl<PutVerificationStateOnViolationCommandInput, PutVerificationStateOnViolationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
