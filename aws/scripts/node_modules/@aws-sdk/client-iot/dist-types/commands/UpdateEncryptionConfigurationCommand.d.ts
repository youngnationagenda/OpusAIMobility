...
import type { UpdateEncryptionConfigurationRequest, UpdateEncryptionConfigurationResponse } from "../models/models_2";
/**
 * @public
 */
...
declare const UpdateEncryptionConfigurationCommand_base: {
    new (input: UpdateEncryptionConfigurationCommandInput): import("@smithy/core/client").CommandImpl<UpdateEncryptionConfigurationCommandInput, UpdateEncryptionConfigurationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateEncryptionConfigurationCommandInput): import("@smithy/core/client").CommandImpl<UpdateEncryptionConfigurationCommandInput, UpdateEncryptionConfigurationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
