...
declare const DeleteCACertificateCommand_base: {
    new (input: DeleteCACertificateCommandInput): import("@smithy/core/client").CommandImpl<DeleteCACertificateCommandInput, DeleteCACertificateCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteCACertificateCommandInput): import("@smithy/core/client").CommandImpl<DeleteCACertificateCommandInput, DeleteCACertificateCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
