...
declare const ConfirmTopicRuleDestinationCommand_base: {
    new (input: ConfirmTopicRuleDestinationCommandInput): import("@smithy/core/client").CommandImpl<ConfirmTopicRuleDestinationCommandInput, ConfirmTopicRuleDestinationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ConfirmTopicRuleDestinationCommandInput): import("@smithy/core/client").CommandImpl<ConfirmTopicRuleDestinationCommandInput, ConfirmTopicRuleDestinationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
