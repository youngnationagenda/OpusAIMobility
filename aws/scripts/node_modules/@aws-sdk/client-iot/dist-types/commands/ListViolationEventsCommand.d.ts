...
declare const ListViolationEventsCommand_base: {
    new (input: ListViolationEventsCommandInput): import("@smithy/core/client").CommandImpl<ListViolationEventsCommandInput, ListViolationEventsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListViolationEventsCommandInput): import("@smithy/core/client").CommandImpl<ListViolationEventsCommandInput, ListViolationEventsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
