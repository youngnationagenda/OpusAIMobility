...
declare const ReplaceTopicRuleCommand_base: {
    new (input: ReplaceTopicRuleCommandInput): import("@smithy/core/client").CommandImpl<ReplaceTopicRuleCommandInput, ReplaceTopicRuleCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ReplaceTopicRuleCommandInput): import("@smithy/core/client").CommandImpl<ReplaceTopicRuleCommandInput, ReplaceTopicRuleCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
