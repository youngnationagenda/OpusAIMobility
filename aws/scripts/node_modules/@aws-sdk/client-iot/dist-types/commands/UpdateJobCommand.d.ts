...
import type { UpdateJobRequest } from "../models/models_2";
/**
 * @public
 */
...
declare const UpdateJobCommand_base: {
    new (input: UpdateJobCommandInput): import("@smithy/core/client").CommandImpl<UpdateJobCommandInput, UpdateJobCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateJobCommandInput): import("@smithy/core/client").CommandImpl<UpdateJobCommandInput, UpdateJobCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
