...
declare const UpdateTopicRuleDestinationCommand_base: {
    new (input: UpdateTopicRuleDestinationCommandInput): import("@smithy/core/client").CommandImpl<UpdateTopicRuleDestinationCommandInput, UpdateTopicRuleDestinationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateTopicRuleDestinationCommandInput): import("@smithy/core/client").CommandImpl<UpdateTopicRuleDestinationCommandInput, UpdateTopicRuleDestinationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
