...
declare const CreatePackageCommand_base: {
    new (input: CreatePackageCommandInput): import("@smithy/core/client").CommandImpl<CreatePackageCommandInput, CreatePackageCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreatePackageCommandInput): import("@smithy/core/client").CommandImpl<CreatePackageCommandInput, CreatePackageCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
