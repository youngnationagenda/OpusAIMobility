...
declare const CreatePolicyCommand_base: {
    new (input: CreatePolicyCommandInput): import("@smithy/core/client").CommandImpl<CreatePolicyCommandInput, CreatePolicyCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreatePolicyCommandInput): import("@smithy/core/client").CommandImpl<CreatePolicyCommandInput, CreatePolicyCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
