...
declare const GetCardinalityCommand_base: {
    new (input: GetCardinalityCommandInput): import("@smithy/core/client").CommandImpl<GetCardinalityCommandInput, GetCardinalityCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetCardinalityCommandInput): import("@smithy/core/client").CommandImpl<GetCardinalityCommandInput, GetCardinalityCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
