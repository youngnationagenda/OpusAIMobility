...
declare const ListAuthorizersCommand_base: {
    new (input: ListAuthorizersCommandInput): import("@smithy/core/client").CommandImpl<ListAuthorizersCommandInput, ListAuthorizersCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListAuthorizersCommandInput]): import("@smithy/core/client").CommandImpl<ListAuthorizersCommandInput, ListAuthorizersCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
