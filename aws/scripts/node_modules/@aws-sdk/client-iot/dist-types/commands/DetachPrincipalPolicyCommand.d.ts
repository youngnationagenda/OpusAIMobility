...
declare const DetachPrincipalPolicyCommand_base: {
    new (input: DetachPrincipalPolicyCommandInput): import("@smithy/core/client").CommandImpl<DetachPrincipalPolicyCommandInput, DetachPrincipalPolicyCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DetachPrincipalPolicyCommandInput): import("@smithy/core/client").CommandImpl<DetachPrincipalPolicyCommandInput, DetachPrincipalPolicyCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
