...
declare const ListAuditSuppressionsCommand_base: {
    new (input: ListAuditSuppressionsCommandInput): import("@smithy/core/client").CommandImpl<ListAuditSuppressionsCommandInput, ListAuditSuppressionsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListAuditSuppressionsCommandInput]): import("@smithy/core/client").CommandImpl<ListAuditSuppressionsCommandInput, ListAuditSuppressionsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
