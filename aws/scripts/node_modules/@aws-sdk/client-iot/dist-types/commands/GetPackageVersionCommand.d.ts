...
declare const GetPackageVersionCommand_base: {
    new (input: GetPackageVersionCommandInput): import("@smithy/core/client").CommandImpl<GetPackageVersionCommandInput, GetPackageVersionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetPackageVersionCommandInput): import("@smithy/core/client").CommandImpl<GetPackageVersionCommandInput, GetPackageVersionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
