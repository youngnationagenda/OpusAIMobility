...
declare const UpdateDomainConfigurationCommand_base: {
    new (input: UpdateDomainConfigurationCommandInput): import("@smithy/core/client").CommandImpl<UpdateDomainConfigurationCommandInput, UpdateDomainConfigurationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateDomainConfigurationCommandInput): import("@smithy/core/client").CommandImpl<UpdateDomainConfigurationCommandInput, UpdateDomainConfigurationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
