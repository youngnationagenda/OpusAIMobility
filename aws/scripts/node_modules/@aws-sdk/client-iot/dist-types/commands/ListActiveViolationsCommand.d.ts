...
import type { ListActiveViolationsRequest, ListActiveViolationsResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const ListActiveViolationsCommand_base: {
    new (input: ListActiveViolationsCommandInput): import("@smithy/core/client").CommandImpl<ListActiveViolationsCommandInput, ListActiveViolationsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListActiveViolationsCommandInput]): import("@smithy/core/client").CommandImpl<ListActiveViolationsCommandInput, ListActiveViolationsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
