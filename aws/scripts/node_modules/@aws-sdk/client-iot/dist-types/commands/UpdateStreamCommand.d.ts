...
declare const UpdateStreamCommand_base: {
    new (input: UpdateStreamCommandInput): import("@smithy/core/client").CommandImpl<UpdateStreamCommandInput, UpdateStreamCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateStreamCommandInput): import("@smithy/core/client").CommandImpl<UpdateStreamCommandInput, UpdateStreamCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
