...
import type { GetRegistrationCodeRequest, GetRegistrationCodeResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const GetRegistrationCodeCommand_base: {
    new (input: GetRegistrationCodeCommandInput): import("@smithy/core/client").CommandImpl<GetRegistrationCodeCommandInput, GetRegistrationCodeCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetRegistrationCodeCommandInput]): import("@smithy/core/client").CommandImpl<GetRegistrationCodeCommandInput, GetRegistrationCodeCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
