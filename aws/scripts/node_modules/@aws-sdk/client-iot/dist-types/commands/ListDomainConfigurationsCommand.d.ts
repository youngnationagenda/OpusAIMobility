...
import type { ListDomainConfigurationsRequest, ListDomainConfigurationsResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const ListDomainConfigurationsCommand_base: {
    new (input: ListDomainConfigurationsCommandInput): import("@smithy/core/client").CommandImpl<ListDomainConfigurationsCommandInput, ListDomainConfigurationsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListDomainConfigurationsCommandInput]): import("@smithy/core/client").CommandImpl<ListDomainConfigurationsCommandInput, ListDomainConfigurationsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
