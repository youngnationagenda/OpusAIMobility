...
declare const GetCommandCommand_base: {
    new (input: GetCommandCommandInput): import("@smithy/core/client").CommandImpl<GetCommandCommandInput, GetCommandCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetCommandCommandInput): import("@smithy/core/client").CommandImpl<GetCommandCommandInput, GetCommandCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
