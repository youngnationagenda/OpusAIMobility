...
declare const TestInvokeAuthorizerCommand_base: {
    new (input: TestInvokeAuthorizerCommandInput): import("@smithy/core/client").CommandImpl<TestInvokeAuthorizerCommandInput, TestInvokeAuthorizerCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: TestInvokeAuthorizerCommandInput): import("@smithy/core/client").CommandImpl<TestInvokeAuthorizerCommandInput, TestInvokeAuthorizerCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
