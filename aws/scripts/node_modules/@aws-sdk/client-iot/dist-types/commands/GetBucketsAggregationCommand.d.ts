...
import type { GetBucketsAggregationRequest, GetBucketsAggregationResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const GetBucketsAggregationCommand_base: {
    new (input: GetBucketsAggregationCommandInput): import("@smithy/core/client").CommandImpl<GetBucketsAggregationCommandInput, GetBucketsAggregationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetBucketsAggregationCommandInput): import("@smithy/core/client").CommandImpl<GetBucketsAggregationCommandInput, GetBucketsAggregationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
