...
declare const CreateDomainConfigurationCommand_base: {
    new (input: CreateDomainConfigurationCommandInput): import("@smithy/core/client").CommandImpl<CreateDomainConfigurationCommandInput, CreateDomainConfigurationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateDomainConfigurationCommandInput): import("@smithy/core/client").CommandImpl<CreateDomainConfigurationCommandInput, CreateDomainConfigurationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
