...
import type { DescribeBillingGroupRequest, DescribeBillingGroupResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const DescribeBillingGroupCommand_base: {
    new (input: DescribeBillingGroupCommandInput): import("@smithy/core/client").CommandImpl<DescribeBillingGroupCommandInput, DescribeBillingGroupCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeBillingGroupCommandInput): import("@smithy/core/client").CommandImpl<DescribeBillingGroupCommandInput, DescribeBillingGroupCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
