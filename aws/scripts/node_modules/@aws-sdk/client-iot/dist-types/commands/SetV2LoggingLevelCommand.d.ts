...
declare const SetV2LoggingLevelCommand_base: {
    new (input: SetV2LoggingLevelCommandInput): import("@smithy/core/client").CommandImpl<SetV2LoggingLevelCommandInput, SetV2LoggingLevelCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SetV2LoggingLevelCommandInput): import("@smithy/core/client").CommandImpl<SetV2LoggingLevelCommandInput, SetV2LoggingLevelCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
