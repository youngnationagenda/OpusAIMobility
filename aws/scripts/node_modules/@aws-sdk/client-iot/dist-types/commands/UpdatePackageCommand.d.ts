...
import type { UpdatePackageRequest, UpdatePackageResponse } from "../models/models_2";
/**
 * @public
 */
...
declare const UpdatePackageCommand_base: {
    new (input: UpdatePackageCommandInput): import("@smithy/core/client").CommandImpl<UpdatePackageCommandInput, UpdatePackageCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdatePackageCommandInput): import("@smithy/core/client").CommandImpl<UpdatePackageCommandInput, UpdatePackageCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
