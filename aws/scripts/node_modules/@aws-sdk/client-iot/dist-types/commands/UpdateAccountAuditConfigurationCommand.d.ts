...
import type { UpdateAccountAuditConfigurationRequest, UpdateAccountAuditConfigurationResponse } from "../models/models_2";
/**
 * @public
 */
...
declare const UpdateAccountAuditConfigurationCommand_base: {
    new (input: UpdateAccountAuditConfigurationCommandInput): import("@smithy/core/client").CommandImpl<UpdateAccountAuditConfigurationCommandInput, UpdateAccountAuditConfigurationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [UpdateAccountAuditConfigurationCommandInput]): import("@smithy/core/client").CommandImpl<UpdateAccountAuditConfigurationCommandInput, UpdateAccountAuditConfigurationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
