...
import type { ValidateSecurityProfileBehaviorsRequest, ValidateSecurityProfileBehaviorsResponse } from "../models/models_2";
/**
 * @public
 */
...
declare const ValidateSecurityProfileBehaviorsCommand_base: {
    new (input: ValidateSecurityProfileBehaviorsCommandInput): import("@smithy/core/client").CommandImpl<ValidateSecurityProfileBehaviorsCommandInput, ValidateSecurityProfileBehaviorsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ValidateSecurityProfileBehaviorsCommandInput): import("@smithy/core/client").CommandImpl<ValidateSecurityProfileBehaviorsCommandInput, ValidateSecurityProfileBehaviorsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
