...
import type { AttachThingPrincipalRequest, AttachThingPrincipalResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const AttachThingPrincipalCommand_base: {
    new (input: AttachThingPrincipalCommandInput): import("@smithy/core/client").CommandImpl<AttachThingPrincipalCommandInput, AttachThingPrincipalCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AttachThingPrincipalCommandInput): import("@smithy/core/client").CommandImpl<AttachThingPrincipalCommandInput, AttachThingPrincipalCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
