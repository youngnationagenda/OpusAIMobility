...
declare const DetachSecurityProfileCommand_base: {
    new (input: DetachSecurityProfileCommandInput): import("@smithy/core/client").CommandImpl<DetachSecurityProfileCommandInput, DetachSecurityProfileCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DetachSecurityProfileCommandInput): import("@smithy/core/client").CommandImpl<DetachSecurityProfileCommandInput, DetachSecurityProfileCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
