...
import type { DeleteCommandRequest, DeleteCommandResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DeleteCommandCommand_base: {
    new (input: DeleteCommandCommandInput): import("@smithy/core/client").CommandImpl<DeleteCommandCommandInput, DeleteCommandCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteCommandCommandInput): import("@smithy/core/client").CommandImpl<DeleteCommandCommandInput, DeleteCommandCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
