...
declare const GetTopicRuleCommand_base: {
    new (input: GetTopicRuleCommandInput): import("@smithy/core/client").CommandImpl<GetTopicRuleCommandInput, GetTopicRuleCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetTopicRuleCommandInput): import("@smithy/core/client").CommandImpl<GetTopicRuleCommandInput, GetTopicRuleCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
