...
declare const EnableTopicRuleCommand_base: {
    new (input: EnableTopicRuleCommandInput): import("@smithy/core/client").CommandImpl<EnableTopicRuleCommandInput, EnableTopicRuleCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: EnableTopicRuleCommandInput): import("@smithy/core/client").CommandImpl<EnableTopicRuleCommandInput, EnableTopicRuleCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
