...
declare const ListAuditFindingsCommand_base: {
    new (input: ListAuditFindingsCommandInput): import("@smithy/core/client").CommandImpl<ListAuditFindingsCommandInput, ListAuditFindingsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListAuditFindingsCommandInput]): import("@smithy/core/client").CommandImpl<ListAuditFindingsCommandInput, ListAuditFindingsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
