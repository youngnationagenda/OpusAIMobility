...
declare const SetV2LoggingOptionsCommand_base: {
    new (input: SetV2LoggingOptionsCommandInput): import("@smithy/core/client").CommandImpl<SetV2LoggingOptionsCommandInput, SetV2LoggingOptionsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [SetV2LoggingOptionsCommandInput]): import("@smithy/core/client").CommandImpl<SetV2LoggingOptionsCommandInput, SetV2LoggingOptionsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
