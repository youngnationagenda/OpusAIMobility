...
declare const DescribeAuditSuppressionCommand_base: {
    new (input: DescribeAuditSuppressionCommandInput): import("@smithy/core/client").CommandImpl<DescribeAuditSuppressionCommandInput, DescribeAuditSuppressionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeAuditSuppressionCommandInput): import("@smithy/core/client").CommandImpl<DescribeAuditSuppressionCommandInput, DescribeAuditSuppressionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
