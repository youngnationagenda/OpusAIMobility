...
import type { DescribeMitigationActionRequest, DescribeMitigationActionResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const DescribeMitigationActionCommand_base: {
    new (input: DescribeMitigationActionCommandInput): import("@smithy/core/client").CommandImpl<DescribeMitigationActionCommandInput, DescribeMitigationActionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeMitigationActionCommandInput): import("@smithy/core/client").CommandImpl<DescribeMitigationActionCommandInput, DescribeMitigationActionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
