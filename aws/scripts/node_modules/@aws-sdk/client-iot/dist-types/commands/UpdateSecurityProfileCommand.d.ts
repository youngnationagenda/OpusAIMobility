...
declare const UpdateSecurityProfileCommand_base: {
    new (input: UpdateSecurityProfileCommandInput): import("@smithy/core/client").CommandImpl<UpdateSecurityProfileCommandInput, UpdateSecurityProfileCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateSecurityProfileCommandInput): import("@smithy/core/client").CommandImpl<UpdateSecurityProfileCommandInput, UpdateSecurityProfileCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
