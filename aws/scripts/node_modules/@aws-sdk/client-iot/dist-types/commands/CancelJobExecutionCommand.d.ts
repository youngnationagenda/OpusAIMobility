...
declare const CancelJobExecutionCommand_base: {
    new (input: CancelJobExecutionCommandInput): import("@smithy/core/client").CommandImpl<CancelJobExecutionCommandInput, CancelJobExecutionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CancelJobExecutionCommandInput): import("@smithy/core/client").CommandImpl<CancelJobExecutionCommandInput, CancelJobExecutionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
