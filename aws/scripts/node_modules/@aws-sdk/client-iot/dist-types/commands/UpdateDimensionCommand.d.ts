...
declare const UpdateDimensionCommand_base: {
    new (input: UpdateDimensionCommandInput): import("@smithy/core/client").CommandImpl<UpdateDimensionCommandInput, UpdateDimensionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateDimensionCommandInput): import("@smithy/core/client").CommandImpl<UpdateDimensionCommandInput, UpdateDimensionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
