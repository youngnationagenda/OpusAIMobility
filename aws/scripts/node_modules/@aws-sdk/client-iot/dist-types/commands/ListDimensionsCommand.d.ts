...
declare const ListDimensionsCommand_base: {
    new (input: ListDimensionsCommandInput): import("@smithy/core/client").CommandImpl<ListDimensionsCommandInput, ListDimensionsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListDimensionsCommandInput]): import("@smithy/core/client").CommandImpl<ListDimensionsCommandInput, ListDimensionsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
