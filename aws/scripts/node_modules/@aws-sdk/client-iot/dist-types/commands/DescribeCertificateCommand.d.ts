...
declare const DescribeCertificateCommand_base: {
    new (input: DescribeCertificateCommandInput): import("@smithy/core/client").CommandImpl<DescribeCertificateCommandInput, DescribeCertificateCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeCertificateCommandInput): import("@smithy/core/client").CommandImpl<DescribeCertificateCommandInput, DescribeCertificateCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
