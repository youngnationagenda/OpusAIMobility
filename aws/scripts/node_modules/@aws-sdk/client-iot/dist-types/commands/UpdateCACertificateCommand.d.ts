...
declare const UpdateCACertificateCommand_base: {
    new (input: UpdateCACertificateCommandInput): import("@smithy/core/client").CommandImpl<UpdateCACertificateCommandInput, UpdateCACertificateCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateCACertificateCommandInput): import("@smithy/core/client").CommandImpl<UpdateCACertificateCommandInput, UpdateCACertificateCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
