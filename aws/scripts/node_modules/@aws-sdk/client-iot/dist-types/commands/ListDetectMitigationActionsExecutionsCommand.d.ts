...
import type { ListDetectMitigationActionsExecutionsRequest, ListDetectMitigationActionsExecutionsResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const ListDetectMitigationActionsExecutionsCommand_base: {
    new (input: ListDetectMitigationActionsExecutionsCommandInput): import("@smithy/core/client").CommandImpl<ListDetectMitigationActionsExecutionsCommandInput, ListDetectMitigationActionsExecutionsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListDetectMitigationActionsExecutionsCommandInput]): import("@smithy/core/client").CommandImpl<ListDetectMitigationActionsExecutionsCommandInput, ListDetectMitigationActionsExecutionsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
