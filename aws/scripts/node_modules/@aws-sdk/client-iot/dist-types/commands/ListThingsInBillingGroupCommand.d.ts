...
declare const ListThingsInBillingGroupCommand_base: {
    new (input: ListThingsInBillingGroupCommandInput): import("@smithy/core/client").CommandImpl<ListThingsInBillingGroupCommandInput, ListThingsInBillingGroupCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListThingsInBillingGroupCommandInput): import("@smithy/core/client").CommandImpl<ListThingsInBillingGroupCommandInput, ListThingsInBillingGroupCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
