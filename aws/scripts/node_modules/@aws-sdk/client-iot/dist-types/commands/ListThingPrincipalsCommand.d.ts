...
declare const ListThingPrincipalsCommand_base: {
    new (input: ListThingPrincipalsCommandInput): import("@smithy/core/client").CommandImpl<ListThingPrincipalsCommandInput, ListThingPrincipalsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListThingPrincipalsCommandInput): import("@smithy/core/client").CommandImpl<ListThingPrincipalsCommandInput, ListThingPrincipalsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
