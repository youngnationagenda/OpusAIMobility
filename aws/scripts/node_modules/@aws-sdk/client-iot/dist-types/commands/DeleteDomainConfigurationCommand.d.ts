...
declare const DeleteDomainConfigurationCommand_base: {
    new (input: DeleteDomainConfigurationCommandInput): import("@smithy/core/client").CommandImpl<DeleteDomainConfigurationCommandInput, DeleteDomainConfigurationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteDomainConfigurationCommandInput): import("@smithy/core/client").CommandImpl<DeleteDomainConfigurationCommandInput, DeleteDomainConfigurationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
