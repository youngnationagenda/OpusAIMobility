...
import type { CreatePackageVersionRequest, CreatePackageVersionResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const CreatePackageVersionCommand_base: {
    new (input: CreatePackageVersionCommandInput): import("@smithy/core/client").CommandImpl<CreatePackageVersionCommandInput, CreatePackageVersionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreatePackageVersionCommandInput): import("@smithy/core/client").CommandImpl<CreatePackageVersionCommandInput, CreatePackageVersionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
