...
declare const GetV2LoggingOptionsCommand_base: {
    new (input: GetV2LoggingOptionsCommandInput): import("@smithy/core/client").CommandImpl<GetV2LoggingOptionsCommandInput, GetV2LoggingOptionsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetV2LoggingOptionsCommandInput]): import("@smithy/core/client").CommandImpl<GetV2LoggingOptionsCommandInput, GetV2LoggingOptionsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
