...
import type { ListAuditMitigationActionsExecutionsRequest, ListAuditMitigationActionsExecutionsResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const ListAuditMitigationActionsExecutionsCommand_base: {
    new (input: ListAuditMitigationActionsExecutionsCommandInput): import("@smithy/core/client").CommandImpl<ListAuditMitigationActionsExecutionsCommandInput, ListAuditMitigationActionsExecutionsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListAuditMitigationActionsExecutionsCommandInput): import("@smithy/core/client").CommandImpl<ListAuditMitigationActionsExecutionsCommandInput, ListAuditMitigationActionsExecutionsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
