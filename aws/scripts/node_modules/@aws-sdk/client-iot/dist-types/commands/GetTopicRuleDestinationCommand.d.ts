...
declare const GetTopicRuleDestinationCommand_base: {
    new (input: GetTopicRuleDestinationCommandInput): import("@smithy/core/client").CommandImpl<GetTopicRuleDestinationCommandInput, GetTopicRuleDestinationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetTopicRuleDestinationCommandInput): import("@smithy/core/client").CommandImpl<GetTopicRuleDestinationCommandInput, GetTopicRuleDestinationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
