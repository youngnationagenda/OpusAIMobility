...
import type { DescribeJobExecutionRequest, DescribeJobExecutionResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const DescribeJobExecutionCommand_base: {
    new (input: DescribeJobExecutionCommandInput): import("@smithy/core/client").CommandImpl<DescribeJobExecutionCommandInput, DescribeJobExecutionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeJobExecutionCommandInput): import("@smithy/core/client").CommandImpl<DescribeJobExecutionCommandInput, DescribeJobExecutionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
