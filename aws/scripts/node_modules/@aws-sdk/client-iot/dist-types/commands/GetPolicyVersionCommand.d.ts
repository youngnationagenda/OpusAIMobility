...
import type { GetPolicyVersionRequest, GetPolicyVersionResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const GetPolicyVersionCommand_base: {
    new (input: GetPolicyVersionCommandInput): import("@smithy/core/client").CommandImpl<GetPolicyVersionCommandInput, GetPolicyVersionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetPolicyVersionCommandInput): import("@smithy/core/client").CommandImpl<GetPolicyVersionCommandInput, GetPolicyVersionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
