...
declare const RemoveThingFromBillingGroupCommand_base: {
    new (input: RemoveThingFromBillingGroupCommandInput): import("@smithy/core/client").CommandImpl<RemoveThingFromBillingGroupCommandInput, RemoveThingFromBillingGroupCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [RemoveThingFromBillingGroupCommandInput]): import("@smithy/core/client").CommandImpl<RemoveThingFromBillingGroupCommandInput, RemoveThingFromBillingGroupCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
