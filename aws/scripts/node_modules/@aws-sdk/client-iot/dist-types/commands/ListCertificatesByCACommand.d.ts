...
import type { ListCertificatesByCARequest, ListCertificatesByCAResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const ListCertificatesByCACommand_base: {
    new (input: ListCertificatesByCACommandInput): import("@smithy/core/client").CommandImpl<ListCertificatesByCACommandInput, ListCertificatesByCACommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListCertificatesByCACommandInput): import("@smithy/core/client").CommandImpl<ListCertificatesByCACommandInput, ListCertificatesByCACommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
