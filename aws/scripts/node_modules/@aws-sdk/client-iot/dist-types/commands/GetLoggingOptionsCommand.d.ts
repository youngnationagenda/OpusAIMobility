...
declare const GetLoggingOptionsCommand_base: {
    new (input: GetLoggingOptionsCommandInput): import("@smithy/core/client").CommandImpl<GetLoggingOptionsCommandInput, GetLoggingOptionsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetLoggingOptionsCommandInput]): import("@smithy/core/client").CommandImpl<GetLoggingOptionsCommandInput, GetLoggingOptionsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
