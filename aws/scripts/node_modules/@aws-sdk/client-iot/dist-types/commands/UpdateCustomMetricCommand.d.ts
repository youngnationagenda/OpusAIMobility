...
declare const UpdateCustomMetricCommand_base: {
    new (input: UpdateCustomMetricCommandInput): import("@smithy/core/client").CommandImpl<UpdateCustomMetricCommandInput, UpdateCustomMetricCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateCustomMetricCommandInput): import("@smithy/core/client").CommandImpl<UpdateCustomMetricCommandInput, UpdateCustomMetricCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
