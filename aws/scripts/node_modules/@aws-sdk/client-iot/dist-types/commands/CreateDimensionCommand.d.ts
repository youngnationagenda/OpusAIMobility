...
import type { CreateDimensionRequest, CreateDimensionResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateDimensionCommand_base: {
    new (input: CreateDimensionCommandInput): import("@smithy/core/client").CommandImpl<CreateDimensionCommandInput, CreateDimensionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateDimensionCommandInput): import("@smithy/core/client").CommandImpl<CreateDimensionCommandInput, CreateDimensionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
