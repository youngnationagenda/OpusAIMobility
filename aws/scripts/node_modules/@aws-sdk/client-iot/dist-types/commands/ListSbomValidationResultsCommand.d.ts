...
declare const ListSbomValidationResultsCommand_base: {
    new (input: ListSbomValidationResultsCommandInput): import("@smithy/core/client").CommandImpl<ListSbomValidationResultsCommandInput, ListSbomValidationResultsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListSbomValidationResultsCommandInput): import("@smithy/core/client").CommandImpl<ListSbomValidationResultsCommandInput, ListSbomValidationResultsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
