...
declare const DescribeThingCommand_base: {
    new (input: DescribeThingCommandInput): import("@smithy/core/client").CommandImpl<DescribeThingCommandInput, DescribeThingCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeThingCommandInput): import("@smithy/core/client").CommandImpl<DescribeThingCommandInput, DescribeThingCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
