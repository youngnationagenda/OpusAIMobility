...
declare const RegisterCACertificateCommand_base: {
    new (input: RegisterCACertificateCommandInput): import("@smithy/core/client").CommandImpl<RegisterCACertificateCommandInput, RegisterCACertificateCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RegisterCACertificateCommandInput): import("@smithy/core/client").CommandImpl<RegisterCACertificateCommandInput, RegisterCACertificateCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
