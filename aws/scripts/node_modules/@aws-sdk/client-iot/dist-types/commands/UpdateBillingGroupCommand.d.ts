...
import type { UpdateBillingGroupRequest, UpdateBillingGroupResponse } from "../models/models_2";
/**
 * @public
 */
...
declare const UpdateBillingGroupCommand_base: {
    new (input: UpdateBillingGroupCommandInput): import("@smithy/core/client").CommandImpl<UpdateBillingGroupCommandInput, UpdateBillingGroupCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateBillingGroupCommandInput): import("@smithy/core/client").CommandImpl<UpdateBillingGroupCommandInput, UpdateBillingGroupCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
