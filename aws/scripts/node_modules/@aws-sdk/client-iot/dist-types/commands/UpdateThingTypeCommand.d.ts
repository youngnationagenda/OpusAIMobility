...
declare const UpdateThingTypeCommand_base: {
    new (input: UpdateThingTypeCommandInput): import("@smithy/core/client").CommandImpl<UpdateThingTypeCommandInput, UpdateThingTypeCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateThingTypeCommandInput): import("@smithy/core/client").CommandImpl<UpdateThingTypeCommandInput, UpdateThingTypeCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
