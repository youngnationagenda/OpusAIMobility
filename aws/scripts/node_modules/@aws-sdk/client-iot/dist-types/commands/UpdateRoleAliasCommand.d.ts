...
declare const UpdateRoleAliasCommand_base: {
    new (input: UpdateRoleAliasCommandInput): import("@smithy/core/client").CommandImpl<UpdateRoleAliasCommandInput, UpdateRoleAliasCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateRoleAliasCommandInput): import("@smithy/core/client").CommandImpl<UpdateRoleAliasCommandInput, UpdateRoleAliasCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
