...
declare const ListAuditTasksCommand_base: {
    new (input: ListAuditTasksCommandInput): import("@smithy/core/client").CommandImpl<ListAuditTasksCommandInput, ListAuditTasksCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListAuditTasksCommandInput): import("@smithy/core/client").CommandImpl<ListAuditTasksCommandInput, ListAuditTasksCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
