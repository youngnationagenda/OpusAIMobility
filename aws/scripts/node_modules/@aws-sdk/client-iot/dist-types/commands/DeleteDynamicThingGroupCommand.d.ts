...
declare const DeleteDynamicThingGroupCommand_base: {
    new (input: DeleteDynamicThingGroupCommandInput): import("@smithy/core/client").CommandImpl<DeleteDynamicThingGroupCommandInput, DeleteDynamicThingGroupCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteDynamicThingGroupCommandInput): import("@smithy/core/client").CommandImpl<DeleteDynamicThingGroupCommandInput, DeleteDynamicThingGroupCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
