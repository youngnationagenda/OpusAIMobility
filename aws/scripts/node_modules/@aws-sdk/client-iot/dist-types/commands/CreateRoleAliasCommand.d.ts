...
declare const CreateRoleAliasCommand_base: {
    new (input: CreateRoleAliasCommandInput): import("@smithy/core/client").CommandImpl<CreateRoleAliasCommandInput, CreateRoleAliasCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateRoleAliasCommandInput): import("@smithy/core/client").CommandImpl<CreateRoleAliasCommandInput, CreateRoleAliasCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
