...
declare const DescribeDimensionCommand_base: {
    new (input: DescribeDimensionCommandInput): import("@smithy/core/client").CommandImpl<DescribeDimensionCommandInput, DescribeDimensionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeDimensionCommandInput): import("@smithy/core/client").CommandImpl<DescribeDimensionCommandInput, DescribeDimensionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
