...
import type { CancelAuditMitigationActionsTaskRequest, CancelAuditMitigationActionsTaskResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const CancelAuditMitigationActionsTaskCommand_base: {
    new (input: CancelAuditMitigationActionsTaskCommandInput): import("@smithy/core/client").CommandImpl<CancelAuditMitigationActionsTaskCommandInput, CancelAuditMitigationActionsTaskCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CancelAuditMitigationActionsTaskCommandInput): import("@smithy/core/client").CommandImpl<CancelAuditMitigationActionsTaskCommandInput, CancelAuditMitigationActionsTaskCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
