...
declare const DeleteJobCommand_base: {
    new (input: DeleteJobCommandInput): import("@smithy/core/client").CommandImpl<DeleteJobCommandInput, DeleteJobCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteJobCommandInput): import("@smithy/core/client").CommandImpl<DeleteJobCommandInput, DeleteJobCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
