...
import type { CancelDetectMitigationActionsTaskRequest, CancelDetectMitigationActionsTaskResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const CancelDetectMitigationActionsTaskCommand_base: {
    new (input: CancelDetectMitigationActionsTaskCommandInput): import("@smithy/core/client").CommandImpl<CancelDetectMitigationActionsTaskCommandInput, CancelDetectMitigationActionsTaskCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CancelDetectMitigationActionsTaskCommandInput): import("@smithy/core/client").CommandImpl<CancelDetectMitigationActionsTaskCommandInput, CancelDetectMitigationActionsTaskCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
