...
import type { GetIndexingConfigurationRequest, GetIndexingConfigurationResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const GetIndexingConfigurationCommand_base: {
    new (input: GetIndexingConfigurationCommandInput): import("@smithy/core/client").CommandImpl<GetIndexingConfigurationCommandInput, GetIndexingConfigurationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetIndexingConfigurationCommandInput]): import("@smithy/core/client").CommandImpl<GetIndexingConfigurationCommandInput, GetIndexingConfigurationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
