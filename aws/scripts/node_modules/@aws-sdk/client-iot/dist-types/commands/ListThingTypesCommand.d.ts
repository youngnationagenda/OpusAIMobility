...
declare const ListThingTypesCommand_base: {
    new (input: ListThingTypesCommandInput): import("@smithy/core/client").CommandImpl<ListThingTypesCommandInput, ListThingTypesCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListThingTypesCommandInput]): import("@smithy/core/client").CommandImpl<ListThingTypesCommandInput, ListThingTypesCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
