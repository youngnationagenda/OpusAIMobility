...
declare const UpdateScheduledAuditCommand_base: {
    new (input: UpdateScheduledAuditCommandInput): import("@smithy/core/client").CommandImpl<UpdateScheduledAuditCommandInput, UpdateScheduledAuditCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateScheduledAuditCommandInput): import("@smithy/core/client").CommandImpl<UpdateScheduledAuditCommandInput, UpdateScheduledAuditCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
