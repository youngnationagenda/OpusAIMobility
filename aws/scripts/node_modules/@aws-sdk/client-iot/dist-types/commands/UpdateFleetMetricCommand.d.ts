...
import type { UpdateFleetMetricRequest } from "../models/models_2";
/**
 * @public
 */
...
declare const UpdateFleetMetricCommand_base: {
    new (input: UpdateFleetMetricCommandInput): import("@smithy/core/client").CommandImpl<UpdateFleetMetricCommandInput, UpdateFleetMetricCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateFleetMetricCommandInput): import("@smithy/core/client").CommandImpl<UpdateFleetMetricCommandInput, UpdateFleetMetricCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
