...
declare const StartThingRegistrationTaskCommand_base: {
    new (input: StartThingRegistrationTaskCommandInput): import("@smithy/core/client").CommandImpl<StartThingRegistrationTaskCommandInput, StartThingRegistrationTaskCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartThingRegistrationTaskCommandInput): import("@smithy/core/client").CommandImpl<StartThingRegistrationTaskCommandInput, StartThingRegistrationTaskCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
