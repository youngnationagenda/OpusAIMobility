...
declare const CreateJobCommand_base: {
    new (input: CreateJobCommandInput): import("@smithy/core/client").CommandImpl<CreateJobCommandInput, CreateJobCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateJobCommandInput): import("@smithy/core/client").CommandImpl<CreateJobCommandInput, CreateJobCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
