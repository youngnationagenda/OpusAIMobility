...
declare const CreateDynamicThingGroupCommand_base: {
    new (input: CreateDynamicThingGroupCommandInput): import("@smithy/core/client").CommandImpl<CreateDynamicThingGroupCommandInput, CreateDynamicThingGroupCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateDynamicThingGroupCommandInput): import("@smithy/core/client").CommandImpl<CreateDynamicThingGroupCommandInput, CreateDynamicThingGroupCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
