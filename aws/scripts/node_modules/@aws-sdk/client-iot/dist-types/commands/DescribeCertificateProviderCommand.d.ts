...
declare const DescribeCertificateProviderCommand_base: {
    new (input: DescribeCertificateProviderCommandInput): import("@smithy/core/client").CommandImpl<DescribeCertificateProviderCommandInput, DescribeCertificateProviderCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeCertificateProviderCommandInput): import("@smithy/core/client").CommandImpl<DescribeCertificateProviderCommandInput, DescribeCertificateProviderCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
