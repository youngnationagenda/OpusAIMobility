...
declare const StartDetectMitigationActionsTaskCommand_base: {
    new (input: StartDetectMitigationActionsTaskCommandInput): import("@smithy/core/client").CommandImpl<StartDetectMitigationActionsTaskCommandInput, StartDetectMitigationActionsTaskCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartDetectMitigationActionsTaskCommandInput): import("@smithy/core/client").CommandImpl<StartDetectMitigationActionsTaskCommandInput, StartDetectMitigationActionsTaskCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
