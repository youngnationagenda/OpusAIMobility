...
declare const ListThingGroupsForThingCommand_base: {
    new (input: ListThingGroupsForThingCommandInput): import("@smithy/core/client").CommandImpl<ListThingGroupsForThingCommandInput, ListThingGroupsForThingCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListThingGroupsForThingCommandInput): import("@smithy/core/client").CommandImpl<ListThingGroupsForThingCommandInput, ListThingGroupsForThingCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
