...
import type { ListAuditMitigationActionsTasksRequest, ListAuditMitigationActionsTasksResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const ListAuditMitigationActionsTasksCommand_base: {
    new (input: ListAuditMitigationActionsTasksCommandInput): import("@smithy/core/client").CommandImpl<ListAuditMitigationActionsTasksCommandInput, ListAuditMitigationActionsTasksCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListAuditMitigationActionsTasksCommandInput): import("@smithy/core/client").CommandImpl<ListAuditMitigationActionsTasksCommandInput, ListAuditMitigationActionsTasksCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
