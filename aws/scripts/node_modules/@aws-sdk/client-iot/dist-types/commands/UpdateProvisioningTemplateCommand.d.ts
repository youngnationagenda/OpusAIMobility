...
declare const UpdateProvisioningTemplateCommand_base: {
    new (input: UpdateProvisioningTemplateCommandInput): import("@smithy/core/client").CommandImpl<UpdateProvisioningTemplateCommandInput, UpdateProvisioningTemplateCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateProvisioningTemplateCommandInput): import("@smithy/core/client").CommandImpl<UpdateProvisioningTemplateCommandInput, UpdateProvisioningTemplateCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
