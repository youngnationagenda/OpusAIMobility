...
import type { CreateThingGroupRequest, CreateThingGroupResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateThingGroupCommand_base: {
    new (input: CreateThingGroupCommandInput): import("@smithy/core/client").CommandImpl<CreateThingGroupCommandInput, CreateThingGroupCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateThingGroupCommandInput): import("@smithy/core/client").CommandImpl<CreateThingGroupCommandInput, CreateThingGroupCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
