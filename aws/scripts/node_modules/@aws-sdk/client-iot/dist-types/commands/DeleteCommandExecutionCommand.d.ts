...
declare const DeleteCommandExecutionCommand_base: {
    new (input: DeleteCommandExecutionCommandInput): import("@smithy/core/client").CommandImpl<DeleteCommandExecutionCommandInput, DeleteCommandExecutionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteCommandExecutionCommandInput): import("@smithy/core/client").CommandImpl<DeleteCommandExecutionCommandInput, DeleteCommandExecutionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
