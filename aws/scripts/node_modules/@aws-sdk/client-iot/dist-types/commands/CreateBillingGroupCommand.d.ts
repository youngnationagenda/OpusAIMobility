...
declare const CreateBillingGroupCommand_base: {
    new (input: CreateBillingGroupCommandInput): import("@smithy/core/client").CommandImpl<CreateBillingGroupCommandInput, CreateBillingGroupCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateBillingGroupCommandInput): import("@smithy/core/client").CommandImpl<CreateBillingGroupCommandInput, CreateBillingGroupCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
