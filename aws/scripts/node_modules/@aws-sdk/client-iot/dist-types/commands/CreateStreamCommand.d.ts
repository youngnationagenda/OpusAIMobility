...
declare const CreateStreamCommand_base: {
    new (input: CreateStreamCommandInput): import("@smithy/core/client").CommandImpl<CreateStreamCommandInput, CreateStreamCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateStreamCommandInput): import("@smithy/core/client").CommandImpl<CreateStreamCommandInput, CreateStreamCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
