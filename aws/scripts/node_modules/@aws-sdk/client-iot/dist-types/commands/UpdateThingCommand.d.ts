...
declare const UpdateThingCommand_base: {
    new (input: UpdateThingCommandInput): import("@smithy/core/client").CommandImpl<UpdateThingCommandInput, UpdateThingCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateThingCommandInput): import("@smithy/core/client").CommandImpl<UpdateThingCommandInput, UpdateThingCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
