...
declare const CreateAuditSuppressionCommand_base: {
    new (input: CreateAuditSuppressionCommandInput): import("@smithy/core/client").CommandImpl<CreateAuditSuppressionCommandInput, CreateAuditSuppressionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateAuditSuppressionCommandInput): import("@smithy/core/client").CommandImpl<CreateAuditSuppressionCommandInput, CreateAuditSuppressionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
