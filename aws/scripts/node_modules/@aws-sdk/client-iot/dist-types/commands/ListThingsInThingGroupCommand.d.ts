...
declare const ListThingsInThingGroupCommand_base: {
    new (input: ListThingsInThingGroupCommandInput): import("@smithy/core/client").CommandImpl<ListThingsInThingGroupCommandInput, ListThingsInThingGroupCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListThingsInThingGroupCommandInput): import("@smithy/core/client").CommandImpl<ListThingsInThingGroupCommandInput, ListThingsInThingGroupCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
