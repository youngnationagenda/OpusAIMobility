...
import type { GetOTAUpdateRequest, GetOTAUpdateResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const GetOTAUpdateCommand_base: {
    new (input: GetOTAUpdateCommandInput): import("@smithy/core/client").CommandImpl<GetOTAUpdateCommandInput, GetOTAUpdateCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetOTAUpdateCommandInput): import("@smithy/core/client").CommandImpl<GetOTAUpdateCommandInput, GetOTAUpdateCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
