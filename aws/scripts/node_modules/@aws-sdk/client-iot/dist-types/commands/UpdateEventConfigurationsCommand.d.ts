...
declare const UpdateEventConfigurationsCommand_base: {
    new (input: UpdateEventConfigurationsCommandInput): import("@smithy/core/client").CommandImpl<UpdateEventConfigurationsCommandInput, UpdateEventConfigurationsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [UpdateEventConfigurationsCommandInput]): import("@smithy/core/client").CommandImpl<UpdateEventConfigurationsCommandInput, UpdateEventConfigurationsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
