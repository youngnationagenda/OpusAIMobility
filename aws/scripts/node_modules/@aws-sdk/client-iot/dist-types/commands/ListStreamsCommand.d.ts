...
declare const ListStreamsCommand_base: {
    new (input: ListStreamsCommandInput): import("@smithy/core/client").CommandImpl<ListStreamsCommandInput, ListStreamsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListStreamsCommandInput]): import("@smithy/core/client").CommandImpl<ListStreamsCommandInput, ListStreamsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
