...
import type { GetBehaviorModelTrainingSummariesRequest, GetBehaviorModelTrainingSummariesResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const GetBehaviorModelTrainingSummariesCommand_base: {
    new (input: GetBehaviorModelTrainingSummariesCommandInput): import("@smithy/core/client").CommandImpl<GetBehaviorModelTrainingSummariesCommandInput, GetBehaviorModelTrainingSummariesCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetBehaviorModelTrainingSummariesCommandInput]): import("@smithy/core/client").CommandImpl<GetBehaviorModelTrainingSummariesCommandInput, GetBehaviorModelTrainingSummariesCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
