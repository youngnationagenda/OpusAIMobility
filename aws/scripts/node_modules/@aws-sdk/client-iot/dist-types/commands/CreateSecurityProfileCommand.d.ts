...
declare const CreateSecurityProfileCommand_base: {
    new (input: CreateSecurityProfileCommandInput): import("@smithy/core/client").CommandImpl<CreateSecurityProfileCommandInput, CreateSecurityProfileCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateSecurityProfileCommandInput): import("@smithy/core/client").CommandImpl<CreateSecurityProfileCommandInput, CreateSecurityProfileCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
