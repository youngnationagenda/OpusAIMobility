...
declare const DeleteMitigationActionCommand_base: {
    new (input: DeleteMitigationActionCommandInput): import("@smithy/core/client").CommandImpl<DeleteMitigationActionCommandInput, DeleteMitigationActionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteMitigationActionCommandInput): import("@smithy/core/client").CommandImpl<DeleteMitigationActionCommandInput, DeleteMitigationActionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
