...
declare const DescribeThingTypeCommand_base: {
    new (input: DescribeThingTypeCommandInput): import("@smithy/core/client").CommandImpl<DescribeThingTypeCommandInput, DescribeThingTypeCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeThingTypeCommandInput): import("@smithy/core/client").CommandImpl<DescribeThingTypeCommandInput, DescribeThingTypeCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
