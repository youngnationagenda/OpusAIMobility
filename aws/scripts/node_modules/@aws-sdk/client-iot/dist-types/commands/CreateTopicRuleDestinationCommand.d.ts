...
import type { CreateTopicRuleDestinationRequest, CreateTopicRuleDestinationResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateTopicRuleDestinationCommand_base: {
    new (input: CreateTopicRuleDestinationCommandInput): import("@smithy/core/client").CommandImpl<CreateTopicRuleDestinationCommandInput, CreateTopicRuleDestinationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateTopicRuleDestinationCommandInput): import("@smithy/core/client").CommandImpl<CreateTopicRuleDestinationCommandInput, CreateTopicRuleDestinationCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
