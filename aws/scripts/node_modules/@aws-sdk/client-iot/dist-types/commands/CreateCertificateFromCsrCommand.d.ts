...
declare const CreateCertificateFromCsrCommand_base: {
    new (input: CreateCertificateFromCsrCommandInput): import("@smithy/core/client").CommandImpl<CreateCertificateFromCsrCommandInput, CreateCertificateFromCsrCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateCertificateFromCsrCommandInput): import("@smithy/core/client").CommandImpl<CreateCertificateFromCsrCommandInput, CreateCertificateFromCsrCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
