...
import type { CreateProvisioningTemplateVersionRequest, CreateProvisioningTemplateVersionResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateProvisioningTemplateVersionCommand_base: {
    new (input: CreateProvisioningTemplateVersionCommandInput): import("@smithy/core/client").CommandImpl<CreateProvisioningTemplateVersionCommandInput, CreateProvisioningTemplateVersionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateProvisioningTemplateVersionCommandInput): import("@smithy/core/client").CommandImpl<CreateProvisioningTemplateVersionCommandInput, CreateProvisioningTemplateVersionCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
