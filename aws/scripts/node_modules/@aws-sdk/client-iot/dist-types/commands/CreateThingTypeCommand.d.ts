...
declare const CreateThingTypeCommand_base: {
    new (input: CreateThingTypeCommandInput): import("@smithy/core/client").CommandImpl<CreateThingTypeCommandInput, CreateThingTypeCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateThingTypeCommandInput): import("@smithy/core/client").CommandImpl<CreateThingTypeCommandInput, CreateThingTypeCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
