...
declare const ListCustomMetricsCommand_base: {
    new (input: ListCustomMetricsCommandInput): import("@smithy/core/client").CommandImpl<ListCustomMetricsCommandInput, ListCustomMetricsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListCustomMetricsCommandInput]): import("@smithy/core/client").CommandImpl<ListCustomMetricsCommandInput, ListCustomMetricsCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
