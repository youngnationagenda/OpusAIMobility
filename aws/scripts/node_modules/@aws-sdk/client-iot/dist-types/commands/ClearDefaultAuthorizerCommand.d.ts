...
declare const ClearDefaultAuthorizerCommand_base: {
    new (input: ClearDefaultAuthorizerCommandInput): import("@smithy/core/client").CommandImpl<ClearDefaultAuthorizerCommandInput, ClearDefaultAuthorizerCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ClearDefaultAuthorizerCommandInput]): import("@smithy/core/client").CommandImpl<ClearDefaultAuthorizerCommandInput, ClearDefaultAuthorizerCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
