...
import type { UpdateCertificateRequest } from "../models/models_2";
/**
 * @public
 */
...
declare const UpdateCertificateCommand_base: {
    new (input: UpdateCertificateCommandInput): import("@smithy/core/client").CommandImpl<UpdateCertificateCommandInput, UpdateCertificateCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateCertificateCommandInput): import("@smithy/core/client").CommandImpl<UpdateCertificateCommandInput, UpdateCertificateCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
