...
declare const RegisterCertificateCommand_base: {
    new (input: RegisterCertificateCommandInput): import("@smithy/core/client").CommandImpl<RegisterCertificateCommandInput, RegisterCertificateCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RegisterCertificateCommandInput): import("@smithy/core/client").CommandImpl<RegisterCertificateCommandInput, RegisterCertificateCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
