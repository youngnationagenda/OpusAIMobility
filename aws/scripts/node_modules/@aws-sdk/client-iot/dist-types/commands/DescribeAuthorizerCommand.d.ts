...
declare const DescribeAuthorizerCommand_base: {
    new (input: DescribeAuthorizerCommandInput): import("@smithy/core/client").CommandImpl<DescribeAuthorizerCommandInput, DescribeAuthorizerCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeAuthorizerCommandInput): import("@smithy/core/client").CommandImpl<DescribeAuthorizerCommandInput, DescribeAuthorizerCommandOutput, import("..").IoTClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
