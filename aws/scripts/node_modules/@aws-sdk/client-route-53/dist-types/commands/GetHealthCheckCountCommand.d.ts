...
declare const GetHealthCheckCountCommand_base: {
    new (input: GetHealthCheckCountCommandInput): import("@smithy/core/client").CommandImpl<GetHealthCheckCountCommandInput, GetHealthCheckCountCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetHealthCheckCountCommandInput]): import("@smithy/core/client").CommandImpl<GetHealthCheckCountCommandInput, GetHealthCheckCountCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
