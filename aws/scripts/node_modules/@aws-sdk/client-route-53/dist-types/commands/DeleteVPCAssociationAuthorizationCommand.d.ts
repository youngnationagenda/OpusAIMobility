...
declare const DeleteVPCAssociationAuthorizationCommand_base: {
    new (input: DeleteVPCAssociationAuthorizationCommandInput): import("@smithy/core/client").CommandImpl<DeleteVPCAssociationAuthorizationCommandInput, DeleteVPCAssociationAuthorizationCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteVPCAssociationAuthorizationCommandInput): import("@smithy/core/client").CommandImpl<DeleteVPCAssociationAuthorizationCommandInput, DeleteVPCAssociationAuthorizationCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
