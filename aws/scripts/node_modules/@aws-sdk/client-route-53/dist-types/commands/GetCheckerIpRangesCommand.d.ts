...
declare const GetCheckerIpRangesCommand_base: {
    new (input: GetCheckerIpRangesCommandInput): import("@smithy/core/client").CommandImpl<GetCheckerIpRangesCommandInput, GetCheckerIpRangesCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetCheckerIpRangesCommandInput]): import("@smithy/core/client").CommandImpl<GetCheckerIpRangesCommandInput, GetCheckerIpRangesCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
