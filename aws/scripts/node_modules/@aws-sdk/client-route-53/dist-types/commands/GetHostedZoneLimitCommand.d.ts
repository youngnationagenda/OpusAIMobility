...
declare const GetHostedZoneLimitCommand_base: {
    new (input: GetHostedZoneLimitCommandInput): import("@smithy/core/client").CommandImpl<GetHostedZoneLimitCommandInput, GetHostedZoneLimitCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetHostedZoneLimitCommandInput): import("@smithy/core/client").CommandImpl<GetHostedZoneLimitCommandInput, GetHostedZoneLimitCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
