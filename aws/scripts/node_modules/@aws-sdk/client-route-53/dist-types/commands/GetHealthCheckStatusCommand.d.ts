...
declare const GetHealthCheckStatusCommand_base: {
    new (input: GetHealthCheckStatusCommandInput): import("@smithy/core/client").CommandImpl<GetHealthCheckStatusCommandInput, GetHealthCheckStatusCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetHealthCheckStatusCommandInput): import("@smithy/core/client").CommandImpl<GetHealthCheckStatusCommandInput, GetHealthCheckStatusCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
