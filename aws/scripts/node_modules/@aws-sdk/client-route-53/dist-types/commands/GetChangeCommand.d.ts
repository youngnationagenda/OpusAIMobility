...
declare const GetChangeCommand_base: {
    new (input: GetChangeCommandInput): import("@smithy/core/client").CommandImpl<GetChangeCommandInput, GetChangeCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetChangeCommandInput): import("@smithy/core/client").CommandImpl<GetChangeCommandInput, GetChangeCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
