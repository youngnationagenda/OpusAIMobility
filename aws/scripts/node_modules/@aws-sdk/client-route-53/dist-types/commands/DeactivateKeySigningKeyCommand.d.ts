...
declare const DeactivateKeySigningKeyCommand_base: {
    new (input: DeactivateKeySigningKeyCommandInput): import("@smithy/core/client").CommandImpl<DeactivateKeySigningKeyCommandInput, DeactivateKeySigningKeyCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeactivateKeySigningKeyCommandInput): import("@smithy/core/client").CommandImpl<DeactivateKeySigningKeyCommandInput, DeactivateKeySigningKeyCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
