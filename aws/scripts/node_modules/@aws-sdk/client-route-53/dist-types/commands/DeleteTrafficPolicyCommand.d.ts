...
declare const DeleteTrafficPolicyCommand_base: {
    new (input: DeleteTrafficPolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteTrafficPolicyCommandInput, DeleteTrafficPolicyCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteTrafficPolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteTrafficPolicyCommandInput, DeleteTrafficPolicyCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
