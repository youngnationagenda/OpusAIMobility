...
declare const CreateQueryLoggingConfigCommand_base: {
    new (input: CreateQueryLoggingConfigCommandInput): import("@smithy/core/client").CommandImpl<CreateQueryLoggingConfigCommandInput, CreateQueryLoggingConfigCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateQueryLoggingConfigCommandInput): import("@smithy/core/client").CommandImpl<CreateQueryLoggingConfigCommandInput, CreateQueryLoggingConfigCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
