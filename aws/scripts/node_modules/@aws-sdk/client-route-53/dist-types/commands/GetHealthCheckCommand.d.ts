...
declare const GetHealthCheckCommand_base: {
    new (input: GetHealthCheckCommandInput): import("@smithy/core/client").CommandImpl<GetHealthCheckCommandInput, GetHealthCheckCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetHealthCheckCommandInput): import("@smithy/core/client").CommandImpl<GetHealthCheckCommandInput, GetHealthCheckCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
