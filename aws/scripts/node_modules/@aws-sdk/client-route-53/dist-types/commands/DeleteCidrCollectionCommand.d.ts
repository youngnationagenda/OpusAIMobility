...
declare const DeleteCidrCollectionCommand_base: {
    new (input: DeleteCidrCollectionCommandInput): import("@smithy/core/client").CommandImpl<DeleteCidrCollectionCommandInput, DeleteCidrCollectionCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteCidrCollectionCommandInput): import("@smithy/core/client").CommandImpl<DeleteCidrCollectionCommandInput, DeleteCidrCollectionCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
