...
declare const GetHealthCheckLastFailureReasonCommand_base: {
    new (input: GetHealthCheckLastFailureReasonCommandInput): import("@smithy/core/client").CommandImpl<GetHealthCheckLastFailureReasonCommandInput, GetHealthCheckLastFailureReasonCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetHealthCheckLastFailureReasonCommandInput): import("@smithy/core/client").CommandImpl<GetHealthCheckLastFailureReasonCommandInput, GetHealthCheckLastFailureReasonCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
