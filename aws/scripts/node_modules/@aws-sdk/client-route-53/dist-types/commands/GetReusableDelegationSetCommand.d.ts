...
declare const GetReusableDelegationSetCommand_base: {
    new (input: GetReusableDelegationSetCommandInput): import("@smithy/core/client").CommandImpl<GetReusableDelegationSetCommandInput, GetReusableDelegationSetCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetReusableDelegationSetCommandInput): import("@smithy/core/client").CommandImpl<GetReusableDelegationSetCommandInput, GetReusableDelegationSetCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
