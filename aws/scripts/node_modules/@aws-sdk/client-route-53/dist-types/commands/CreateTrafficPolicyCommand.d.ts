...
declare const CreateTrafficPolicyCommand_base: {
    new (input: CreateTrafficPolicyCommandInput): import("@smithy/core/client").CommandImpl<CreateTrafficPolicyCommandInput, CreateTrafficPolicyCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateTrafficPolicyCommandInput): import("@smithy/core/client").CommandImpl<CreateTrafficPolicyCommandInput, CreateTrafficPolicyCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
