...
declare const DeleteKeySigningKeyCommand_base: {
    new (input: DeleteKeySigningKeyCommandInput): import("@smithy/core/client").CommandImpl<DeleteKeySigningKeyCommandInput, DeleteKeySigningKeyCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteKeySigningKeyCommandInput): import("@smithy/core/client").CommandImpl<DeleteKeySigningKeyCommandInput, DeleteKeySigningKeyCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
