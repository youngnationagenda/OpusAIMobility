...
declare const GetHostedZoneCommand_base: {
    new (input: GetHostedZoneCommandInput): import("@smithy/core/client").CommandImpl<GetHostedZoneCommandInput, GetHostedZoneCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetHostedZoneCommandInput): import("@smithy/core/client").CommandImpl<GetHostedZoneCommandInput, GetHostedZoneCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
