...
declare const DeleteReusableDelegationSetCommand_base: {
    new (input: DeleteReusableDelegationSetCommandInput): import("@smithy/core/client").CommandImpl<DeleteReusableDelegationSetCommandInput, DeleteReusableDelegationSetCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteReusableDelegationSetCommandInput): import("@smithy/core/client").CommandImpl<DeleteReusableDelegationSetCommandInput, DeleteReusableDelegationSetCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
