...
declare const DeleteTrafficPolicyInstanceCommand_base: {
    new (input: DeleteTrafficPolicyInstanceCommandInput): import("@smithy/core/client").CommandImpl<DeleteTrafficPolicyInstanceCommandInput, DeleteTrafficPolicyInstanceCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteTrafficPolicyInstanceCommandInput): import("@smithy/core/client").CommandImpl<DeleteTrafficPolicyInstanceCommandInput, DeleteTrafficPolicyInstanceCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
