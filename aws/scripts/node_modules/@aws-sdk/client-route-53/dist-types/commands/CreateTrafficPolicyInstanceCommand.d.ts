...
declare const CreateTrafficPolicyInstanceCommand_base: {
    new (input: CreateTrafficPolicyInstanceCommandInput): import("@smithy/core/client").CommandImpl<CreateTrafficPolicyInstanceCommandInput, CreateTrafficPolicyInstanceCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateTrafficPolicyInstanceCommandInput): import("@smithy/core/client").CommandImpl<CreateTrafficPolicyInstanceCommandInput, CreateTrafficPolicyInstanceCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
