...
declare const GetTrafficPolicyCommand_base: {
    new (input: GetTrafficPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetTrafficPolicyCommandInput, GetTrafficPolicyCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetTrafficPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetTrafficPolicyCommandInput, GetTrafficPolicyCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
