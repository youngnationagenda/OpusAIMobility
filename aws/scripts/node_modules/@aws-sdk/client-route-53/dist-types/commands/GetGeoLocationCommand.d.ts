...
declare const GetGeoLocationCommand_base: {
    new (input: GetGeoLocationCommandInput): import("@smithy/core/client").CommandImpl<GetGeoLocationCommandInput, GetGeoLocationCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetGeoLocationCommandInput]): import("@smithy/core/client").CommandImpl<GetGeoLocationCommandInput, GetGeoLocationCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
