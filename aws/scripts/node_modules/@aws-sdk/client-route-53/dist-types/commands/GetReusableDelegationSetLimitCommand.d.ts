...
declare const GetReusableDelegationSetLimitCommand_base: {
    new (input: GetReusableDelegationSetLimitCommandInput): import("@smithy/core/client").CommandImpl<GetReusableDelegationSetLimitCommandInput, GetReusableDelegationSetLimitCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetReusableDelegationSetLimitCommandInput): import("@smithy/core/client").CommandImpl<GetReusableDelegationSetLimitCommandInput, GetReusableDelegationSetLimitCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
