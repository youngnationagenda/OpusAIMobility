...
declare const ListCidrBlocksCommand_base: {
    new (input: ListCidrBlocksCommandInput): import("@smithy/core/client").CommandImpl<ListCidrBlocksCommandInput, ListCidrBlocksCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListCidrBlocksCommandInput): import("@smithy/core/client").CommandImpl<ListCidrBlocksCommandInput, ListCidrBlocksCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
