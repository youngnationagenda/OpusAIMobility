...
declare const ListGeoLocationsCommand_base: {
    new (input: ListGeoLocationsCommandInput): import("@smithy/core/client").CommandImpl<ListGeoLocationsCommandInput, ListGeoLocationsCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListGeoLocationsCommandInput]): import("@smithy/core/client").CommandImpl<ListGeoLocationsCommandInput, ListGeoLocationsCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
