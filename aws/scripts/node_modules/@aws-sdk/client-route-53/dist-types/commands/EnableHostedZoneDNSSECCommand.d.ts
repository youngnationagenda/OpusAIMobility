...
declare const EnableHostedZoneDNSSECCommand_base: {
    new (input: EnableHostedZoneDNSSECCommandInput): import("@smithy/core/client").CommandImpl<EnableHostedZoneDNSSECCommandInput, EnableHostedZoneDNSSECCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: EnableHostedZoneDNSSECCommandInput): import("@smithy/core/client").CommandImpl<EnableHostedZoneDNSSECCommandInput, EnableHostedZoneDNSSECCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
