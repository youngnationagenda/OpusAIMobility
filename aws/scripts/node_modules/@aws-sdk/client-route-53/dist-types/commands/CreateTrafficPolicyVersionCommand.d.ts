...
declare const CreateTrafficPolicyVersionCommand_base: {
    new (input: CreateTrafficPolicyVersionCommandInput): import("@smithy/core/client").CommandImpl<CreateTrafficPolicyVersionCommandInput, CreateTrafficPolicyVersionCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateTrafficPolicyVersionCommandInput): import("@smithy/core/client").CommandImpl<CreateTrafficPolicyVersionCommandInput, CreateTrafficPolicyVersionCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
