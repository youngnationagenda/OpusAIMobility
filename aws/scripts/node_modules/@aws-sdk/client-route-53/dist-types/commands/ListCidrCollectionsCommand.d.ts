...
declare const ListCidrCollectionsCommand_base: {
    new (input: ListCidrCollectionsCommandInput): import("@smithy/core/client").CommandImpl<ListCidrCollectionsCommandInput, ListCidrCollectionsCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListCidrCollectionsCommandInput]): import("@smithy/core/client").CommandImpl<ListCidrCollectionsCommandInput, ListCidrCollectionsCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
