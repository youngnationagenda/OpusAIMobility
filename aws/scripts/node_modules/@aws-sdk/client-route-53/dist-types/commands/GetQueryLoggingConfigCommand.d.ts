...
declare const GetQueryLoggingConfigCommand_base: {
    new (input: GetQueryLoggingConfigCommandInput): import("@smithy/core/client").CommandImpl<GetQueryLoggingConfigCommandInput, GetQueryLoggingConfigCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetQueryLoggingConfigCommandInput): import("@smithy/core/client").CommandImpl<GetQueryLoggingConfigCommandInput, GetQueryLoggingConfigCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
