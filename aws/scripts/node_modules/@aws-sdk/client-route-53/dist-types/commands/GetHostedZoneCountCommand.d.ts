...
declare const GetHostedZoneCountCommand_base: {
    new (input: GetHostedZoneCountCommandInput): import("@smithy/core/client").CommandImpl<GetHostedZoneCountCommandInput, GetHostedZoneCountCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetHostedZoneCountCommandInput]): import("@smithy/core/client").CommandImpl<GetHostedZoneCountCommandInput, GetHostedZoneCountCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
