...
declare const CreateKeySigningKeyCommand_base: {
    new (input: CreateKeySigningKeyCommandInput): import("@smithy/core/client").CommandImpl<CreateKeySigningKeyCommandInput, CreateKeySigningKeyCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateKeySigningKeyCommandInput): import("@smithy/core/client").CommandImpl<CreateKeySigningKeyCommandInput, CreateKeySigningKeyCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
