...
declare const DeleteHealthCheckCommand_base: {
    new (input: DeleteHealthCheckCommandInput): import("@smithy/core/client").CommandImpl<DeleteHealthCheckCommandInput, DeleteHealthCheckCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteHealthCheckCommandInput): import("@smithy/core/client").CommandImpl<DeleteHealthCheckCommandInput, DeleteHealthCheckCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
