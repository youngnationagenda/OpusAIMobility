...
declare const GetTrafficPolicyInstanceCommand_base: {
    new (input: GetTrafficPolicyInstanceCommandInput): import("@smithy/core/client").CommandImpl<GetTrafficPolicyInstanceCommandInput, GetTrafficPolicyInstanceCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetTrafficPolicyInstanceCommandInput): import("@smithy/core/client").CommandImpl<GetTrafficPolicyInstanceCommandInput, GetTrafficPolicyInstanceCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
