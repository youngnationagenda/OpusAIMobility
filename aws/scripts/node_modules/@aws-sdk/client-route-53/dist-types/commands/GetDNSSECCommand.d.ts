...
declare const GetDNSSECCommand_base: {
    new (input: GetDNSSECCommandInput): import("@smithy/core/client").CommandImpl<GetDNSSECCommandInput, GetDNSSECCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetDNSSECCommandInput): import("@smithy/core/client").CommandImpl<GetDNSSECCommandInput, GetDNSSECCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
