...
declare const CreateVPCAssociationAuthorizationCommand_base: {
    new (input: CreateVPCAssociationAuthorizationCommandInput): import("@smithy/core/client").CommandImpl<CreateVPCAssociationAuthorizationCommandInput, CreateVPCAssociationAuthorizationCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateVPCAssociationAuthorizationCommandInput): import("@smithy/core/client").CommandImpl<CreateVPCAssociationAuthorizationCommandInput, CreateVPCAssociationAuthorizationCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
