...
declare const GetAccountLimitCommand_base: {
    new (input: GetAccountLimitCommandInput): import("@smithy/core/client").CommandImpl<GetAccountLimitCommandInput, GetAccountLimitCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetAccountLimitCommandInput): import("@smithy/core/client").CommandImpl<GetAccountLimitCommandInput, GetAccountLimitCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
