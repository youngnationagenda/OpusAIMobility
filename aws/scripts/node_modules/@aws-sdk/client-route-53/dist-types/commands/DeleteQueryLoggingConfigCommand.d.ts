...
declare const DeleteQueryLoggingConfigCommand_base: {
    new (input: DeleteQueryLoggingConfigCommandInput): import("@smithy/core/client").CommandImpl<DeleteQueryLoggingConfigCommandInput, DeleteQueryLoggingConfigCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteQueryLoggingConfigCommandInput): import("@smithy/core/client").CommandImpl<DeleteQueryLoggingConfigCommandInput, DeleteQueryLoggingConfigCommandOutput, import("..").Route53ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
