...
declare const ListLayersCommand_base: {
    new (input: ListLayersCommandInput): import("@smithy/core/client").CommandImpl<ListLayersCommandInput, ListLayersCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListLayersCommandInput]): import("@smithy/core/client").CommandImpl<ListLayersCommandInput, ListLayersCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
