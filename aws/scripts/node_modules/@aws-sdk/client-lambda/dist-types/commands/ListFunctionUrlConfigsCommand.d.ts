...
declare const ListFunctionUrlConfigsCommand_base: {
    new (input: ListFunctionUrlConfigsCommandInput): import("@smithy/core/client").CommandImpl<ListFunctionUrlConfigsCommandInput, ListFunctionUrlConfigsCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListFunctionUrlConfigsCommandInput): import("@smithy/core/client").CommandImpl<ListFunctionUrlConfigsCommandInput, ListFunctionUrlConfigsCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
