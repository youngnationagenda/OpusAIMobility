...
declare const GetLayerVersionCommand_base: {
    new (input: GetLayerVersionCommandInput): import("@smithy/core/client").CommandImpl<GetLayerVersionCommandInput, GetLayerVersionCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetLayerVersionCommandInput): import("@smithy/core/client").CommandImpl<GetLayerVersionCommandInput, GetLayerVersionCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
