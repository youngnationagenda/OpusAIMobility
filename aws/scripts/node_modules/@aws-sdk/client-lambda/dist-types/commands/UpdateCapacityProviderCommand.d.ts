...
declare const UpdateCapacityProviderCommand_base: {
    new (input: UpdateCapacityProviderCommandInput): import("@smithy/core/client").CommandImpl<UpdateCapacityProviderCommandInput, UpdateCapacityProviderCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateCapacityProviderCommandInput): import("@smithy/core/client").CommandImpl<UpdateCapacityProviderCommandInput, UpdateCapacityProviderCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
