...
declare const GetAliasCommand_base: {
    new (input: GetAliasCommandInput): import("@smithy/core/client").CommandImpl<GetAliasCommandInput, GetAliasCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetAliasCommandInput): import("@smithy/core/client").CommandImpl<GetAliasCommandInput, GetAliasCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
