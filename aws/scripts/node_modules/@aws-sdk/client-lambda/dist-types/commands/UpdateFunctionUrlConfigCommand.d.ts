...
declare const UpdateFunctionUrlConfigCommand_base: {
    new (input: UpdateFunctionUrlConfigCommandInput): import("@smithy/core/client").CommandImpl<UpdateFunctionUrlConfigCommandInput, UpdateFunctionUrlConfigCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateFunctionUrlConfigCommandInput): import("@smithy/core/client").CommandImpl<UpdateFunctionUrlConfigCommandInput, UpdateFunctionUrlConfigCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
