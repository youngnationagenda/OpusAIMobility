...
declare const DeleteFunctionConcurrencyCommand_base: {
    new (input: DeleteFunctionConcurrencyCommandInput): import("@smithy/core/client").CommandImpl<DeleteFunctionConcurrencyCommandInput, DeleteFunctionConcurrencyCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteFunctionConcurrencyCommandInput): import("@smithy/core/client").CommandImpl<DeleteFunctionConcurrencyCommandInput, DeleteFunctionConcurrencyCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
