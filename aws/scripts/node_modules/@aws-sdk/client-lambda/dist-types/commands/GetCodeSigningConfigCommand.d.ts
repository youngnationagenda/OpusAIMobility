...
declare const GetCodeSigningConfigCommand_base: {
    new (input: GetCodeSigningConfigCommandInput): import("@smithy/core/client").CommandImpl<GetCodeSigningConfigCommandInput, GetCodeSigningConfigCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetCodeSigningConfigCommandInput): import("@smithy/core/client").CommandImpl<GetCodeSigningConfigCommandInput, GetCodeSigningConfigCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
