...
declare const InvokeCommand_base: {
    new (input: InvokeCommandInput): import("@smithy/core/client").CommandImpl<InvokeCommandInput, InvokeCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: InvokeCommandInput): import("@smithy/core/client").CommandImpl<InvokeCommandInput, InvokeCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
