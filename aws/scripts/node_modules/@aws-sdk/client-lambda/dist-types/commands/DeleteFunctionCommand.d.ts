...
declare const DeleteFunctionCommand_base: {
    new (input: DeleteFunctionCommandInput): import("@smithy/core/client").CommandImpl<DeleteFunctionCommandInput, DeleteFunctionCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteFunctionCommandInput): import("@smithy/core/client").CommandImpl<DeleteFunctionCommandInput, DeleteFunctionCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
