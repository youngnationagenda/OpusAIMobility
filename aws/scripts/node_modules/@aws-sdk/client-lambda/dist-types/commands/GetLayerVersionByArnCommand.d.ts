...
declare const GetLayerVersionByArnCommand_base: {
    new (input: GetLayerVersionByArnCommandInput): import("@smithy/core/client").CommandImpl<GetLayerVersionByArnCommandInput, GetLayerVersionByArnCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetLayerVersionByArnCommandInput): import("@smithy/core/client").CommandImpl<GetLayerVersionByArnCommandInput, GetLayerVersionByArnCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
