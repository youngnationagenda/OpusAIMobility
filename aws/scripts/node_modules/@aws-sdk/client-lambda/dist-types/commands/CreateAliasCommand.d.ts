...
declare const CreateAliasCommand_base: {
    new (input: CreateAliasCommandInput): import("@smithy/core/client").CommandImpl<CreateAliasCommandInput, CreateAliasCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateAliasCommandInput): import("@smithy/core/client").CommandImpl<CreateAliasCommandInput, CreateAliasCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
