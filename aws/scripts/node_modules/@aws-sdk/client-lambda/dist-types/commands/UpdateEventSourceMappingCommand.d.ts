...
declare const UpdateEventSourceMappingCommand_base: {
    new (input: UpdateEventSourceMappingCommandInput): import("@smithy/core/client").CommandImpl<UpdateEventSourceMappingCommandInput, UpdateEventSourceMappingCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateEventSourceMappingCommandInput): import("@smithy/core/client").CommandImpl<UpdateEventSourceMappingCommandInput, UpdateEventSourceMappingCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
