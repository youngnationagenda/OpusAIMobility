...
declare const ListFunctionsByCodeSigningConfigCommand_base: {
    new (input: ListFunctionsByCodeSigningConfigCommandInput): import("@smithy/core/client").CommandImpl<ListFunctionsByCodeSigningConfigCommandInput, ListFunctionsByCodeSigningConfigCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListFunctionsByCodeSigningConfigCommandInput): import("@smithy/core/client").CommandImpl<ListFunctionsByCodeSigningConfigCommandInput, ListFunctionsByCodeSigningConfigCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
