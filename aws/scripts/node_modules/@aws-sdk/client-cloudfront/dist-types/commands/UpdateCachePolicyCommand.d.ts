...
declare const UpdateCachePolicyCommand_base: {
    new (input: UpdateCachePolicyCommandInput): import("@smithy/core/client").CommandImpl<UpdateCachePolicyCommandInput, UpdateCachePolicyCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateCachePolicyCommandInput): import("@smithy/core/client").CommandImpl<UpdateCachePolicyCommandInput, UpdateCachePolicyCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
