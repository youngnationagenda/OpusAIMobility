...
declare const UpdateConnectionFunctionCommand_base: {
    new (input: UpdateConnectionFunctionCommandInput): import("@smithy/core/client").CommandImpl<UpdateConnectionFunctionCommandInput, UpdateConnectionFunctionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateConnectionFunctionCommandInput): import("@smithy/core/client").CommandImpl<UpdateConnectionFunctionCommandInput, UpdateConnectionFunctionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
