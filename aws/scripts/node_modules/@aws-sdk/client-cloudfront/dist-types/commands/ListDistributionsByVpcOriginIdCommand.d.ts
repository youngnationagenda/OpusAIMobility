...
declare const ListDistributionsByVpcOriginIdCommand_base: {
    new (input: ListDistributionsByVpcOriginIdCommandInput): import("@smithy/core/client").CommandImpl<ListDistributionsByVpcOriginIdCommandInput, ListDistributionsByVpcOriginIdCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListDistributionsByVpcOriginIdCommandInput): import("@smithy/core/client").CommandImpl<ListDistributionsByVpcOriginIdCommandInput, ListDistributionsByVpcOriginIdCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
