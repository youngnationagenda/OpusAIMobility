...
declare const ListFunctionsCommand_base: {
    new (input: ListFunctionsCommandInput): import("@smithy/core/client").CommandImpl<ListFunctionsCommandInput, ListFunctionsCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListFunctionsCommandInput]): import("@smithy/core/client").CommandImpl<ListFunctionsCommandInput, ListFunctionsCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
