...
declare const ListVpcOriginsCommand_base: {
    new (input: ListVpcOriginsCommandInput): import("@smithy/core/client").CommandImpl<ListVpcOriginsCommandInput, ListVpcOriginsCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListVpcOriginsCommandInput]): import("@smithy/core/client").CommandImpl<ListVpcOriginsCommandInput, ListVpcOriginsCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
