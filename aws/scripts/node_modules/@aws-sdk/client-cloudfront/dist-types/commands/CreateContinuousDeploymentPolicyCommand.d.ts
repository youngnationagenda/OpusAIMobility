...
declare const CreateContinuousDeploymentPolicyCommand_base: {
    new (input: CreateContinuousDeploymentPolicyCommandInput): import("@smithy/core/client").CommandImpl<CreateContinuousDeploymentPolicyCommandInput, CreateContinuousDeploymentPolicyCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateContinuousDeploymentPolicyCommandInput): import("@smithy/core/client").CommandImpl<CreateContinuousDeploymentPolicyCommandInput, CreateContinuousDeploymentPolicyCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
