...
declare const ListConnectionFunctionsCommand_base: {
    new (input: ListConnectionFunctionsCommandInput): import("@smithy/core/client").CommandImpl<ListConnectionFunctionsCommandInput, ListConnectionFunctionsCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListConnectionFunctionsCommandInput]): import("@smithy/core/client").CommandImpl<ListConnectionFunctionsCommandInput, ListConnectionFunctionsCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
