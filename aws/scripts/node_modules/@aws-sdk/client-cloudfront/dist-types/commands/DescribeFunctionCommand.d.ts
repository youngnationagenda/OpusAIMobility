...
declare const DescribeFunctionCommand_base: {
    new (input: DescribeFunctionCommandInput): import("@smithy/core/client").CommandImpl<DescribeFunctionCommandInput, DescribeFunctionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeFunctionCommandInput): import("@smithy/core/client").CommandImpl<DescribeFunctionCommandInput, DescribeFunctionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
