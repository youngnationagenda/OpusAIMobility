...
declare const ListDistributionTenantsByCustomizationCommand_base: {
    new (input: ListDistributionTenantsByCustomizationCommandInput): import("@smithy/core/client").CommandImpl<ListDistributionTenantsByCustomizationCommandInput, ListDistributionTenantsByCustomizationCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListDistributionTenantsByCustomizationCommandInput]): import("@smithy/core/client").CommandImpl<ListDistributionTenantsByCustomizationCommandInput, ListDistributionTenantsByCustomizationCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
