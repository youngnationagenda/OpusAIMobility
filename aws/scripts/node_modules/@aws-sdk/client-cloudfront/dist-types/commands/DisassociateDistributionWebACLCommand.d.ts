...
declare const DisassociateDistributionWebACLCommand_base: {
    new (input: DisassociateDistributionWebACLCommandInput): import("@smithy/core/client").CommandImpl<DisassociateDistributionWebACLCommandInput, DisassociateDistributionWebACLCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisassociateDistributionWebACLCommandInput): import("@smithy/core/client").CommandImpl<DisassociateDistributionWebACLCommandInput, DisassociateDistributionWebACLCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
