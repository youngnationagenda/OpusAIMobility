...
declare const UpdateAnycastIpListCommand_base: {
    new (input: UpdateAnycastIpListCommandInput): import("@smithy/core/client").CommandImpl<UpdateAnycastIpListCommandInput, UpdateAnycastIpListCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateAnycastIpListCommandInput): import("@smithy/core/client").CommandImpl<UpdateAnycastIpListCommandInput, UpdateAnycastIpListCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
