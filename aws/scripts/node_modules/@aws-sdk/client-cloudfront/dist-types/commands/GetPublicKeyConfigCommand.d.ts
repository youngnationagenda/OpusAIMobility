...
declare const GetPublicKeyConfigCommand_base: {
    new (input: GetPublicKeyConfigCommandInput): import("@smithy/core/client").CommandImpl<GetPublicKeyConfigCommandInput, GetPublicKeyConfigCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetPublicKeyConfigCommandInput): import("@smithy/core/client").CommandImpl<GetPublicKeyConfigCommandInput, GetPublicKeyConfigCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
