...
declare const CreateKeyValueStoreCommand_base: {
    new (input: CreateKeyValueStoreCommandInput): import("@smithy/core/client").CommandImpl<CreateKeyValueStoreCommandInput, CreateKeyValueStoreCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateKeyValueStoreCommandInput): import("@smithy/core/client").CommandImpl<CreateKeyValueStoreCommandInput, CreateKeyValueStoreCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
