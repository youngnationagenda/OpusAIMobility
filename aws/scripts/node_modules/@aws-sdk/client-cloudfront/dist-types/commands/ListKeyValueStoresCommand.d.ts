...
declare const ListKeyValueStoresCommand_base: {
    new (input: ListKeyValueStoresCommandInput): import("@smithy/core/client").CommandImpl<ListKeyValueStoresCommandInput, ListKeyValueStoresCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListKeyValueStoresCommandInput]): import("@smithy/core/client").CommandImpl<ListKeyValueStoresCommandInput, ListKeyValueStoresCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
