...
declare const GetOriginRequestPolicyCommand_base: {
    new (input: GetOriginRequestPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetOriginRequestPolicyCommandInput, GetOriginRequestPolicyCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetOriginRequestPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetOriginRequestPolicyCommandInput, GetOriginRequestPolicyCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
