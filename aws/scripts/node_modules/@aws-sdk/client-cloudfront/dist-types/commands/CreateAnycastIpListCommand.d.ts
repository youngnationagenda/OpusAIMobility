...
declare const CreateAnycastIpListCommand_base: {
    new (input: CreateAnycastIpListCommandInput): import("@smithy/core/client").CommandImpl<CreateAnycastIpListCommandInput, CreateAnycastIpListCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateAnycastIpListCommandInput): import("@smithy/core/client").CommandImpl<CreateAnycastIpListCommandInput, CreateAnycastIpListCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
