...
declare const GetResponseHeadersPolicyCommand_base: {
    new (input: GetResponseHeadersPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetResponseHeadersPolicyCommandInput, GetResponseHeadersPolicyCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetResponseHeadersPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetResponseHeadersPolicyCommandInput, GetResponseHeadersPolicyCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
