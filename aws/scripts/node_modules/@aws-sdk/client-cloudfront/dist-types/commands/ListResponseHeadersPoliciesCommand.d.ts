...
declare const ListResponseHeadersPoliciesCommand_base: {
    new (input: ListResponseHeadersPoliciesCommandInput): import("@smithy/core/client").CommandImpl<ListResponseHeadersPoliciesCommandInput, ListResponseHeadersPoliciesCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListResponseHeadersPoliciesCommandInput]): import("@smithy/core/client").CommandImpl<ListResponseHeadersPoliciesCommandInput, ListResponseHeadersPoliciesCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
