...
declare const GetCachePolicyCommand_base: {
    new (input: GetCachePolicyCommandInput): import("@smithy/core/client").CommandImpl<GetCachePolicyCommandInput, GetCachePolicyCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetCachePolicyCommandInput): import("@smithy/core/client").CommandImpl<GetCachePolicyCommandInput, GetCachePolicyCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
