...
declare const GetFunctionCommand_base: {
    new (input: GetFunctionCommandInput): import("@smithy/core/client").CommandImpl<GetFunctionCommandInput, GetFunctionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetFunctionCommandInput): import("@smithy/core/client").CommandImpl<GetFunctionCommandInput, GetFunctionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
