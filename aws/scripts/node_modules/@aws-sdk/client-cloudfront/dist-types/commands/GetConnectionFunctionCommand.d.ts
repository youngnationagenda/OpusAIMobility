...
declare const GetConnectionFunctionCommand_base: {
    new (input: GetConnectionFunctionCommandInput): import("@smithy/core/client").CommandImpl<GetConnectionFunctionCommandInput, GetConnectionFunctionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetConnectionFunctionCommandInput): import("@smithy/core/client").CommandImpl<GetConnectionFunctionCommandInput, GetConnectionFunctionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
