...
declare const ListDistributionsCommand_base: {
    new (input: ListDistributionsCommandInput): import("@smithy/core/client").CommandImpl<ListDistributionsCommandInput, ListDistributionsCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListDistributionsCommandInput]): import("@smithy/core/client").CommandImpl<ListDistributionsCommandInput, ListDistributionsCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
