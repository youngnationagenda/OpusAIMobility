...
declare const DeleteStreamingDistributionCommand_base: {
    new (input: DeleteStreamingDistributionCommandInput): import("@smithy/core/client").CommandImpl<DeleteStreamingDistributionCommandInput, DeleteStreamingDistributionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteStreamingDistributionCommandInput): import("@smithy/core/client").CommandImpl<DeleteStreamingDistributionCommandInput, DeleteStreamingDistributionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
