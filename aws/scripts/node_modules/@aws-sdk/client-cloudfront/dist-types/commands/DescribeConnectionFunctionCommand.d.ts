...
declare const DescribeConnectionFunctionCommand_base: {
    new (input: DescribeConnectionFunctionCommandInput): import("@smithy/core/client").CommandImpl<DescribeConnectionFunctionCommandInput, DescribeConnectionFunctionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeConnectionFunctionCommandInput): import("@smithy/core/client").CommandImpl<DescribeConnectionFunctionCommandInput, DescribeConnectionFunctionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
