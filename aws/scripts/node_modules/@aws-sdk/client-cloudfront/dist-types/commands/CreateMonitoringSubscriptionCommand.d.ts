...
declare const CreateMonitoringSubscriptionCommand_base: {
    new (input: CreateMonitoringSubscriptionCommandInput): import("@smithy/core/client").CommandImpl<CreateMonitoringSubscriptionCommandInput, CreateMonitoringSubscriptionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateMonitoringSubscriptionCommandInput): import("@smithy/core/client").CommandImpl<CreateMonitoringSubscriptionCommandInput, CreateMonitoringSubscriptionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
