...
declare const ListDistributionsByOwnedResourceCommand_base: {
    new (input: ListDistributionsByOwnedResourceCommandInput): import("@smithy/core/client").CommandImpl<ListDistributionsByOwnedResourceCommandInput, ListDistributionsByOwnedResourceCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListDistributionsByOwnedResourceCommandInput): import("@smithy/core/client").CommandImpl<ListDistributionsByOwnedResourceCommandInput, ListDistributionsByOwnedResourceCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
