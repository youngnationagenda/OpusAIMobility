...
declare const CreateOriginRequestPolicyCommand_base: {
    new (input: CreateOriginRequestPolicyCommandInput): import("@smithy/core/client").CommandImpl<CreateOriginRequestPolicyCommandInput, CreateOriginRequestPolicyCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateOriginRequestPolicyCommandInput): import("@smithy/core/client").CommandImpl<CreateOriginRequestPolicyCommandInput, CreateOriginRequestPolicyCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
