...
declare const ListConnectionGroupsCommand_base: {
    new (input: ListConnectionGroupsCommandInput): import("@smithy/core/client").CommandImpl<ListConnectionGroupsCommandInput, ListConnectionGroupsCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListConnectionGroupsCommandInput]): import("@smithy/core/client").CommandImpl<ListConnectionGroupsCommandInput, ListConnectionGroupsCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
