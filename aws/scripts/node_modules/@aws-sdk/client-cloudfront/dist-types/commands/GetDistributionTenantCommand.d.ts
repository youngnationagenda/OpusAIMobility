...
declare const GetDistributionTenantCommand_base: {
    new (input: GetDistributionTenantCommandInput): import("@smithy/core/client").CommandImpl<GetDistributionTenantCommandInput, GetDistributionTenantCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetDistributionTenantCommandInput): import("@smithy/core/client").CommandImpl<GetDistributionTenantCommandInput, GetDistributionTenantCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
