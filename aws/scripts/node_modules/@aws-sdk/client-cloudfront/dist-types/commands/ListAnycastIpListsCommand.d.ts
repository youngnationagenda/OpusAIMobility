...
declare const ListAnycastIpListsCommand_base: {
    new (input: ListAnycastIpListsCommandInput): import("@smithy/core/client").CommandImpl<ListAnycastIpListsCommandInput, ListAnycastIpListsCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListAnycastIpListsCommandInput]): import("@smithy/core/client").CommandImpl<ListAnycastIpListsCommandInput, ListAnycastIpListsCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
