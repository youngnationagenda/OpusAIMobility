...
declare const ListContinuousDeploymentPoliciesCommand_base: {
    new (input: ListContinuousDeploymentPoliciesCommandInput): import("@smithy/core/client").CommandImpl<ListContinuousDeploymentPoliciesCommandInput, ListContinuousDeploymentPoliciesCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListContinuousDeploymentPoliciesCommandInput]): import("@smithy/core/client").CommandImpl<ListContinuousDeploymentPoliciesCommandInput, ListContinuousDeploymentPoliciesCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
