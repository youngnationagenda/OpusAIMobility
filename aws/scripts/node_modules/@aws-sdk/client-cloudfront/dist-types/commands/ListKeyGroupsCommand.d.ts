...
declare const ListKeyGroupsCommand_base: {
    new (input: ListKeyGroupsCommandInput): import("@smithy/core/client").CommandImpl<ListKeyGroupsCommandInput, ListKeyGroupsCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListKeyGroupsCommandInput]): import("@smithy/core/client").CommandImpl<ListKeyGroupsCommandInput, ListKeyGroupsCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
