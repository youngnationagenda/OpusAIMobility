...
declare const GetPublicKeyCommand_base: {
    new (input: GetPublicKeyCommandInput): import("@smithy/core/client").CommandImpl<GetPublicKeyCommandInput, GetPublicKeyCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetPublicKeyCommandInput): import("@smithy/core/client").CommandImpl<GetPublicKeyCommandInput, GetPublicKeyCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
