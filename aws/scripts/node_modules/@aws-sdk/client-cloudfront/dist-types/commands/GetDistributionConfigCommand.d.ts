...
declare const GetDistributionConfigCommand_base: {
    new (input: GetDistributionConfigCommandInput): import("@smithy/core/client").CommandImpl<GetDistributionConfigCommandInput, GetDistributionConfigCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetDistributionConfigCommandInput): import("@smithy/core/client").CommandImpl<GetDistributionConfigCommandInput, GetDistributionConfigCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
