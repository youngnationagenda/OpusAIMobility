...
declare const CreateResponseHeadersPolicyCommand_base: {
    new (input: CreateResponseHeadersPolicyCommandInput): import("@smithy/core/client").CommandImpl<CreateResponseHeadersPolicyCommandInput, CreateResponseHeadersPolicyCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateResponseHeadersPolicyCommandInput): import("@smithy/core/client").CommandImpl<CreateResponseHeadersPolicyCommandInput, CreateResponseHeadersPolicyCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
