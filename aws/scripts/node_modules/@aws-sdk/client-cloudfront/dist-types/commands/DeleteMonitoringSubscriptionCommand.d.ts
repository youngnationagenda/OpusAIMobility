...
declare const DeleteMonitoringSubscriptionCommand_base: {
    new (input: DeleteMonitoringSubscriptionCommandInput): import("@smithy/core/client").CommandImpl<DeleteMonitoringSubscriptionCommandInput, DeleteMonitoringSubscriptionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteMonitoringSubscriptionCommandInput): import("@smithy/core/client").CommandImpl<DeleteMonitoringSubscriptionCommandInput, DeleteMonitoringSubscriptionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
