...
declare const DeleteKeyGroupCommand_base: {
    new (input: DeleteKeyGroupCommandInput): import("@smithy/core/client").CommandImpl<DeleteKeyGroupCommandInput, DeleteKeyGroupCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteKeyGroupCommandInput): import("@smithy/core/client").CommandImpl<DeleteKeyGroupCommandInput, DeleteKeyGroupCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
