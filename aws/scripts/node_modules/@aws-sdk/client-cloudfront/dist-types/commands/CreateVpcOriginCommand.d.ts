...
declare const CreateVpcOriginCommand_base: {
    new (input: CreateVpcOriginCommandInput): import("@smithy/core/client").CommandImpl<CreateVpcOriginCommandInput, CreateVpcOriginCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateVpcOriginCommandInput): import("@smithy/core/client").CommandImpl<CreateVpcOriginCommandInput, CreateVpcOriginCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
