...
declare const ListCachePoliciesCommand_base: {
    new (input: ListCachePoliciesCommandInput): import("@smithy/core/client").CommandImpl<ListCachePoliciesCommandInput, ListCachePoliciesCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListCachePoliciesCommandInput]): import("@smithy/core/client").CommandImpl<ListCachePoliciesCommandInput, ListCachePoliciesCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
