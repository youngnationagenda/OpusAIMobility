...
declare const CreateDistributionCommand_base: {
    new (input: CreateDistributionCommandInput): import("@smithy/core/client").CommandImpl<CreateDistributionCommandInput, CreateDistributionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateDistributionCommandInput): import("@smithy/core/client").CommandImpl<CreateDistributionCommandInput, CreateDistributionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
