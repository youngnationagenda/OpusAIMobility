...
declare const GetKeyGroupCommand_base: {
    new (input: GetKeyGroupCommandInput): import("@smithy/core/client").CommandImpl<GetKeyGroupCommandInput, GetKeyGroupCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetKeyGroupCommandInput): import("@smithy/core/client").CommandImpl<GetKeyGroupCommandInput, GetKeyGroupCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
