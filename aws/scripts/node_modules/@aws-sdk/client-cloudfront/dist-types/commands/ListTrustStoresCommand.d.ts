...
declare const ListTrustStoresCommand_base: {
    new (input: ListTrustStoresCommandInput): import("@smithy/core/client").CommandImpl<ListTrustStoresCommandInput, ListTrustStoresCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListTrustStoresCommandInput]): import("@smithy/core/client").CommandImpl<ListTrustStoresCommandInput, ListTrustStoresCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
