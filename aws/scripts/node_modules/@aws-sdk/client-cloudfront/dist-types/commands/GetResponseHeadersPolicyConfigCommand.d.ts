...
declare const GetResponseHeadersPolicyConfigCommand_base: {
    new (input: GetResponseHeadersPolicyConfigCommandInput): import("@smithy/core/client").CommandImpl<GetResponseHeadersPolicyConfigCommandInput, GetResponseHeadersPolicyConfigCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetResponseHeadersPolicyConfigCommandInput): import("@smithy/core/client").CommandImpl<GetResponseHeadersPolicyConfigCommandInput, GetResponseHeadersPolicyConfigCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
