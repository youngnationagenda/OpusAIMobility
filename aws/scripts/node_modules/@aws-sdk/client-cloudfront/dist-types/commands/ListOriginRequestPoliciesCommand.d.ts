...
declare const ListOriginRequestPoliciesCommand_base: {
    new (input: ListOriginRequestPoliciesCommandInput): import("@smithy/core/client").CommandImpl<ListOriginRequestPoliciesCommandInput, ListOriginRequestPoliciesCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListOriginRequestPoliciesCommandInput]): import("@smithy/core/client").CommandImpl<ListOriginRequestPoliciesCommandInput, ListOriginRequestPoliciesCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
