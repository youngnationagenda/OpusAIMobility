...
declare const GetContinuousDeploymentPolicyCommand_base: {
    new (input: GetContinuousDeploymentPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetContinuousDeploymentPolicyCommandInput, GetContinuousDeploymentPolicyCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetContinuousDeploymentPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetContinuousDeploymentPolicyCommandInput, GetContinuousDeploymentPolicyCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
