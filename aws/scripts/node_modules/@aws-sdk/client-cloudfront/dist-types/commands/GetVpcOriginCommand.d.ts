...
declare const GetVpcOriginCommand_base: {
    new (input: GetVpcOriginCommandInput): import("@smithy/core/client").CommandImpl<GetVpcOriginCommandInput, GetVpcOriginCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetVpcOriginCommandInput): import("@smithy/core/client").CommandImpl<GetVpcOriginCommandInput, GetVpcOriginCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
