...
declare const DeleteConnectionGroupCommand_base: {
    new (input: DeleteConnectionGroupCommandInput): import("@smithy/core/client").CommandImpl<DeleteConnectionGroupCommandInput, DeleteConnectionGroupCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteConnectionGroupCommandInput): import("@smithy/core/client").CommandImpl<DeleteConnectionGroupCommandInput, DeleteConnectionGroupCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
