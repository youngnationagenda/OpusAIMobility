...
declare const ListStreamingDistributionsCommand_base: {
    new (input: ListStreamingDistributionsCommandInput): import("@smithy/core/client").CommandImpl<ListStreamingDistributionsCommandInput, ListStreamingDistributionsCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListStreamingDistributionsCommandInput]): import("@smithy/core/client").CommandImpl<ListStreamingDistributionsCommandInput, ListStreamingDistributionsCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
