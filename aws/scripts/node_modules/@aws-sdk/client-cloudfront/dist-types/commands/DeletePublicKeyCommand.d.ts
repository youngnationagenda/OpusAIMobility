...
declare const DeletePublicKeyCommand_base: {
    new (input: DeletePublicKeyCommandInput): import("@smithy/core/client").CommandImpl<DeletePublicKeyCommandInput, DeletePublicKeyCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeletePublicKeyCommandInput): import("@smithy/core/client").CommandImpl<DeletePublicKeyCommandInput, DeletePublicKeyCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
