...
declare const ListPublicKeysCommand_base: {
    new (input: ListPublicKeysCommandInput): import("@smithy/core/client").CommandImpl<ListPublicKeysCommandInput, ListPublicKeysCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListPublicKeysCommandInput]): import("@smithy/core/client").CommandImpl<ListPublicKeysCommandInput, ListPublicKeysCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
