...
declare const ListDistributionsByCachePolicyIdCommand_base: {
    new (input: ListDistributionsByCachePolicyIdCommandInput): import("@smithy/core/client").CommandImpl<ListDistributionsByCachePolicyIdCommandInput, ListDistributionsByCachePolicyIdCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListDistributionsByCachePolicyIdCommandInput): import("@smithy/core/client").CommandImpl<ListDistributionsByCachePolicyIdCommandInput, ListDistributionsByCachePolicyIdCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
