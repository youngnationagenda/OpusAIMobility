...
declare const ListDistributionsByRealtimeLogConfigCommand_base: {
    new (input: ListDistributionsByRealtimeLogConfigCommandInput): import("@smithy/core/client").CommandImpl<ListDistributionsByRealtimeLogConfigCommandInput, ListDistributionsByRealtimeLogConfigCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListDistributionsByRealtimeLogConfigCommandInput]): import("@smithy/core/client").CommandImpl<ListDistributionsByRealtimeLogConfigCommandInput, ListDistributionsByRealtimeLogConfigCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
