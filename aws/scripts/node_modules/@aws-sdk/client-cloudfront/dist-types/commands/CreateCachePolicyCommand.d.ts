...
declare const CreateCachePolicyCommand_base: {
    new (input: CreateCachePolicyCommandInput): import("@smithy/core/client").CommandImpl<CreateCachePolicyCommandInput, CreateCachePolicyCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateCachePolicyCommandInput): import("@smithy/core/client").CommandImpl<CreateCachePolicyCommandInput, CreateCachePolicyCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
