...
declare const CreateOriginAccessControlCommand_base: {
    new (input: CreateOriginAccessControlCommandInput): import("@smithy/core/client").CommandImpl<CreateOriginAccessControlCommandInput, CreateOriginAccessControlCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateOriginAccessControlCommandInput): import("@smithy/core/client").CommandImpl<CreateOriginAccessControlCommandInput, CreateOriginAccessControlCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
