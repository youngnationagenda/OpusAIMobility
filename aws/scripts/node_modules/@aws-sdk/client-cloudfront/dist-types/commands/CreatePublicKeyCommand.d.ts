...
declare const CreatePublicKeyCommand_base: {
    new (input: CreatePublicKeyCommandInput): import("@smithy/core/client").CommandImpl<CreatePublicKeyCommandInput, CreatePublicKeyCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreatePublicKeyCommandInput): import("@smithy/core/client").CommandImpl<CreatePublicKeyCommandInput, CreatePublicKeyCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
