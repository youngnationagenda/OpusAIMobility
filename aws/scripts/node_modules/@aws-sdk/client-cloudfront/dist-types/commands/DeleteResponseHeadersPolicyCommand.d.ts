...
declare const DeleteResponseHeadersPolicyCommand_base: {
    new (input: DeleteResponseHeadersPolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteResponseHeadersPolicyCommandInput, DeleteResponseHeadersPolicyCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteResponseHeadersPolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteResponseHeadersPolicyCommandInput, DeleteResponseHeadersPolicyCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
