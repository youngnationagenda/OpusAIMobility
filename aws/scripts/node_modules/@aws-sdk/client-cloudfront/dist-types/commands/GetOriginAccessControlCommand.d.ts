...
declare const GetOriginAccessControlCommand_base: {
    new (input: GetOriginAccessControlCommandInput): import("@smithy/core/client").CommandImpl<GetOriginAccessControlCommandInput, GetOriginAccessControlCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetOriginAccessControlCommandInput): import("@smithy/core/client").CommandImpl<GetOriginAccessControlCommandInput, GetOriginAccessControlCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
