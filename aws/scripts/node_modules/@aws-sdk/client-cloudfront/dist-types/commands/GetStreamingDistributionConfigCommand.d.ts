...
declare const GetStreamingDistributionConfigCommand_base: {
    new (input: GetStreamingDistributionConfigCommandInput): import("@smithy/core/client").CommandImpl<GetStreamingDistributionConfigCommandInput, GetStreamingDistributionConfigCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetStreamingDistributionConfigCommandInput): import("@smithy/core/client").CommandImpl<GetStreamingDistributionConfigCommandInput, GetStreamingDistributionConfigCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
