...
declare const GetFieldLevelEncryptionCommand_base: {
    new (input: GetFieldLevelEncryptionCommandInput): import("@smithy/core/client").CommandImpl<GetFieldLevelEncryptionCommandInput, GetFieldLevelEncryptionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetFieldLevelEncryptionCommandInput): import("@smithy/core/client").CommandImpl<GetFieldLevelEncryptionCommandInput, GetFieldLevelEncryptionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
