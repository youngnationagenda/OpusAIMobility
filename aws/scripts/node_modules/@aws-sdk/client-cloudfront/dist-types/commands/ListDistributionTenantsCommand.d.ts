...
declare const ListDistributionTenantsCommand_base: {
    new (input: ListDistributionTenantsCommandInput): import("@smithy/core/client").CommandImpl<ListDistributionTenantsCommandInput, ListDistributionTenantsCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListDistributionTenantsCommandInput]): import("@smithy/core/client").CommandImpl<ListDistributionTenantsCommandInput, ListDistributionTenantsCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
