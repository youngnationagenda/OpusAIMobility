...
declare const ListFieldLevelEncryptionConfigsCommand_base: {
    new (input: ListFieldLevelEncryptionConfigsCommandInput): import("@smithy/core/client").CommandImpl<ListFieldLevelEncryptionConfigsCommandInput, ListFieldLevelEncryptionConfigsCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListFieldLevelEncryptionConfigsCommandInput]): import("@smithy/core/client").CommandImpl<ListFieldLevelEncryptionConfigsCommandInput, ListFieldLevelEncryptionConfigsCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
