...
declare const GetOriginAccessControlConfigCommand_base: {
    new (input: GetOriginAccessControlConfigCommandInput): import("@smithy/core/client").CommandImpl<GetOriginAccessControlConfigCommandInput, GetOriginAccessControlConfigCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetOriginAccessControlConfigCommandInput): import("@smithy/core/client").CommandImpl<GetOriginAccessControlConfigCommandInput, GetOriginAccessControlConfigCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
