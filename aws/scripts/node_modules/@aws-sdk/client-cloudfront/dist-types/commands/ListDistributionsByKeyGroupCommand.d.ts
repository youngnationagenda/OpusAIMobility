...
declare const ListDistributionsByKeyGroupCommand_base: {
    new (input: ListDistributionsByKeyGroupCommandInput): import("@smithy/core/client").CommandImpl<ListDistributionsByKeyGroupCommandInput, ListDistributionsByKeyGroupCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListDistributionsByKeyGroupCommandInput): import("@smithy/core/client").CommandImpl<ListDistributionsByKeyGroupCommandInput, ListDistributionsByKeyGroupCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
