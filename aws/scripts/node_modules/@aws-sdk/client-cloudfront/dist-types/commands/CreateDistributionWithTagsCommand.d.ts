...
declare const CreateDistributionWithTagsCommand_base: {
    new (input: CreateDistributionWithTagsCommandInput): import("@smithy/core/client").CommandImpl<CreateDistributionWithTagsCommandInput, CreateDistributionWithTagsCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateDistributionWithTagsCommandInput): import("@smithy/core/client").CommandImpl<CreateDistributionWithTagsCommandInput, CreateDistributionWithTagsCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
