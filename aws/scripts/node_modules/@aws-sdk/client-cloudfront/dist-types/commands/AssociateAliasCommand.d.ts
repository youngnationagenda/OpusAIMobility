...
declare const AssociateAliasCommand_base: {
    new (input: AssociateAliasCommandInput): import("@smithy/core/client").CommandImpl<AssociateAliasCommandInput, AssociateAliasCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AssociateAliasCommandInput): import("@smithy/core/client").CommandImpl<AssociateAliasCommandInput, AssociateAliasCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
