...
declare const DescribeKeyValueStoreCommand_base: {
    new (input: DescribeKeyValueStoreCommandInput): import("@smithy/core/client").CommandImpl<DescribeKeyValueStoreCommandInput, DescribeKeyValueStoreCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeKeyValueStoreCommandInput): import("@smithy/core/client").CommandImpl<DescribeKeyValueStoreCommandInput, DescribeKeyValueStoreCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
