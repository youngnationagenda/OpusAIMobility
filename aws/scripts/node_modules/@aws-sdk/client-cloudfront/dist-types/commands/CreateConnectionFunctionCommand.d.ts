...
declare const CreateConnectionFunctionCommand_base: {
    new (input: CreateConnectionFunctionCommandInput): import("@smithy/core/client").CommandImpl<CreateConnectionFunctionCommandInput, CreateConnectionFunctionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateConnectionFunctionCommandInput): import("@smithy/core/client").CommandImpl<CreateConnectionFunctionCommandInput, CreateConnectionFunctionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
