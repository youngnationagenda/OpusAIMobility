...
declare const ListDomainConflictsCommand_base: {
    new (input: ListDomainConflictsCommandInput): import("@smithy/core/client").CommandImpl<ListDomainConflictsCommandInput, ListDomainConflictsCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListDomainConflictsCommandInput): import("@smithy/core/client").CommandImpl<ListDomainConflictsCommandInput, ListDomainConflictsCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
