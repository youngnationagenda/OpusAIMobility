...
declare const GetDistributionCommand_base: {
    new (input: GetDistributionCommandInput): import("@smithy/core/client").CommandImpl<GetDistributionCommandInput, GetDistributionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetDistributionCommandInput): import("@smithy/core/client").CommandImpl<GetDistributionCommandInput, GetDistributionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
