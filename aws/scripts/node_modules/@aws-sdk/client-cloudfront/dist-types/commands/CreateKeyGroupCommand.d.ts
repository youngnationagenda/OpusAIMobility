...
declare const CreateKeyGroupCommand_base: {
    new (input: CreateKeyGroupCommandInput): import("@smithy/core/client").CommandImpl<CreateKeyGroupCommandInput, CreateKeyGroupCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateKeyGroupCommandInput): import("@smithy/core/client").CommandImpl<CreateKeyGroupCommandInput, CreateKeyGroupCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
