...
declare const TestFunctionCommand_base: {
    new (input: TestFunctionCommandInput): import("@smithy/core/client").CommandImpl<TestFunctionCommandInput, TestFunctionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: TestFunctionCommandInput): import("@smithy/core/client").CommandImpl<TestFunctionCommandInput, TestFunctionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
