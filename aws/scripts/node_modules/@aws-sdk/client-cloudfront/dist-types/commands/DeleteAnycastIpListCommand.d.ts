...
declare const DeleteAnycastIpListCommand_base: {
    new (input: DeleteAnycastIpListCommandInput): import("@smithy/core/client").CommandImpl<DeleteAnycastIpListCommandInput, DeleteAnycastIpListCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteAnycastIpListCommandInput): import("@smithy/core/client").CommandImpl<DeleteAnycastIpListCommandInput, DeleteAnycastIpListCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
