...
declare const GetRealtimeLogConfigCommand_base: {
    new (input: GetRealtimeLogConfigCommandInput): import("@smithy/core/client").CommandImpl<GetRealtimeLogConfigCommandInput, GetRealtimeLogConfigCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetRealtimeLogConfigCommandInput]): import("@smithy/core/client").CommandImpl<GetRealtimeLogConfigCommandInput, GetRealtimeLogConfigCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
