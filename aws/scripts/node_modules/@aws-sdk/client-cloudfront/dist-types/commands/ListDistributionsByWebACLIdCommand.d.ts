...
declare const ListDistributionsByWebACLIdCommand_base: {
    new (input: ListDistributionsByWebACLIdCommandInput): import("@smithy/core/client").CommandImpl<ListDistributionsByWebACLIdCommandInput, ListDistributionsByWebACLIdCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListDistributionsByWebACLIdCommandInput): import("@smithy/core/client").CommandImpl<ListDistributionsByWebACLIdCommandInput, ListDistributionsByWebACLIdCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
