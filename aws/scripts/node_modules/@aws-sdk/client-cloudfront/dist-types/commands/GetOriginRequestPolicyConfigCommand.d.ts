...
declare const GetOriginRequestPolicyConfigCommand_base: {
    new (input: GetOriginRequestPolicyConfigCommandInput): import("@smithy/core/client").CommandImpl<GetOriginRequestPolicyConfigCommandInput, GetOriginRequestPolicyConfigCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetOriginRequestPolicyConfigCommandInput): import("@smithy/core/client").CommandImpl<GetOriginRequestPolicyConfigCommandInput, GetOriginRequestPolicyConfigCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
