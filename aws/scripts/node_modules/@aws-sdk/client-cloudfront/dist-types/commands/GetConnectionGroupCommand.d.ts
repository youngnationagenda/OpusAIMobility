...
declare const GetConnectionGroupCommand_base: {
    new (input: GetConnectionGroupCommandInput): import("@smithy/core/client").CommandImpl<GetConnectionGroupCommandInput, GetConnectionGroupCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetConnectionGroupCommandInput): import("@smithy/core/client").CommandImpl<GetConnectionGroupCommandInput, GetConnectionGroupCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
