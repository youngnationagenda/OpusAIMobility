...
declare const DeleteFieldLevelEncryptionConfigCommand_base: {
    new (input: DeleteFieldLevelEncryptionConfigCommandInput): import("@smithy/core/client").CommandImpl<DeleteFieldLevelEncryptionConfigCommandInput, DeleteFieldLevelEncryptionConfigCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteFieldLevelEncryptionConfigCommandInput): import("@smithy/core/client").CommandImpl<DeleteFieldLevelEncryptionConfigCommandInput, DeleteFieldLevelEncryptionConfigCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
