...
declare const GetMonitoringSubscriptionCommand_base: {
    new (input: GetMonitoringSubscriptionCommandInput): import("@smithy/core/client").CommandImpl<GetMonitoringSubscriptionCommandInput, GetMonitoringSubscriptionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetMonitoringSubscriptionCommandInput): import("@smithy/core/client").CommandImpl<GetMonitoringSubscriptionCommandInput, GetMonitoringSubscriptionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
