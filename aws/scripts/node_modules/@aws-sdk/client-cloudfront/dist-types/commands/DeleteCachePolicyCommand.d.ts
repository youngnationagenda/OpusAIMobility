...
declare const DeleteCachePolicyCommand_base: {
    new (input: DeleteCachePolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteCachePolicyCommandInput, DeleteCachePolicyCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteCachePolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteCachePolicyCommandInput, DeleteCachePolicyCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
