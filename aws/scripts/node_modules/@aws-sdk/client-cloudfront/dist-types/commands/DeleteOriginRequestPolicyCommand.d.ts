...
declare const DeleteOriginRequestPolicyCommand_base: {
    new (input: DeleteOriginRequestPolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteOriginRequestPolicyCommandInput, DeleteOriginRequestPolicyCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteOriginRequestPolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteOriginRequestPolicyCommandInput, DeleteOriginRequestPolicyCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
