...
declare const ListConflictingAliasesCommand_base: {
    new (input: ListConflictingAliasesCommandInput): import("@smithy/core/client").CommandImpl<ListConflictingAliasesCommandInput, ListConflictingAliasesCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListConflictingAliasesCommandInput): import("@smithy/core/client").CommandImpl<ListConflictingAliasesCommandInput, ListConflictingAliasesCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
