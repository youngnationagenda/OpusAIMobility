...
declare const PublishFunctionCommand_base: {
    new (input: PublishFunctionCommandInput): import("@smithy/core/client").CommandImpl<PublishFunctionCommandInput, PublishFunctionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PublishFunctionCommandInput): import("@smithy/core/client").CommandImpl<PublishFunctionCommandInput, PublishFunctionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
