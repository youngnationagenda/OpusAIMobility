...
declare const PublishConnectionFunctionCommand_base: {
    new (input: PublishConnectionFunctionCommandInput): import("@smithy/core/client").CommandImpl<PublishConnectionFunctionCommandInput, PublishConnectionFunctionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PublishConnectionFunctionCommandInput): import("@smithy/core/client").CommandImpl<PublishConnectionFunctionCommandInput, PublishConnectionFunctionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
