...
declare const CreateConnectionGroupCommand_base: {
    new (input: CreateConnectionGroupCommandInput): import("@smithy/core/client").CommandImpl<CreateConnectionGroupCommandInput, CreateConnectionGroupCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateConnectionGroupCommandInput): import("@smithy/core/client").CommandImpl<CreateConnectionGroupCommandInput, CreateConnectionGroupCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
