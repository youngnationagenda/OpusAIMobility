...
declare const TestConnectionFunctionCommand_base: {
    new (input: TestConnectionFunctionCommandInput): import("@smithy/core/client").CommandImpl<TestConnectionFunctionCommandInput, TestConnectionFunctionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: TestConnectionFunctionCommandInput): import("@smithy/core/client").CommandImpl<TestConnectionFunctionCommandInput, TestConnectionFunctionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
