...
declare const DeleteVpcOriginCommand_base: {
    new (input: DeleteVpcOriginCommandInput): import("@smithy/core/client").CommandImpl<DeleteVpcOriginCommandInput, DeleteVpcOriginCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteVpcOriginCommandInput): import("@smithy/core/client").CommandImpl<DeleteVpcOriginCommandInput, DeleteVpcOriginCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
