...
declare const DeleteDistributionCommand_base: {
    new (input: DeleteDistributionCommandInput): import("@smithy/core/client").CommandImpl<DeleteDistributionCommandInput, DeleteDistributionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteDistributionCommandInput): import("@smithy/core/client").CommandImpl<DeleteDistributionCommandInput, DeleteDistributionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
