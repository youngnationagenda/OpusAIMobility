...
declare const DeleteContinuousDeploymentPolicyCommand_base: {
    new (input: DeleteContinuousDeploymentPolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteContinuousDeploymentPolicyCommandInput, DeleteContinuousDeploymentPolicyCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteContinuousDeploymentPolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteContinuousDeploymentPolicyCommandInput, DeleteContinuousDeploymentPolicyCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
