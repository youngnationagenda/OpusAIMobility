...
declare const CreateRealtimeLogConfigCommand_base: {
    new (input: CreateRealtimeLogConfigCommandInput): import("@smithy/core/client").CommandImpl<CreateRealtimeLogConfigCommandInput, CreateRealtimeLogConfigCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateRealtimeLogConfigCommandInput): import("@smithy/core/client").CommandImpl<CreateRealtimeLogConfigCommandInput, CreateRealtimeLogConfigCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
