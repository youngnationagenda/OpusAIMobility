...
declare const GetStreamingDistributionCommand_base: {
    new (input: GetStreamingDistributionCommandInput): import("@smithy/core/client").CommandImpl<GetStreamingDistributionCommandInput, GetStreamingDistributionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetStreamingDistributionCommandInput): import("@smithy/core/client").CommandImpl<GetStreamingDistributionCommandInput, GetStreamingDistributionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
