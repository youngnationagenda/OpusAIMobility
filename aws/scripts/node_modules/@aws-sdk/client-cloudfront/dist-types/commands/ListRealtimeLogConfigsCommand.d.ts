...
declare const ListRealtimeLogConfigsCommand_base: {
    new (input: ListRealtimeLogConfigsCommandInput): import("@smithy/core/client").CommandImpl<ListRealtimeLogConfigsCommandInput, ListRealtimeLogConfigsCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListRealtimeLogConfigsCommandInput]): import("@smithy/core/client").CommandImpl<ListRealtimeLogConfigsCommandInput, ListRealtimeLogConfigsCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
