...
declare const GetAnycastIpListCommand_base: {
    new (input: GetAnycastIpListCommandInput): import("@smithy/core/client").CommandImpl<GetAnycastIpListCommandInput, GetAnycastIpListCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetAnycastIpListCommandInput): import("@smithy/core/client").CommandImpl<GetAnycastIpListCommandInput, GetAnycastIpListCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
