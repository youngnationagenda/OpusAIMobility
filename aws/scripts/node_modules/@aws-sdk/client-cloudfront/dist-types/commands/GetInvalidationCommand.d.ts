...
declare const GetInvalidationCommand_base: {
    new (input: GetInvalidationCommandInput): import("@smithy/core/client").CommandImpl<GetInvalidationCommandInput, GetInvalidationCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetInvalidationCommandInput): import("@smithy/core/client").CommandImpl<GetInvalidationCommandInput, GetInvalidationCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
