...
declare const GetFieldLevelEncryptionProfileCommand_base: {
    new (input: GetFieldLevelEncryptionProfileCommandInput): import("@smithy/core/client").CommandImpl<GetFieldLevelEncryptionProfileCommandInput, GetFieldLevelEncryptionProfileCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetFieldLevelEncryptionProfileCommandInput): import("@smithy/core/client").CommandImpl<GetFieldLevelEncryptionProfileCommandInput, GetFieldLevelEncryptionProfileCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
