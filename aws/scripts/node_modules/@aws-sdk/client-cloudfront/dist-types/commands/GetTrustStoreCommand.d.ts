...
declare const GetTrustStoreCommand_base: {
    new (input: GetTrustStoreCommandInput): import("@smithy/core/client").CommandImpl<GetTrustStoreCommandInput, GetTrustStoreCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetTrustStoreCommandInput): import("@smithy/core/client").CommandImpl<GetTrustStoreCommandInput, GetTrustStoreCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
