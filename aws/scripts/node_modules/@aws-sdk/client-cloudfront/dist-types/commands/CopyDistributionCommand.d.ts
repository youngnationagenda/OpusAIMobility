...
declare const CopyDistributionCommand_base: {
    new (input: CopyDistributionCommandInput): import("@smithy/core/client").CommandImpl<CopyDistributionCommandInput, CopyDistributionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CopyDistributionCommandInput): import("@smithy/core/client").CommandImpl<CopyDistributionCommandInput, CopyDistributionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
