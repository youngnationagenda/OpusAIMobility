...
declare const CreateFunctionCommand_base: {
    new (input: CreateFunctionCommandInput): import("@smithy/core/client").CommandImpl<CreateFunctionCommandInput, CreateFunctionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateFunctionCommandInput): import("@smithy/core/client").CommandImpl<CreateFunctionCommandInput, CreateFunctionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
