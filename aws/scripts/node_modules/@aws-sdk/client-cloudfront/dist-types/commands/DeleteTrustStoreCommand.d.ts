...
declare const DeleteTrustStoreCommand_base: {
    new (input: DeleteTrustStoreCommandInput): import("@smithy/core/client").CommandImpl<DeleteTrustStoreCommandInput, DeleteTrustStoreCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteTrustStoreCommandInput): import("@smithy/core/client").CommandImpl<DeleteTrustStoreCommandInput, DeleteTrustStoreCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
