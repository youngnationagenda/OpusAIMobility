...
declare const DeleteConnectionFunctionCommand_base: {
    new (input: DeleteConnectionFunctionCommandInput): import("@smithy/core/client").CommandImpl<DeleteConnectionFunctionCommandInput, DeleteConnectionFunctionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteConnectionFunctionCommandInput): import("@smithy/core/client").CommandImpl<DeleteConnectionFunctionCommandInput, DeleteConnectionFunctionCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
