...
declare const ListOriginAccessControlsCommand_base: {
    new (input: ListOriginAccessControlsCommandInput): import("@smithy/core/client").CommandImpl<ListOriginAccessControlsCommandInput, ListOriginAccessControlsCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListOriginAccessControlsCommandInput]): import("@smithy/core/client").CommandImpl<ListOriginAccessControlsCommandInput, ListOriginAccessControlsCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
