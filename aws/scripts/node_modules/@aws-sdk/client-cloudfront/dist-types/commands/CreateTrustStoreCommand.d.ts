...
declare const CreateTrustStoreCommand_base: {
    new (input: CreateTrustStoreCommandInput): import("@smithy/core/client").CommandImpl<CreateTrustStoreCommandInput, CreateTrustStoreCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateTrustStoreCommandInput): import("@smithy/core/client").CommandImpl<CreateTrustStoreCommandInput, CreateTrustStoreCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
