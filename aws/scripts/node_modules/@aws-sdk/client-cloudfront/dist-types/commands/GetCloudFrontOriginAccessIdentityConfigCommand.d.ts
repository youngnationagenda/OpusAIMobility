...
declare const GetCloudFrontOriginAccessIdentityConfigCommand_base: {
    new (input: GetCloudFrontOriginAccessIdentityConfigCommandInput): import("@smithy/core/client").CommandImpl<GetCloudFrontOriginAccessIdentityConfigCommandInput, GetCloudFrontOriginAccessIdentityConfigCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetCloudFrontOriginAccessIdentityConfigCommandInput): import("@smithy/core/client").CommandImpl<GetCloudFrontOriginAccessIdentityConfigCommandInput, GetCloudFrontOriginAccessIdentityConfigCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
