...
declare const DeleteRealtimeLogConfigCommand_base: {
    new (input: DeleteRealtimeLogConfigCommandInput): import("@smithy/core/client").CommandImpl<DeleteRealtimeLogConfigCommandInput, DeleteRealtimeLogConfigCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DeleteRealtimeLogConfigCommandInput]): import("@smithy/core/client").CommandImpl<DeleteRealtimeLogConfigCommandInput, DeleteRealtimeLogConfigCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
