...
declare const GetCachePolicyConfigCommand_base: {
    new (input: GetCachePolicyConfigCommandInput): import("@smithy/core/client").CommandImpl<GetCachePolicyConfigCommandInput, GetCachePolicyConfigCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetCachePolicyConfigCommandInput): import("@smithy/core/client").CommandImpl<GetCachePolicyConfigCommandInput, GetCachePolicyConfigCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
