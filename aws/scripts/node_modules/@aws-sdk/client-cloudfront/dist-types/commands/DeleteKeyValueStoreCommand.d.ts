...
declare const DeleteKeyValueStoreCommand_base: {
    new (input: DeleteKeyValueStoreCommandInput): import("@smithy/core/client").CommandImpl<DeleteKeyValueStoreCommandInput, DeleteKeyValueStoreCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteKeyValueStoreCommandInput): import("@smithy/core/client").CommandImpl<DeleteKeyValueStoreCommandInput, DeleteKeyValueStoreCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
