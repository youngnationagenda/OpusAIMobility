...
declare const ListDistributionsByTrustStoreCommand_base: {
    new (input: ListDistributionsByTrustStoreCommandInput): import("@smithy/core/client").CommandImpl<ListDistributionsByTrustStoreCommandInput, ListDistributionsByTrustStoreCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListDistributionsByTrustStoreCommandInput): import("@smithy/core/client").CommandImpl<ListDistributionsByTrustStoreCommandInput, ListDistributionsByTrustStoreCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
