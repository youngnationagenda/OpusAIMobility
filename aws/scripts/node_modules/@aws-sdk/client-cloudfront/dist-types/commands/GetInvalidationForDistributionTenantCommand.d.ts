...
declare const GetInvalidationForDistributionTenantCommand_base: {
    new (input: GetInvalidationForDistributionTenantCommandInput): import("@smithy/core/client").CommandImpl<GetInvalidationForDistributionTenantCommandInput, GetInvalidationForDistributionTenantCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetInvalidationForDistributionTenantCommandInput): import("@smithy/core/client").CommandImpl<GetInvalidationForDistributionTenantCommandInput, GetInvalidationForDistributionTenantCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
