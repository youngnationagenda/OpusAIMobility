...
declare const ListCloudFrontOriginAccessIdentitiesCommand_base: {
    new (input: ListCloudFrontOriginAccessIdentitiesCommandInput): import("@smithy/core/client").CommandImpl<ListCloudFrontOriginAccessIdentitiesCommandInput, ListCloudFrontOriginAccessIdentitiesCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListCloudFrontOriginAccessIdentitiesCommandInput]): import("@smithy/core/client").CommandImpl<ListCloudFrontOriginAccessIdentitiesCommandInput, ListCloudFrontOriginAccessIdentitiesCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
