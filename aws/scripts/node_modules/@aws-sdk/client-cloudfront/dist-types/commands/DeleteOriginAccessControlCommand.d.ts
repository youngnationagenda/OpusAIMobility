...
declare const DeleteOriginAccessControlCommand_base: {
    new (input: DeleteOriginAccessControlCommandInput): import("@smithy/core/client").CommandImpl<DeleteOriginAccessControlCommandInput, DeleteOriginAccessControlCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteOriginAccessControlCommandInput): import("@smithy/core/client").CommandImpl<DeleteOriginAccessControlCommandInput, DeleteOriginAccessControlCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
