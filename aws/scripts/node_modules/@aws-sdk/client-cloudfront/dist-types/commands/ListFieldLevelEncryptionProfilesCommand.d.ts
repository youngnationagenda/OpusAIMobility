...
declare const ListFieldLevelEncryptionProfilesCommand_base: {
    new (input: ListFieldLevelEncryptionProfilesCommandInput): import("@smithy/core/client").CommandImpl<ListFieldLevelEncryptionProfilesCommandInput, ListFieldLevelEncryptionProfilesCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListFieldLevelEncryptionProfilesCommandInput]): import("@smithy/core/client").CommandImpl<ListFieldLevelEncryptionProfilesCommandInput, ListFieldLevelEncryptionProfilesCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
