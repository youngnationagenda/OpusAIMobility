...
declare const GetKeyGroupConfigCommand_base: {
    new (input: GetKeyGroupConfigCommandInput): import("@smithy/core/client").CommandImpl<GetKeyGroupConfigCommandInput, GetKeyGroupConfigCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetKeyGroupConfigCommandInput): import("@smithy/core/client").CommandImpl<GetKeyGroupConfigCommandInput, GetKeyGroupConfigCommandOutput, import("..").CloudFrontClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
