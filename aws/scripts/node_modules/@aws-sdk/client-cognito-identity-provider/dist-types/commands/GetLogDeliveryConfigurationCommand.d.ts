...
declare const GetLogDeliveryConfigurationCommand_base: {
    new (input: GetLogDeliveryConfigurationCommandInput): import("@smithy/core/client").CommandImpl<GetLogDeliveryConfigurationCommandInput, GetLogDeliveryConfigurationCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetLogDeliveryConfigurationCommandInput): import("@smithy/core/client").CommandImpl<GetLogDeliveryConfigurationCommandInput, GetLogDeliveryConfigurationCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
