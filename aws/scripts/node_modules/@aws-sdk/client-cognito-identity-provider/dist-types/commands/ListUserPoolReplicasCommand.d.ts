...
declare const ListUserPoolReplicasCommand_base: {
    new (input: ListUserPoolReplicasCommandInput): import("@smithy/core/client").CommandImpl<ListUserPoolReplicasCommandInput, ListUserPoolReplicasCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListUserPoolReplicasCommandInput): import("@smithy/core/client").CommandImpl<ListUserPoolReplicasCommandInput, ListUserPoolReplicasCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
