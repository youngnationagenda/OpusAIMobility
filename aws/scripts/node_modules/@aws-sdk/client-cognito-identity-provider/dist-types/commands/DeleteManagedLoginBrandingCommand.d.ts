...
declare const DeleteManagedLoginBrandingCommand_base: {
    new (input: DeleteManagedLoginBrandingCommandInput): import("@smithy/core/client").CommandImpl<DeleteManagedLoginBrandingCommandInput, DeleteManagedLoginBrandingCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteManagedLoginBrandingCommandInput): import("@smithy/core/client").CommandImpl<DeleteManagedLoginBrandingCommandInput, DeleteManagedLoginBrandingCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
