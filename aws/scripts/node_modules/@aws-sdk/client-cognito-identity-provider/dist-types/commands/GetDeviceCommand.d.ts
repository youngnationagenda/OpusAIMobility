...
declare const GetDeviceCommand_base: {
    new (input: GetDeviceCommandInput): import("@smithy/core/client").CommandImpl<GetDeviceCommandInput, GetDeviceCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetDeviceCommandInput): import("@smithy/core/client").CommandImpl<GetDeviceCommandInput, GetDeviceCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
