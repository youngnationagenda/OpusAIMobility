...
declare const UpdateIdentityProviderCommand_base: {
    new (input: UpdateIdentityProviderCommandInput): import("@smithy/core/client").CommandImpl<UpdateIdentityProviderCommandInput, UpdateIdentityProviderCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateIdentityProviderCommandInput): import("@smithy/core/client").CommandImpl<UpdateIdentityProviderCommandInput, UpdateIdentityProviderCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
