...
declare const AdminGetUserCommand_base: {
    new (input: AdminGetUserCommandInput): import("@smithy/core/client").CommandImpl<AdminGetUserCommandInput, AdminGetUserCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AdminGetUserCommandInput): import("@smithy/core/client").CommandImpl<AdminGetUserCommandInput, AdminGetUserCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
