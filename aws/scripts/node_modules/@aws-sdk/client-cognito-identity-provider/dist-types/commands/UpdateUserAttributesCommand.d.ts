...
declare const UpdateUserAttributesCommand_base: {
    new (input: UpdateUserAttributesCommandInput): import("@smithy/core/client").CommandImpl<UpdateUserAttributesCommandInput, UpdateUserAttributesCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateUserAttributesCommandInput): import("@smithy/core/client").CommandImpl<UpdateUserAttributesCommandInput, UpdateUserAttributesCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
