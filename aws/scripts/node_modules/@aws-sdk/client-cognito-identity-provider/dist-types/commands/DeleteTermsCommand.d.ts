...
declare const DeleteTermsCommand_base: {
    new (input: DeleteTermsCommandInput): import("@smithy/core/client").CommandImpl<DeleteTermsCommandInput, DeleteTermsCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteTermsCommandInput): import("@smithy/core/client").CommandImpl<DeleteTermsCommandInput, DeleteTermsCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
