...
declare const AdminListGroupsForUserCommand_base: {
    new (input: AdminListGroupsForUserCommandInput): import("@smithy/core/client").CommandImpl<AdminListGroupsForUserCommandInput, AdminListGroupsForUserCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AdminListGroupsForUserCommandInput): import("@smithy/core/client").CommandImpl<AdminListGroupsForUserCommandInput, AdminListGroupsForUserCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
