...
declare const DescribeRiskConfigurationCommand_base: {
    new (input: DescribeRiskConfigurationCommandInput): import("@smithy/core/client").CommandImpl<DescribeRiskConfigurationCommandInput, DescribeRiskConfigurationCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeRiskConfigurationCommandInput): import("@smithy/core/client").CommandImpl<DescribeRiskConfigurationCommandInput, DescribeRiskConfigurationCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
