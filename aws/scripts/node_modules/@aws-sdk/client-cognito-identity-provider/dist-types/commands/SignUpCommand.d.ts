...
declare const SignUpCommand_base: {
    new (input: SignUpCommandInput): import("@smithy/core/client").CommandImpl<SignUpCommandInput, SignUpCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SignUpCommandInput): import("@smithy/core/client").CommandImpl<SignUpCommandInput, SignUpCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
