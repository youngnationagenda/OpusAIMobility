...
declare const AdminGetDeviceCommand_base: {
    new (input: AdminGetDeviceCommandInput): import("@smithy/core/client").CommandImpl<AdminGetDeviceCommandInput, AdminGetDeviceCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AdminGetDeviceCommandInput): import("@smithy/core/client").CommandImpl<AdminGetDeviceCommandInput, AdminGetDeviceCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
