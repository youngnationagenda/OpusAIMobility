...
declare const AdminInitiateAuthCommand_base: {
    new (input: AdminInitiateAuthCommandInput): import("@smithy/core/client").CommandImpl<AdminInitiateAuthCommandInput, AdminInitiateAuthCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AdminInitiateAuthCommandInput): import("@smithy/core/client").CommandImpl<AdminInitiateAuthCommandInput, AdminInitiateAuthCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
