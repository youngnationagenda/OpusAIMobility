...
declare const ChangePasswordCommand_base: {
    new (input: ChangePasswordCommandInput): import("@smithy/core/client").CommandImpl<ChangePasswordCommandInput, ChangePasswordCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ChangePasswordCommandInput): import("@smithy/core/client").CommandImpl<ChangePasswordCommandInput, ChangePasswordCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
