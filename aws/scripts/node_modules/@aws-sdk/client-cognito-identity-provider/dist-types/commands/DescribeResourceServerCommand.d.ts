...
declare const DescribeResourceServerCommand_base: {
    new (input: DescribeResourceServerCommandInput): import("@smithy/core/client").CommandImpl<DescribeResourceServerCommandInput, DescribeResourceServerCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeResourceServerCommandInput): import("@smithy/core/client").CommandImpl<DescribeResourceServerCommandInput, DescribeResourceServerCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
