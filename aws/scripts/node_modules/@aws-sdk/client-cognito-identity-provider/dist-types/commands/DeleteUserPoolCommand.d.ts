...
declare const DeleteUserPoolCommand_base: {
    new (input: DeleteUserPoolCommandInput): import("@smithy/core/client").CommandImpl<DeleteUserPoolCommandInput, DeleteUserPoolCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteUserPoolCommandInput): import("@smithy/core/client").CommandImpl<DeleteUserPoolCommandInput, DeleteUserPoolCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
