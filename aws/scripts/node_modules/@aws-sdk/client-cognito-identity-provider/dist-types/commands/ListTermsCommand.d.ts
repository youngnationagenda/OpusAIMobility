...
declare const ListTermsCommand_base: {
    new (input: ListTermsCommandInput): import("@smithy/core/client").CommandImpl<ListTermsCommandInput, ListTermsCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListTermsCommandInput): import("@smithy/core/client").CommandImpl<ListTermsCommandInput, ListTermsCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
