...
declare const AdminUpdateUserAttributesCommand_base: {
    new (input: AdminUpdateUserAttributesCommandInput): import("@smithy/core/client").CommandImpl<AdminUpdateUserAttributesCommandInput, AdminUpdateUserAttributesCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AdminUpdateUserAttributesCommandInput): import("@smithy/core/client").CommandImpl<AdminUpdateUserAttributesCommandInput, AdminUpdateUserAttributesCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
