...
declare const GetTokensFromRefreshTokenCommand_base: {
    new (input: GetTokensFromRefreshTokenCommandInput): import("@smithy/core/client").CommandImpl<GetTokensFromRefreshTokenCommandInput, GetTokensFromRefreshTokenCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetTokensFromRefreshTokenCommandInput): import("@smithy/core/client").CommandImpl<GetTokensFromRefreshTokenCommandInput, GetTokensFromRefreshTokenCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
