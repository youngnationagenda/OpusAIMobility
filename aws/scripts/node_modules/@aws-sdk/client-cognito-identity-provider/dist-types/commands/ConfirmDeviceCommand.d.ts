...
declare const ConfirmDeviceCommand_base: {
    new (input: ConfirmDeviceCommandInput): import("@smithy/core/client").CommandImpl<ConfirmDeviceCommandInput, ConfirmDeviceCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ConfirmDeviceCommandInput): import("@smithy/core/client").CommandImpl<ConfirmDeviceCommandInput, ConfirmDeviceCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
