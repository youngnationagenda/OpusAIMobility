...
declare const ForgetDeviceCommand_base: {
    new (input: ForgetDeviceCommandInput): import("@smithy/core/client").CommandImpl<ForgetDeviceCommandInput, ForgetDeviceCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ForgetDeviceCommandInput): import("@smithy/core/client").CommandImpl<ForgetDeviceCommandInput, ForgetDeviceCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
