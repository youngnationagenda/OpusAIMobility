...
declare const AdminListDevicesCommand_base: {
    new (input: AdminListDevicesCommandInput): import("@smithy/core/client").CommandImpl<AdminListDevicesCommandInput, AdminListDevicesCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AdminListDevicesCommandInput): import("@smithy/core/client").CommandImpl<AdminListDevicesCommandInput, AdminListDevicesCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
