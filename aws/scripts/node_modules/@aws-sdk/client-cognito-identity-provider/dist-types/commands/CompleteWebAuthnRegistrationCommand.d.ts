...
declare const CompleteWebAuthnRegistrationCommand_base: {
    new (input: CompleteWebAuthnRegistrationCommandInput): import("@smithy/core/client").CommandImpl<CompleteWebAuthnRegistrationCommandInput, CompleteWebAuthnRegistrationCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CompleteWebAuthnRegistrationCommandInput): import("@smithy/core/client").CommandImpl<CompleteWebAuthnRegistrationCommandInput, CompleteWebAuthnRegistrationCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
