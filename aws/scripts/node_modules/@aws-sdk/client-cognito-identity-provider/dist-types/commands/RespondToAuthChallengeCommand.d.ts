...
declare const RespondToAuthChallengeCommand_base: {
    new (input: RespondToAuthChallengeCommandInput): import("@smithy/core/client").CommandImpl<RespondToAuthChallengeCommandInput, RespondToAuthChallengeCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RespondToAuthChallengeCommandInput): import("@smithy/core/client").CommandImpl<RespondToAuthChallengeCommandInput, RespondToAuthChallengeCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
