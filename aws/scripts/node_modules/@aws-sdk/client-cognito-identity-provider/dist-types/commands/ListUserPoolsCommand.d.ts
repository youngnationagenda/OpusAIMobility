...
declare const ListUserPoolsCommand_base: {
    new (input: ListUserPoolsCommandInput): import("@smithy/core/client").CommandImpl<ListUserPoolsCommandInput, ListUserPoolsCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListUserPoolsCommandInput): import("@smithy/core/client").CommandImpl<ListUserPoolsCommandInput, ListUserPoolsCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
