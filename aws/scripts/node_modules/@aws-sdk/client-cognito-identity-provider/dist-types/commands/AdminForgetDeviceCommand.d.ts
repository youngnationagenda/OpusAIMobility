...
declare const AdminForgetDeviceCommand_base: {
    new (input: AdminForgetDeviceCommandInput): import("@smithy/core/client").CommandImpl<AdminForgetDeviceCommandInput, AdminForgetDeviceCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AdminForgetDeviceCommandInput): import("@smithy/core/client").CommandImpl<AdminForgetDeviceCommandInput, AdminForgetDeviceCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
