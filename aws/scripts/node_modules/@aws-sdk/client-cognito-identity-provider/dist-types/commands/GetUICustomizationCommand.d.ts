...
declare const GetUICustomizationCommand_base: {
    new (input: GetUICustomizationCommandInput): import("@smithy/core/client").CommandImpl<GetUICustomizationCommandInput, GetUICustomizationCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetUICustomizationCommandInput): import("@smithy/core/client").CommandImpl<GetUICustomizationCommandInput, GetUICustomizationCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
