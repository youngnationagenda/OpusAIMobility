...
declare const UpdateUserPoolClientCommand_base: {
    new (input: UpdateUserPoolClientCommandInput): import("@smithy/core/client").CommandImpl<UpdateUserPoolClientCommandInput, UpdateUserPoolClientCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateUserPoolClientCommandInput): import("@smithy/core/client").CommandImpl<UpdateUserPoolClientCommandInput, UpdateUserPoolClientCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
