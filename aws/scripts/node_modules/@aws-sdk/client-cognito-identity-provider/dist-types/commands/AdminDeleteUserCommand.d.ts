...
declare const AdminDeleteUserCommand_base: {
    new (input: AdminDeleteUserCommandInput): import("@smithy/core/client").CommandImpl<AdminDeleteUserCommandInput, AdminDeleteUserCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AdminDeleteUserCommandInput): import("@smithy/core/client").CommandImpl<AdminDeleteUserCommandInput, AdminDeleteUserCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
