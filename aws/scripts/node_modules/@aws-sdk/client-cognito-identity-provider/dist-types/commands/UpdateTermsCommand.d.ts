...
declare const UpdateTermsCommand_base: {
    new (input: UpdateTermsCommandInput): import("@smithy/core/client").CommandImpl<UpdateTermsCommandInput, UpdateTermsCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateTermsCommandInput): import("@smithy/core/client").CommandImpl<UpdateTermsCommandInput, UpdateTermsCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
