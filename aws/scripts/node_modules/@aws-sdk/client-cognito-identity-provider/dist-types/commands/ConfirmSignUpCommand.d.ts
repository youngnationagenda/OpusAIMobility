...
declare const ConfirmSignUpCommand_base: {
    new (input: ConfirmSignUpCommandInput): import("@smithy/core/client").CommandImpl<ConfirmSignUpCommandInput, ConfirmSignUpCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ConfirmSignUpCommandInput): import("@smithy/core/client").CommandImpl<ConfirmSignUpCommandInput, ConfirmSignUpCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
