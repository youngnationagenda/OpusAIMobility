...
declare const DeleteIdentityProviderCommand_base: {
    new (input: DeleteIdentityProviderCommandInput): import("@smithy/core/client").CommandImpl<DeleteIdentityProviderCommandInput, DeleteIdentityProviderCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteIdentityProviderCommandInput): import("@smithy/core/client").CommandImpl<DeleteIdentityProviderCommandInput, DeleteIdentityProviderCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
