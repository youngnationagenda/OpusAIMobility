...
declare const AdminDeleteUserAttributesCommand_base: {
    new (input: AdminDeleteUserAttributesCommandInput): import("@smithy/core/client").CommandImpl<AdminDeleteUserAttributesCommandInput, AdminDeleteUserAttributesCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AdminDeleteUserAttributesCommandInput): import("@smithy/core/client").CommandImpl<AdminDeleteUserAttributesCommandInput, AdminDeleteUserAttributesCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
