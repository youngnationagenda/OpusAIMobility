...
declare const AdminLinkProviderForUserCommand_base: {
    new (input: AdminLinkProviderForUserCommandInput): import("@smithy/core/client").CommandImpl<AdminLinkProviderForUserCommandInput, AdminLinkProviderForUserCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AdminLinkProviderForUserCommandInput): import("@smithy/core/client").CommandImpl<AdminLinkProviderForUserCommandInput, AdminLinkProviderForUserCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
