...
declare const AdminSetUserMFAPreferenceCommand_base: {
    new (input: AdminSetUserMFAPreferenceCommandInput): import("@smithy/core/client").CommandImpl<AdminSetUserMFAPreferenceCommandInput, AdminSetUserMFAPreferenceCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AdminSetUserMFAPreferenceCommandInput): import("@smithy/core/client").CommandImpl<AdminSetUserMFAPreferenceCommandInput, AdminSetUserMFAPreferenceCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
