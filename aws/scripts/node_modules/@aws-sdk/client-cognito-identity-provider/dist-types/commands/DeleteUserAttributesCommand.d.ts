...
declare const DeleteUserAttributesCommand_base: {
    new (input: DeleteUserAttributesCommandInput): import("@smithy/core/client").CommandImpl<DeleteUserAttributesCommandInput, DeleteUserAttributesCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteUserAttributesCommandInput): import("@smithy/core/client").CommandImpl<DeleteUserAttributesCommandInput, DeleteUserAttributesCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
