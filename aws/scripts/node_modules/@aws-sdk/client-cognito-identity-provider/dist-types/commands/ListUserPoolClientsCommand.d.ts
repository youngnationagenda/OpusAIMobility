...
declare const ListUserPoolClientsCommand_base: {
    new (input: ListUserPoolClientsCommandInput): import("@smithy/core/client").CommandImpl<ListUserPoolClientsCommandInput, ListUserPoolClientsCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListUserPoolClientsCommandInput): import("@smithy/core/client").CommandImpl<ListUserPoolClientsCommandInput, ListUserPoolClientsCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
