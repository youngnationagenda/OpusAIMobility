...
declare const VerifyUserAttributeCommand_base: {
    new (input: VerifyUserAttributeCommandInput): import("@smithy/core/client").CommandImpl<VerifyUserAttributeCommandInput, VerifyUserAttributeCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: VerifyUserAttributeCommandInput): import("@smithy/core/client").CommandImpl<VerifyUserAttributeCommandInput, VerifyUserAttributeCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
