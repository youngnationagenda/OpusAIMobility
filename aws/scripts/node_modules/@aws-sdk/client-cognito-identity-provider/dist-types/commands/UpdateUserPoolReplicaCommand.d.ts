...
declare const UpdateUserPoolReplicaCommand_base: {
    new (input: UpdateUserPoolReplicaCommandInput): import("@smithy/core/client").CommandImpl<UpdateUserPoolReplicaCommandInput, UpdateUserPoolReplicaCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateUserPoolReplicaCommandInput): import("@smithy/core/client").CommandImpl<UpdateUserPoolReplicaCommandInput, UpdateUserPoolReplicaCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
