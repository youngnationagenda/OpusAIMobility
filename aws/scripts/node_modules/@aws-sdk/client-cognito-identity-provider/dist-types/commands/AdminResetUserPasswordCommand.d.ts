...
declare const AdminResetUserPasswordCommand_base: {
    new (input: AdminResetUserPasswordCommandInput): import("@smithy/core/client").CommandImpl<AdminResetUserPasswordCommandInput, AdminResetUserPasswordCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AdminResetUserPasswordCommandInput): import("@smithy/core/client").CommandImpl<AdminResetUserPasswordCommandInput, AdminResetUserPasswordCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
