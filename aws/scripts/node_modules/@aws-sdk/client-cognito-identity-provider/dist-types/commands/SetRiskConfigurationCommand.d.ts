...
declare const SetRiskConfigurationCommand_base: {
    new (input: SetRiskConfigurationCommandInput): import("@smithy/core/client").CommandImpl<SetRiskConfigurationCommandInput, SetRiskConfigurationCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SetRiskConfigurationCommandInput): import("@smithy/core/client").CommandImpl<SetRiskConfigurationCommandInput, SetRiskConfigurationCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
