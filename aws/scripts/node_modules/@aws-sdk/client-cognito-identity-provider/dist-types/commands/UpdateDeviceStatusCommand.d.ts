...
declare const UpdateDeviceStatusCommand_base: {
    new (input: UpdateDeviceStatusCommandInput): import("@smithy/core/client").CommandImpl<UpdateDeviceStatusCommandInput, UpdateDeviceStatusCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateDeviceStatusCommandInput): import("@smithy/core/client").CommandImpl<UpdateDeviceStatusCommandInput, UpdateDeviceStatusCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
