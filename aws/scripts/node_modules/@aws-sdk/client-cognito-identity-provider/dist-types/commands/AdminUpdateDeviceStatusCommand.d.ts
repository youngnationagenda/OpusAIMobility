...
declare const AdminUpdateDeviceStatusCommand_base: {
    new (input: AdminUpdateDeviceStatusCommandInput): import("@smithy/core/client").CommandImpl<AdminUpdateDeviceStatusCommandInput, AdminUpdateDeviceStatusCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AdminUpdateDeviceStatusCommandInput): import("@smithy/core/client").CommandImpl<AdminUpdateDeviceStatusCommandInput, AdminUpdateDeviceStatusCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
