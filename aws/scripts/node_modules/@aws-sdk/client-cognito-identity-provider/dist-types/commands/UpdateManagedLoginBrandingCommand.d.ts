...
declare const UpdateManagedLoginBrandingCommand_base: {
    new (input: UpdateManagedLoginBrandingCommandInput): import("@smithy/core/client").CommandImpl<UpdateManagedLoginBrandingCommandInput, UpdateManagedLoginBrandingCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [UpdateManagedLoginBrandingCommandInput]): import("@smithy/core/client").CommandImpl<UpdateManagedLoginBrandingCommandInput, UpdateManagedLoginBrandingCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
