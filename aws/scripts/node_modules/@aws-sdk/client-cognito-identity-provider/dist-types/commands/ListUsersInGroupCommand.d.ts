...
declare const ListUsersInGroupCommand_base: {
    new (input: ListUsersInGroupCommandInput): import("@smithy/core/client").CommandImpl<ListUsersInGroupCommandInput, ListUsersInGroupCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListUsersInGroupCommandInput): import("@smithy/core/client").CommandImpl<ListUsersInGroupCommandInput, ListUsersInGroupCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
