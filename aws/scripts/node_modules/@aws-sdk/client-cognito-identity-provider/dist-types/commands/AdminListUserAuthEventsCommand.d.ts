...
declare const AdminListUserAuthEventsCommand_base: {
    new (input: AdminListUserAuthEventsCommandInput): import("@smithy/core/client").CommandImpl<AdminListUserAuthEventsCommandInput, AdminListUserAuthEventsCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AdminListUserAuthEventsCommandInput): import("@smithy/core/client").CommandImpl<AdminListUserAuthEventsCommandInput, AdminListUserAuthEventsCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
