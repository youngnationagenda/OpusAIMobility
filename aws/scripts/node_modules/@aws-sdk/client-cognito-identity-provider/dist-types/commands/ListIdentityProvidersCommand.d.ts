...
declare const ListIdentityProvidersCommand_base: {
    new (input: ListIdentityProvidersCommandInput): import("@smithy/core/client").CommandImpl<ListIdentityProvidersCommandInput, ListIdentityProvidersCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListIdentityProvidersCommandInput): import("@smithy/core/client").CommandImpl<ListIdentityProvidersCommandInput, ListIdentityProvidersCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
