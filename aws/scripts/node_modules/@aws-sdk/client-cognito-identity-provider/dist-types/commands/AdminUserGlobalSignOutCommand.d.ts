...
declare const AdminUserGlobalSignOutCommand_base: {
    new (input: AdminUserGlobalSignOutCommandInput): import("@smithy/core/client").CommandImpl<AdminUserGlobalSignOutCommandInput, AdminUserGlobalSignOutCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AdminUserGlobalSignOutCommandInput): import("@smithy/core/client").CommandImpl<AdminUserGlobalSignOutCommandInput, AdminUserGlobalSignOutCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
