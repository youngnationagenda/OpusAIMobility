...
declare const GetUserCommand_base: {
    new (input: GetUserCommandInput): import("@smithy/core/client").CommandImpl<GetUserCommandInput, GetUserCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetUserCommandInput): import("@smithy/core/client").CommandImpl<GetUserCommandInput, GetUserCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
