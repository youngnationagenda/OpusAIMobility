...
declare const VerifySoftwareTokenCommand_base: {
    new (input: VerifySoftwareTokenCommandInput): import("@smithy/core/client").CommandImpl<VerifySoftwareTokenCommandInput, VerifySoftwareTokenCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: VerifySoftwareTokenCommandInput): import("@smithy/core/client").CommandImpl<VerifySoftwareTokenCommandInput, VerifySoftwareTokenCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
