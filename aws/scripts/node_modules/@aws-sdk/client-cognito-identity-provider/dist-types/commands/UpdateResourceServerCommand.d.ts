...
declare const UpdateResourceServerCommand_base: {
    new (input: UpdateResourceServerCommandInput): import("@smithy/core/client").CommandImpl<UpdateResourceServerCommandInput, UpdateResourceServerCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateResourceServerCommandInput): import("@smithy/core/client").CommandImpl<UpdateResourceServerCommandInput, UpdateResourceServerCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
