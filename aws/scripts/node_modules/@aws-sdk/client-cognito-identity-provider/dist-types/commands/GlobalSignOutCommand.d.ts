...
declare const GlobalSignOutCommand_base: {
    new (input: GlobalSignOutCommandInput): import("@smithy/core/client").CommandImpl<GlobalSignOutCommandInput, GlobalSignOutCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GlobalSignOutCommandInput): import("@smithy/core/client").CommandImpl<GlobalSignOutCommandInput, GlobalSignOutCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
