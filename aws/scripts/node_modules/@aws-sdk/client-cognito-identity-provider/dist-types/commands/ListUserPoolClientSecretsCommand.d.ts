...
declare const ListUserPoolClientSecretsCommand_base: {
    new (input: ListUserPoolClientSecretsCommandInput): import("@smithy/core/client").CommandImpl<ListUserPoolClientSecretsCommandInput, ListUserPoolClientSecretsCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListUserPoolClientSecretsCommandInput): import("@smithy/core/client").CommandImpl<ListUserPoolClientSecretsCommandInput, ListUserPoolClientSecretsCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
