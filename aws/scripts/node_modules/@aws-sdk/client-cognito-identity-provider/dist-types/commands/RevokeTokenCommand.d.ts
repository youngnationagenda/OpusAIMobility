...
declare const RevokeTokenCommand_base: {
    new (input: RevokeTokenCommandInput): import("@smithy/core/client").CommandImpl<RevokeTokenCommandInput, RevokeTokenCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RevokeTokenCommandInput): import("@smithy/core/client").CommandImpl<RevokeTokenCommandInput, RevokeTokenCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
