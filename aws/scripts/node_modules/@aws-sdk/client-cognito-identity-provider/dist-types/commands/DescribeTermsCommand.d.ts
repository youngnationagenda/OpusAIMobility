...
declare const DescribeTermsCommand_base: {
    new (input: DescribeTermsCommandInput): import("@smithy/core/client").CommandImpl<DescribeTermsCommandInput, DescribeTermsCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeTermsCommandInput): import("@smithy/core/client").CommandImpl<DescribeTermsCommandInput, DescribeTermsCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
