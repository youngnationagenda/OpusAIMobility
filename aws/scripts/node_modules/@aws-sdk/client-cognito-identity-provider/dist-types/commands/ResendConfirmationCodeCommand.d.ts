...
declare const ResendConfirmationCodeCommand_base: {
    new (input: ResendConfirmationCodeCommandInput): import("@smithy/core/client").CommandImpl<ResendConfirmationCodeCommandInput, ResendConfirmationCodeCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ResendConfirmationCodeCommandInput): import("@smithy/core/client").CommandImpl<ResendConfirmationCodeCommandInput, ResendConfirmationCodeCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
