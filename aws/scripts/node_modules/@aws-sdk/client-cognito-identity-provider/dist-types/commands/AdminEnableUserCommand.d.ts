...
declare const AdminEnableUserCommand_base: {
    new (input: AdminEnableUserCommandInput): import("@smithy/core/client").CommandImpl<AdminEnableUserCommandInput, AdminEnableUserCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AdminEnableUserCommandInput): import("@smithy/core/client").CommandImpl<AdminEnableUserCommandInput, AdminEnableUserCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
