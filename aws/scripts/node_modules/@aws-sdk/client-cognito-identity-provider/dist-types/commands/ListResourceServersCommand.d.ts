...
declare const ListResourceServersCommand_base: {
    new (input: ListResourceServersCommandInput): import("@smithy/core/client").CommandImpl<ListResourceServersCommandInput, ListResourceServersCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListResourceServersCommandInput): import("@smithy/core/client").CommandImpl<ListResourceServersCommandInput, ListResourceServersCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
