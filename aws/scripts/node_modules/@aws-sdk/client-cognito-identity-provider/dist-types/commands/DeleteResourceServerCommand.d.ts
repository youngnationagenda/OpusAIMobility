...
declare const DeleteResourceServerCommand_base: {
    new (input: DeleteResourceServerCommandInput): import("@smithy/core/client").CommandImpl<DeleteResourceServerCommandInput, DeleteResourceServerCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteResourceServerCommandInput): import("@smithy/core/client").CommandImpl<DeleteResourceServerCommandInput, DeleteResourceServerCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
