...
declare const CreateIdentityProviderCommand_base: {
    new (input: CreateIdentityProviderCommandInput): import("@smithy/core/client").CommandImpl<CreateIdentityProviderCommandInput, CreateIdentityProviderCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateIdentityProviderCommandInput): import("@smithy/core/client").CommandImpl<CreateIdentityProviderCommandInput, CreateIdentityProviderCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
