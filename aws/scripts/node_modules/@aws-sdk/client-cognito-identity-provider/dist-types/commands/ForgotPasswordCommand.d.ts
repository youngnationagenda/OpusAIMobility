...
declare const ForgotPasswordCommand_base: {
    new (input: ForgotPasswordCommandInput): import("@smithy/core/client").CommandImpl<ForgotPasswordCommandInput, ForgotPasswordCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ForgotPasswordCommandInput): import("@smithy/core/client").CommandImpl<ForgotPasswordCommandInput, ForgotPasswordCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
