...
declare const DescribeManagedLoginBrandingByClientCommand_base: {
    new (input: DescribeManagedLoginBrandingByClientCommandInput): import("@smithy/core/client").CommandImpl<DescribeManagedLoginBrandingByClientCommandInput, DescribeManagedLoginBrandingByClientCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeManagedLoginBrandingByClientCommandInput): import("@smithy/core/client").CommandImpl<DescribeManagedLoginBrandingByClientCommandInput, DescribeManagedLoginBrandingByClientCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
