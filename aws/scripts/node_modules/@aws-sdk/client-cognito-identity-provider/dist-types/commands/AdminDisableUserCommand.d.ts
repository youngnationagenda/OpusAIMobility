...
declare const AdminDisableUserCommand_base: {
    new (input: AdminDisableUserCommandInput): import("@smithy/core/client").CommandImpl<AdminDisableUserCommandInput, AdminDisableUserCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AdminDisableUserCommandInput): import("@smithy/core/client").CommandImpl<AdminDisableUserCommandInput, AdminDisableUserCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
