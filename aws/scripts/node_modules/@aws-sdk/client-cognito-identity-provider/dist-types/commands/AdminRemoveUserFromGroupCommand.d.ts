...
declare const AdminRemoveUserFromGroupCommand_base: {
    new (input: AdminRemoveUserFromGroupCommandInput): import("@smithy/core/client").CommandImpl<AdminRemoveUserFromGroupCommandInput, AdminRemoveUserFromGroupCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AdminRemoveUserFromGroupCommandInput): import("@smithy/core/client").CommandImpl<AdminRemoveUserFromGroupCommandInput, AdminRemoveUserFromGroupCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
