...
declare const DeleteUserPoolReplicaCommand_base: {
    new (input: DeleteUserPoolReplicaCommandInput): import("@smithy/core/client").CommandImpl<DeleteUserPoolReplicaCommandInput, DeleteUserPoolReplicaCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteUserPoolReplicaCommandInput): import("@smithy/core/client").CommandImpl<DeleteUserPoolReplicaCommandInput, DeleteUserPoolReplicaCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
