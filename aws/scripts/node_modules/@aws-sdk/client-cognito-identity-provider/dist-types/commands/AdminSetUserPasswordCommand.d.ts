...
declare const AdminSetUserPasswordCommand_base: {
    new (input: AdminSetUserPasswordCommandInput): import("@smithy/core/client").CommandImpl<AdminSetUserPasswordCommandInput, AdminSetUserPasswordCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AdminSetUserPasswordCommandInput): import("@smithy/core/client").CommandImpl<AdminSetUserPasswordCommandInput, AdminSetUserPasswordCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
