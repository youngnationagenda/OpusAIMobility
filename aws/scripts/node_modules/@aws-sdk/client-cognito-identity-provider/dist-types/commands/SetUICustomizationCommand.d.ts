...
declare const SetUICustomizationCommand_base: {
    new (input: SetUICustomizationCommandInput): import("@smithy/core/client").CommandImpl<SetUICustomizationCommandInput, SetUICustomizationCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SetUICustomizationCommandInput): import("@smithy/core/client").CommandImpl<SetUICustomizationCommandInput, SetUICustomizationCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
