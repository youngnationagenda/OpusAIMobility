...
declare const CreateManagedLoginBrandingCommand_base: {
    new (input: CreateManagedLoginBrandingCommandInput): import("@smithy/core/client").CommandImpl<CreateManagedLoginBrandingCommandInput, CreateManagedLoginBrandingCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateManagedLoginBrandingCommandInput): import("@smithy/core/client").CommandImpl<CreateManagedLoginBrandingCommandInput, CreateManagedLoginBrandingCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
