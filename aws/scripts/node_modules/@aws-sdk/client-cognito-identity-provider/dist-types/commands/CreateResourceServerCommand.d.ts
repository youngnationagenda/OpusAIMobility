...
declare const CreateResourceServerCommand_base: {
    new (input: CreateResourceServerCommandInput): import("@smithy/core/client").CommandImpl<CreateResourceServerCommandInput, CreateResourceServerCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateResourceServerCommandInput): import("@smithy/core/client").CommandImpl<CreateResourceServerCommandInput, CreateResourceServerCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
