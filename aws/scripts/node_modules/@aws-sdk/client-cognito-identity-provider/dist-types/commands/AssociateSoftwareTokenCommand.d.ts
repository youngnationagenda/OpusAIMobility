...
declare const AssociateSoftwareTokenCommand_base: {
    new (input: AssociateSoftwareTokenCommandInput): import("@smithy/core/client").CommandImpl<AssociateSoftwareTokenCommandInput, AssociateSoftwareTokenCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [AssociateSoftwareTokenCommandInput]): import("@smithy/core/client").CommandImpl<AssociateSoftwareTokenCommandInput, AssociateSoftwareTokenCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
