...
declare const DeleteUserPoolDomainCommand_base: {
    new (input: DeleteUserPoolDomainCommandInput): import("@smithy/core/client").CommandImpl<DeleteUserPoolDomainCommandInput, DeleteUserPoolDomainCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteUserPoolDomainCommandInput): import("@smithy/core/client").CommandImpl<DeleteUserPoolDomainCommandInput, DeleteUserPoolDomainCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
