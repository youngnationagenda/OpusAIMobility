...
declare const SetLogDeliveryConfigurationCommand_base: {
    new (input: SetLogDeliveryConfigurationCommandInput): import("@smithy/core/client").CommandImpl<SetLogDeliveryConfigurationCommandInput, SetLogDeliveryConfigurationCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SetLogDeliveryConfigurationCommandInput): import("@smithy/core/client").CommandImpl<SetLogDeliveryConfigurationCommandInput, SetLogDeliveryConfigurationCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
