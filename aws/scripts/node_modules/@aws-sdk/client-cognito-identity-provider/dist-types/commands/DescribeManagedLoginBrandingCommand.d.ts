...
declare const DescribeManagedLoginBrandingCommand_base: {
    new (input: DescribeManagedLoginBrandingCommandInput): import("@smithy/core/client").CommandImpl<DescribeManagedLoginBrandingCommandInput, DescribeManagedLoginBrandingCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeManagedLoginBrandingCommandInput): import("@smithy/core/client").CommandImpl<DescribeManagedLoginBrandingCommandInput, DescribeManagedLoginBrandingCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
