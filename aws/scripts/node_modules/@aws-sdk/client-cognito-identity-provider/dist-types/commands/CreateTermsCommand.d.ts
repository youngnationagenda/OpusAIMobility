...
declare const CreateTermsCommand_base: {
    new (input: CreateTermsCommandInput): import("@smithy/core/client").CommandImpl<CreateTermsCommandInput, CreateTermsCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateTermsCommandInput): import("@smithy/core/client").CommandImpl<CreateTermsCommandInput, CreateTermsCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
