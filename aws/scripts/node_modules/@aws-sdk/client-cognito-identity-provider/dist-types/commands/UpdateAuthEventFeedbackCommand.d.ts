...
declare const UpdateAuthEventFeedbackCommand_base: {
    new (input: UpdateAuthEventFeedbackCommandInput): import("@smithy/core/client").CommandImpl<UpdateAuthEventFeedbackCommandInput, UpdateAuthEventFeedbackCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateAuthEventFeedbackCommandInput): import("@smithy/core/client").CommandImpl<UpdateAuthEventFeedbackCommandInput, UpdateAuthEventFeedbackCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
