...
declare const DeleteWebAuthnCredentialCommand_base: {
    new (input: DeleteWebAuthnCredentialCommandInput): import("@smithy/core/client").CommandImpl<DeleteWebAuthnCredentialCommandInput, DeleteWebAuthnCredentialCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteWebAuthnCredentialCommandInput): import("@smithy/core/client").CommandImpl<DeleteWebAuthnCredentialCommandInput, DeleteWebAuthnCredentialCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
