...
declare const GetCSVHeaderCommand_base: {
    new (input: GetCSVHeaderCommandInput): import("@smithy/core/client").CommandImpl<GetCSVHeaderCommandInput, GetCSVHeaderCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetCSVHeaderCommandInput): import("@smithy/core/client").CommandImpl<GetCSVHeaderCommandInput, GetCSVHeaderCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
