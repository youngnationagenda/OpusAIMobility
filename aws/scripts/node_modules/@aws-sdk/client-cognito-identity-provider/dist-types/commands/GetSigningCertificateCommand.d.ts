...
declare const GetSigningCertificateCommand_base: {
    new (input: GetSigningCertificateCommandInput): import("@smithy/core/client").CommandImpl<GetSigningCertificateCommandInput, GetSigningCertificateCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetSigningCertificateCommandInput): import("@smithy/core/client").CommandImpl<GetSigningCertificateCommandInput, GetSigningCertificateCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
