...
declare const InitiateAuthCommand_base: {
    new (input: InitiateAuthCommandInput): import("@smithy/core/client").CommandImpl<InitiateAuthCommandInput, InitiateAuthCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: InitiateAuthCommandInput): import("@smithy/core/client").CommandImpl<InitiateAuthCommandInput, InitiateAuthCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
