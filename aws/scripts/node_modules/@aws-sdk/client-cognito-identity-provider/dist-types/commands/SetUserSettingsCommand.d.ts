...
declare const SetUserSettingsCommand_base: {
    new (input: SetUserSettingsCommandInput): import("@smithy/core/client").CommandImpl<SetUserSettingsCommandInput, SetUserSettingsCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SetUserSettingsCommandInput): import("@smithy/core/client").CommandImpl<SetUserSettingsCommandInput, SetUserSettingsCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
