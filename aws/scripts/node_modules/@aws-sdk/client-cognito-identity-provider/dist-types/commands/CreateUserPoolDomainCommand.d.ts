...
declare const CreateUserPoolDomainCommand_base: {
    new (input: CreateUserPoolDomainCommandInput): import("@smithy/core/client").CommandImpl<CreateUserPoolDomainCommandInput, CreateUserPoolDomainCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateUserPoolDomainCommandInput): import("@smithy/core/client").CommandImpl<CreateUserPoolDomainCommandInput, CreateUserPoolDomainCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
