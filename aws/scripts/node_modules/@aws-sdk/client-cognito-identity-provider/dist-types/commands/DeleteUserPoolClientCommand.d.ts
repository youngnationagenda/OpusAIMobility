...
declare const DeleteUserPoolClientCommand_base: {
    new (input: DeleteUserPoolClientCommandInput): import("@smithy/core/client").CommandImpl<DeleteUserPoolClientCommandInput, DeleteUserPoolClientCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteUserPoolClientCommandInput): import("@smithy/core/client").CommandImpl<DeleteUserPoolClientCommandInput, DeleteUserPoolClientCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
