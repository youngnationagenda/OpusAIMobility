(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@babel/runtime/helpers/defineProperty'), require('core-js/modules/es.array.iterator.js'), require('core-js/modules/es.promise.js'), require('core-js/modules/es.regexp.exec.js'), require('core-js/modules/es.string.pad-start.js'), require('core-js/modules/es.string.replace.js'), require('core-js/modules/web.dom-collections.iterator.js'), require('stream')) :
  typeof define === 'function' && define.amd ? define(['exports', '@babel/runtime/helpers/defineProperty', 'core-js/modules/es.array.iterator.js', 'core-js/modules/es.promise.js', 'core-js/modules/es.regexp.exec.js', 'core-js/modules/es.string.pad-start.js', 'core-js/modules/es.string.replace.js', 'core-js/modules/web.dom-collections.iterator.js', 'stream'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.jsonStreamStringify = {}, global._defineProperty, null, null, null, null, null, null, global.stream));
})(this, (function (exports, _defineProperty, es_array_iterator_js, es_promise_js, es_regexp_exec_js, es_string_padStart_js, es_string_replace_js, web_domCollections_iterator_js, stream) { 'use strict';
  ...
  let primitiveToJSON;
  if (((_global = global) === null || _global === void 0 || (_global = _global.JSON) === null || _global === void 0 ? void 0 : _global.stringify) instanceof Function) {
    try {
  ...
  */
  ...
  function quoteString(string) {
    const useCache = string.length < 10000;
  ...
  function readAsPromised(stream, size) {
    ...
    if (value === null && !(stream.readableEnded || (_readableState = stream._readableState) !== null && _readableState !== void 0 && _readableState.ended)) {
  ...
  var ReadState = /*#__PURE__*/function (ReadState) {
  ...
  class JsonStreamStringify extends stream.Readable {
    ...
    setReadableStringItem(input, parent) {
      var _readableState2, _readableState3;
      if (input.readableEnded || (_readableState2 = input._readableState) !== null && _readableState2 !== void 0 && _readableState2.endEmitted) {
      ...
      } else if (input.readableFlowing || (_readableState3 = input._readableState) !== null && _readableState3 !== void 0 && _readableState3.flowing) {
        input.pause();
    ...
    setReadableObjectItem(input, parent) {
      var _readableState4, _readableState5;
      if (input.readableEnded || (_readableState4 = input._readableState) !== null && _readableState4 !== void 0 && _readableState4.endEmitted) {
        this.emit('error', new Error('Readable Stream has ended before it was serialized. All stream data have been lost'), input, parent.path);
      } else if (input.readableFlowing || (_readableState5 = input._readableState) !== null && _readableState5 !== void 0 && _readableState5.flowing) {
        input.pause();
        this.emit('error', new Error('Readable Stream is in flowing mode, data may have been lost. Trying to pause stream.'), input, parent.path);
      }
      const that = this;
    ...
    setObjectItem(input, parent = undefined) {
      ...
      const item = {
        read() {
          ...
          key = keys[i];
          if ((include === null || include === void 0 || (_include$indexOf = include.indexOf) === null || _include$indexOf === void 0 ? void 0 : _include$indexOf.call(include, key)) === -1) {
    ...
    destroy(error) {
      ...
      (_super$destroy = super.destroy) === null || _super$destroy === void 0 || _super$destroy.call(this);
      this.cleanup();
      return this;
    }
  }
