...
declare const GetFunctionUrlConfigCommand_base: {
    new (input: GetFunctionUrlConfigCommandInput): import("@smithy/core/client").CommandImpl<GetFunctionUrlConfigCommandInput, GetFunctionUrlConfigCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetFunctionUrlConfigCommandInput): import("@smithy/core/client").CommandImpl<GetFunctionUrlConfigCommandInput, GetFunctionUrlConfigCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
