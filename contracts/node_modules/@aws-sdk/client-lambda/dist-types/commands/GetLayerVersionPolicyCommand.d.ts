...
declare const GetLayerVersionPolicyCommand_base: {
    new (input: GetLayerVersionPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetLayerVersionPolicyCommandInput, GetLayerVersionPolicyCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetLayerVersionPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetLayerVersionPolicyCommandInput, GetLayerVersionPolicyCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
