...
declare const DeleteProvisionedConcurrencyConfigCommand_base: {
    new (input: DeleteProvisionedConcurrencyConfigCommandInput): import("@smithy/core/client").CommandImpl<DeleteProvisionedConcurrencyConfigCommandInput, DeleteProvisionedConcurrencyConfigCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteProvisionedConcurrencyConfigCommandInput): import("@smithy/core/client").CommandImpl<DeleteProvisionedConcurrencyConfigCommandInput, DeleteProvisionedConcurrencyConfigCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
