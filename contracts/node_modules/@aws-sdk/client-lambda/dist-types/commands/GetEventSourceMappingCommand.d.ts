...
declare const GetEventSourceMappingCommand_base: {
    new (input: GetEventSourceMappingCommandInput): import("@smithy/core/client").CommandImpl<GetEventSourceMappingCommandInput, GetEventSourceMappingCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetEventSourceMappingCommandInput): import("@smithy/core/client").CommandImpl<GetEventSourceMappingCommandInput, GetEventSourceMappingCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
