...
declare const ListEventSourceMappingsCommand_base: {
    new (input: ListEventSourceMappingsCommandInput): import("@smithy/core/client").CommandImpl<ListEventSourceMappingsCommandInput, ListEventSourceMappingsCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListEventSourceMappingsCommandInput]): import("@smithy/core/client").CommandImpl<ListEventSourceMappingsCommandInput, ListEventSourceMappingsCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
