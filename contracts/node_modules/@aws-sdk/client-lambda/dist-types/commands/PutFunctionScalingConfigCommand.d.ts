...
declare const PutFunctionScalingConfigCommand_base: {
    new (input: PutFunctionScalingConfigCommandInput): import("@smithy/core/client").CommandImpl<PutFunctionScalingConfigCommandInput, PutFunctionScalingConfigCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutFunctionScalingConfigCommandInput): import("@smithy/core/client").CommandImpl<PutFunctionScalingConfigCommandInput, PutFunctionScalingConfigCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
