...
declare const UpdateAliasCommand_base: {
    new (input: UpdateAliasCommandInput): import("@smithy/core/client").CommandImpl<UpdateAliasCommandInput, UpdateAliasCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateAliasCommandInput): import("@smithy/core/client").CommandImpl<UpdateAliasCommandInput, UpdateAliasCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
