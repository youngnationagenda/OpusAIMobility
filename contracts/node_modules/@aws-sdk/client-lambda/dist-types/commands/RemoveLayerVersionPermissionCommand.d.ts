...
declare const RemoveLayerVersionPermissionCommand_base: {
    new (input: RemoveLayerVersionPermissionCommandInput): import("@smithy/core/client").CommandImpl<RemoveLayerVersionPermissionCommandInput, RemoveLayerVersionPermissionCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RemoveLayerVersionPermissionCommandInput): import("@smithy/core/client").CommandImpl<RemoveLayerVersionPermissionCommandInput, RemoveLayerVersionPermissionCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
