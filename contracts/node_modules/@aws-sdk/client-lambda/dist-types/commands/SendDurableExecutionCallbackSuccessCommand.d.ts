...
declare const SendDurableExecutionCallbackSuccessCommand_base: {
    new (input: SendDurableExecutionCallbackSuccessCommandInput): import("@smithy/core/client").CommandImpl<SendDurableExecutionCallbackSuccessCommandInput, SendDurableExecutionCallbackSuccessCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SendDurableExecutionCallbackSuccessCommandInput): import("@smithy/core/client").CommandImpl<SendDurableExecutionCallbackSuccessCommandInput, SendDurableExecutionCallbackSuccessCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
