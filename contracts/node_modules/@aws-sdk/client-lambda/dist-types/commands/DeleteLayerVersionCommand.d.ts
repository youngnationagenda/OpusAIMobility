...
declare const DeleteLayerVersionCommand_base: {
    new (input: DeleteLayerVersionCommandInput): import("@smithy/core/client").CommandImpl<DeleteLayerVersionCommandInput, DeleteLayerVersionCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteLayerVersionCommandInput): import("@smithy/core/client").CommandImpl<DeleteLayerVersionCommandInput, DeleteLayerVersionCommandOutput, import("..").LambdaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
