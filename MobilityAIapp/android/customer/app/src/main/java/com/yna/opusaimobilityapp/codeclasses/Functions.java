...
import com.yna.opusaimobilityapp.Interface.Callback;
...
public class Functions {
    ...
    public static float getDPToPixels(int i) {
        return TypedValue.applyDimension(1, (float) i, OpusAIMobility.getAppContext().getResources().getDisplayMetrics());
    }
