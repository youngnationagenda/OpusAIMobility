package com.yna.opusaimobilityapp.aws;
 ...
 * Copied from com.terraai.aimobility.aws.AWSManager to allow excluding the
 * entire com.terraai.aimobility source tree during CI builds.
 */
public class AWSManager {
    ...
    public void startWebSocket(String userId) {
        // WebSocket service start - delegates to com.terraai.aimobility.aws.WebSocketForegroundService
        Log.i(TAG, "WebSocket service start requested for user: " + userId);
    }

    public void stopWebSocket() {
        Log.i(TAG, "WebSocket service stop requested");
    }
