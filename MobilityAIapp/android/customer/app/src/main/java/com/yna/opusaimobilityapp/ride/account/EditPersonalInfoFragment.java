    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.dateLayout:
                Functions.hideSoftKeyboard(getActivity());
                Functions.methodOpenDateTimePicker( binding.tvDob.getText().toString(), getActivity().getSupportFragmentManager(), new com.yna.opusaimobilityapp.Interface.Callback() {
                    @Override
